...
var ort = (() => {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of ac(t))
          !sc.call(e, i) &&
            ...
            Oi(e, i, {
              get: () => t[i],
              enumerable: !(n = oc(t, i)) || n.enumerable
            });
      return e;
    };
  var Yt = (e) => uc(Oi({}, "__esModule", { value: !0 }), e);
  var On,
    dr,
    Xt,
    lc,
      ...
      (On = new Map()),
        ...
        (Xt = (e, t, r) => {
          if (
            ...
            let n = On.get(e);
            if (n === void 0) On.set(e, { backend: t, priority: r });
            else {
              if (n.priority > r) return;
              if (n.priority === r && n.backend !== t)
                throw new Error(
        ...
        (Pn = async (e) => {
          let t = e.executionProviders || [],
            r = t.map((c) => (typeof c == "string" ? c : c.name)),
            n = r.length === 0 ? dr : r,
            i,
            s = [],
            a = new Set();
          ...
          if (!i)
            throw new Error(
              `no available backend found. ERR: ${s.map((c) => `[${c.name}] ${c.err}`).join(", ")}`
            );
          for (let { name: c, err: m } of s)
            r.includes(c) &&
              console.warn(
                `removing requested execution provider "${c}" from session options because it is not available: ${m}`
              );
          let d = t.filter((c) => a.has(typeof c == "string" ? c : c.name));
          return [
            i,
            new Proxy(e, {
              get: (c, m) =>
                m === "executionProviders" ? d : Reflect.get(c, m)
            })
          ];
        });
    });
  ...
  var oa,
    ...
    Pi = j(() => {
      ...
      Object.defineProperty(yt, "logLevel", { enumerable: !0 });
    });
  var ke,
    aa = j(() => {
      "use strict";
      ...
      (sa = (e, t) => {
        ...
        if (n != null) {
          ...
          t?.tensorLayout !== void 0 && t.tensorLayout === "NHWC"
            ? ((i = e.dims[2]), (s = e.dims[3]))
            : ((i = e.dims[3]), (s = e.dims[2]));
          let a = t?.format !== void 0 ? t.format : "RGB",
            d = t?.norm,
            c,
            m;
          d === void 0 || d.mean === void 0
            ? (c = [255, 255, 255, 255])
            : typeof d.mean == "number"
              ? (c = [d.mean, d.mean, d.mean, d.mean])
              : ((c = [d.mean[0], d.mean[1], d.mean[2], 0]),
                d.mean[3] !== void 0 && (c[3] = d.mean[3])),
            d === void 0 || d.bias === void 0
              ? (m = [0, 0, 0, 0])
              : typeof d.bias == "number"
                ? (m = [d.bias, d.bias, d.bias, d.bias])
                : ((m = [d.bias[0], d.bias[1], d.bias[2], 0]),
          ...
          for (let x = 0; x < s; x++)
            for (let C = 0; C < i; C++) {
              let T = (e.data[g++] - m[0]) * c[0],
                S = (e.data[b++] - m[1]) * c[1],
                E = (e.data[$++] - m[2]) * c[2],
                k = w === -1 ? 255 : (e.data[w++] - m[3]) * c[3];
              (n.fillStyle = "rgba(" + T + "," + S + "," + E + "," + k + ")"),
                n.fillRect(C, x, 1, 1);
            }
        ...
        (ua = (e, t) => {
          ...
          if (r != null) {
            let i, s, a;
            t?.tensorLayout !== void 0 && t.tensorLayout === "NHWC"
              ? ((i = e.dims[2]), (s = e.dims[1]), (a = e.dims[3]))
              : ((i = e.dims[3]), (s = e.dims[2]), (a = e.dims[1]));
            let d = t !== void 0 && t.format !== void 0 ? t.format : "RGB",
              c = t?.norm,
              m,
              u;
            c === void 0 || c.mean === void 0
              ...
              : typeof c.mean == "number"
                ? (m = [c.mean, c.mean, c.mean, c.mean])
                : ((m = [c.mean[0], c.mean[1], c.mean[2], 255]),
                  c.mean[3] !== void 0 && (m[3] = c.mean[3])),
            ...
            if (
              t !== void 0 &&
              ((t.format !== void 0 && a === 4 && t.format !== "RGBA") ||
                (a === 3 && t.format !== "RGB" && t.format !== "BGR"))
            )
            ...
            d === "RGBA"
              ...
              : d === "RGB"
                ? ((T = 0), (S = g), (E = g * 2))
                : d === "RBG" && ((T = 0), (E = g), (S = g * 2)),
              (n = r.createImageData(i, s));
            for (let P = 0; P < s * i; $ += b, w += b, x += b, C += b, P++)
              (n.data[$] = (e.data[T++] - u[0]) * m[0]),
                (n.data[w] = (e.data[S++] - u[1]) * m[1]),
                (n.data[x] = (e.data[E++] - u[2]) * m[2]),
                (n.data[C] = k === -1 ? 255 : (e.data[k++] - u[3]) * m[3]);
          } else throw new Error("Can not access image data");
          return n;
        });
    });
    ...
    fa = j(() => {
      ...
      (Ri = (e, t) => {
        ...
        typeof i.mean == "number"
          ? (s = [i.mean, i.mean, i.mean, i.mean])
          : (s = [i.mean[0], i.mean[1], i.mean[2], i.mean[3] ?? 255]),
          typeof i.bias == "number"
            ? (a = [i.bias, i.bias, i.bias, i.bias])
            : (a = [i.bias[0], i.bias[1], i.bias[2], i.bias[3] ?? 0]);
        let d = t.format !== void 0 ? t.format : "RGBA",
          c =
            t.tensorFormat !== void 0 && t.tensorFormat !== void 0
              ? t.tensorFormat
              : "RGB",
          m = r * n,
          u = c === "RGBA" ? new Float32Array(m * 4) : new Float32Array(m * 3),
          g = 4,
          b = 0,
          $ = 1,
          w = 2,
          ...
          S = m * 2,
          E = -1;
        d === "RGB" && ((g = 3), (b = 0), ($ = 1), (w = 2), (x = -1)),
          c === "RGBA"
            ? (E = m * 3)
            : c === "RBG"
              ? ((C = 0), (S = m), (T = m * 2))
              : c === "BGR" && ((S = 0), (T = m), (C = m * 2));
        for (let P = 0; P < m; P++, b += g, w += g, $ += g, x += g)
          (u[C++] = (e[b] + a[0]) / s[0]),
            (u[T++] = (e[$] + a[1]) / s[1]),
            (u[S++] = (e[w] + a[2]) / s[2]),
            E !== -1 && x !== -1 && (u[E++] = (e[x] + a[3]) / s[3]);
        return c === "RGBA"
          ? new ot("float32", u, [1, 4, r, n])
          : new ot("float32", u, [1, 3, r, n]);
      }),
        (da = async (e, t) => {
          let r =
              typeof HTMLImageElement < "u" && e instanceof HTMLImageElement,
            n = typeof ImageData < "u" && e instanceof ImageData,
            ...
            m = (u) =>
              u instanceof HTMLCanvasElement || u instanceof OffscreenCanvas
                ? u.getContext("2d")
                : null;
          if (r) {
            let u = c();
            ...
            if (g != null) {
              ...
              if (
                (t !== void 0 &&
                  ...
                  ((b = t.resizedHeight), ($ = t.resizedWidth)),
                t !== void 0)
              ) {
                if (((d = t), t.tensorFormat !== void 0))
                  throw new Error(
                    "Image input config format must be RGBA for HTMLImageElement"
                  );
                (d.tensorFormat = "RGBA"), (d.height = b), (d.width = $);
              } else (d.tensorFormat = "RGBA"), (d.height = b), (d.width = $);
              g.drawImage(e, 0, 0), (a = g.getImageData(0, 0, $, b).data);
            } else throw new Error("Can not access image data");
          } else if (n) {
            let u, g;
            if (
              ...
              t.resizedWidth !== void 0 &&
              t.resizedHeight !== void 0
                ? ((u = t.resizedHeight), (g = t.resizedWidth))
                : ((u = e.height), (g = e.width)),
              t !== void 0 && (d = t),
              (d.format = "RGBA"),
              (d.height = u),
              (d.width = g),
              ...
              let b = c();
              (b.width = g), (b.height = u);
              let $ = m(b);
              if ($ != null)
                $.putImageData(e, 0, 0), (a = $.getImageData(0, 0, g, u).data);
              else throw new Error("Can not access image data");
            } else a = e.data;
          } else if (i) {
            if (t === void 0)
              ...
              return new Promise((u, g) => {
                ...
                (w.crossOrigin = "Anonymous"),
                  ...
                  (w.onload = () => {
                    (b.width = w.width),
                      (b.height = w.height),
                      $.drawImage(w, 0, 0, b.width, b.height);
                    let x = $.getImageData(0, 0, b.width, b.height);
                    (d.height = b.height),
                      (d.width = b.width),
                      u(Ri(x.data, d));
                  });
          ...
          if (a !== void 0) return Ri(a, d);
          throw new Error(
            "Input data provided is not supported - aborted tensor creation"
          );
        }),
        (ca = (e, t) => {
          let { width: r, height: n, download: i, dispose: s } = t,
            a = [1, n, r, 4];
          return new ot({
            location: "texture",
            type: "float32",
        ...
        (pa = (e, t) => {
          let { dataType: r, dims: n, download: i, dispose: s } = t;
          return new ot({
            location: "gpu-buffer",
            type: r ?? "float32",
            gpuBuffer: e,
        ...
        (ga = () => {
          if (!ha) {
            ...
            let e = typeof BigInt64Array < "u" && BigInt64Array.from,
              ...
              r = typeof Float16Array < "u" && Float16Array.from;
            e &&
              (cr.set("int64", BigInt64Array), Qr.set(BigInt64Array, "int64")),
              t &&
                (cr.set("uint64", BigUint64Array),
                Qr.set(BigUint64Array, "uint64")),
              r
                ? (cr.set("float16", Float16Array),
                  Qr.set(Float16Array, "float16"))
                : cr.set("float16", Uint16Array);
          }
        });
    });
  var ba,
        ...
        for (let r = 0; r < e.length; r++) {
          ...
          if (n < 0)
            throw new RangeError(
              `dims[${r}] must be a non-negative integer, got: ${n}`
            );
          t *= n;
        }
        return t;
          ...
          if (typeof t == "object" && "location" in t)
            switch (
              ...
              case "cpu-pinned": {
                ...
                if (!d)
                  throw new TypeError(
                    `unsupported type "${i}" to create tensor from pinned buffer`
                  );
                if (!(t.data instanceof d))
                  throw new TypeError(`buffer should be of type ${d.name}`);
                this.cpuData = t.data;
                break;
              }
              case "texture": {
                if (i !== "float32")
                  throw new TypeError(
                    `unsupported type "${i}" to create tensor from texture`
                  );
              ...
              case "gpu-buffer": {
                if (
                  ...
                  throw new TypeError(
                    `unsupported type "${i}" to create tensor from gpu buffer`
                  );
              ...
              if (((i = t), (c = n), t === "string")) {
                ...
                if (Array.isArray(r)) {
                  ...
                  t === "uint64" || t === "int64"
                    ? (d = m.from(r, BigInt))
                    : (d = m.from(r));
                } else if (r instanceof m) d = r;
                else
                  throw new TypeError(
                    `A ${i} tensor's data must be type of ${m}`
                  );
              }
            else if (((c = r), Array.isArray(t))) {
              if (t.length === 0)
                throw new TypeError(
                  "Tensor type cannot be inferred from an empty array."
                );
              let m = typeof t[0];
              if (m === "string") (i = "string"), (d = t);
              else if (m === "boolean") (i = "bool"), (d = Uint8Array.from(t));
              else
                throw new TypeError(
                  `Invalid element type of data array: ${m}.`
                );
            } else {
              let m = Qr.get(t.constructor);
              if (m === void 0)
                throw new TypeError(
            ...
            if (c === void 0) c = [d.length];
            else if (!Array.isArray(c))
              throw new TypeError("A tensor's dims must be a number array");
            (s = c), (this.cpuData = d), (this.dataLocation = "cpu");
          }
          let a = ba(s);
          if (this.cpuData && a !== this.cpuData.length)
            throw new Error(
              `Tensor's size(${a}) does not match data length(${this.cpuData.length}).`
            );
          (this.type = i), (this.dims = s), (this.size = a);
        }
  ...
  var Jr,
    ...
    zi = j(() => {
      ...
      Pi();
      (Jr = (e, t) => {
        (typeof yt.trace > "u" ? !yt.wasm.trace : !yt.trace) ||
        ...
        ($a = (e, t) => {
          ...
          for (let i = 0; i < r.length; i++) {
            if (n && !r[i].includes("TRACE_FUNC")) {
              let s = `FUNC_${e}::${r[i].trim().split(" ")[1]}`;
              t && (s += `::${t}`), Jr("CPU", s);
              return;
            }
            r[i].includes("TRACE_FUNC") && (n = !0);
          }
        }),
        (lt = (e) => {
          (typeof yt.trace > "u" ? !yt.wasm.trace : !yt.trace) ||
        ...
        (at = (e) => {
          (typeof yt.trace > "u" ? !yt.wasm.trace : !yt.trace) || $a("END", e);
        });
    });
  var Dn,
    _a = j(() => {
      ...
      Dn = class e {
        ...
        async run(t, r, n) {
          ...
          if (typeof r == "object") {
            ...
            if (Array.isArray(r)) {
              ...
              for (let m of r) {
                ...
                if (this.outputNames.indexOf(m) === -1)
                  throw new RangeError(
                    `'fetches' contains invalid output name: ${m}.`
                  );
                i[m] = null;
              }
          ...
          for (let m of this.inputNames)
            if (typeof t[m] > "u")
              throw new Error(`input '${m}' is missing in 'feeds'.`);
          if (a) for (let m of this.outputNames) i[m] = null;
          let d = await this.handler.run(t, i, s),
            c = {};
          for (let m in d)
            if (Object.hasOwnProperty.call(d, m)) {
              ...
              u instanceof et
                ? (c[m] = u)
                : (c[m] = new et(u.type, u.data, u.dims));
            }
          return at(), c;
        }
        async release() {
        ...
        static async create(t, r, n, i) {
          ...
          let s,
            a = {};
          if (typeof t == "string") {
            if (((s = t), typeof r == "object" && r !== null)) a = r;
            else if (typeof r < "u")
              throw new TypeError("'options' must be an object.");
            ...
            if (typeof r == "object" && r !== null) a = r;
              ...
              if (((g = r), !Number.isSafeInteger(g)))
                throw new RangeError("'byteOffset' must be an integer.");
              if (g < 0 || g >= u.byteLength)
                throw new RangeError(
                  `'byteOffset' is out of range [0, ${u.byteLength}).`
                );
              if (((b = t.byteLength - g), typeof n == "number")) {
                if (((b = n), !Number.isSafeInteger(b)))
                  throw new RangeError("'byteLength' must be an integer.");
                if (b <= 0 || g + b > u.byteLength)
                  throw new RangeError(
                    `'byteLength' is out of range (0, ${u.byteLength - g}].`
                  );
                if (typeof i == "object" && i !== null) a = i;
                else if (typeof i < "u")
                  throw new TypeError("'options' must be an object.");
              } else if (typeof n < "u")
              ...
              throw new TypeError("'options' must be an object.");
            s = new Uint8Array(u, g, b);
          } else
            throw new TypeError(
              "Unexpected argument[0]: must be 'path' or 'buffer'."
            );
          let [d, c] = await Pn(a),
            m = await d.createInferenceSessionHandler(s, c);
          return at(), new e(m);
        }
        startProfiling() {
        ...
        (Mn = class e {
          ...
          static async create(t, r) {
            ...
            if (a.createTrainingSessionHandler) {
              let c = await a.createTrainingSessionHandler(
                t.checkpointState,
                t.trainModel,
                n,
                i,
              ...
              return new e(c, !!t.optimizerModel, !!t.evalModel);
            } else throw new Error(dc);
          }
          typeNarrowingForRunStep(t, r, n, i, s) {
            let a = {},
              d = {};
            if (
              typeof n != "object" ||
            ...
            if (typeof i == "object") {
              ...
              if (Array.isArray(i)) {
                ...
                let m = !1,
                  u = Object.getOwnPropertyNames(i);
                for (let g of r)
                  if (u.indexOf(g) !== -1) {
                    let b = i[g];
                    (b === null || b instanceof et) &&
          ...
          convertHandlerReturnTypeToMapOfTensors(t) {
            ...
            for (let n in t)
              if (Object.hasOwnProperty.call(t, n)) {
                ...
                i instanceof et
                  ? (r[n] = i)
                  : (r[n] = new et(i.type, i.data, i.dims));
              }
            return r;
          }
          async lazyResetGrad() {
          ...
          async runTrainStep(t, r, n) {
            let [i, s] = this.typeNarrowingForRunStep(
              ...
              a = await this.handler.runTrainStep(t, i, s);
          ...
          async runEvalStep(t, r, n) {
            if (this.hasEvalModel) {
              let [i, s] = this.typeNarrowingForRunStep(
                ...
                a = await this.handler.runEvalStep(t, i, s);
              return this.convertHandlerReturnTypeToMapOfTensors(a);
            } else
  ...
  var Da = kr((Ba, Ni) => {
    ...
    var za = (() => {
      ...
      return (
        typeof __filename < "u" && (e ||= __filename),
        function (t = {}) {
          var r = t,
            n,
            i,
          ...
          (r.mountExternalData = (l, f) => {
            (r.eb || (r.eb = new Map())).set(l, f);
          }),
          ...
          let a = () => {
            let l =
              ...
              f =
                ...
                async (..._) => {
                  try {
                    if (r.cb) throw Error("Session already started");
                    let A = (r.cb = { xb: _[0], errors: [] }),
                      z = await y(..._);
                    if (r.cb !== A) throw Error("Session mismatch");
                    r.kb?.flush();
                    let G = A.errors;
                    if (0 < G.length) {
                      let q = await Promise.all(G);
                      if (((q = q.filter((te) => te)), 0 < q.length))
                        throw Error(
                          q.join(`
  `)
                        );
            ...
            (r._OrtCreateSession = l(
              r._OrtCreateSession,
              () => r._OrtCreateSession,
              (y) => (r._OrtCreateSession = y)
            )),
              (r._OrtRun = f(
                l(
                  r._OrtRun,
              ...
              (r._OrtRunWithBinding = f(
                l(
                  r._OrtRunWithBinding,
                  () => r._OrtRunWithBinding,
                  (y) => (r._OrtRunWithBinding = y)
                )
              )),
              (r._OrtBindInput = l(
                r._OrtBindInput,
          ...
          r.jsepInit = (l, f) => {
            if ((a?.(), l === "webgpu")) {
              ...
              let y = r.kb;
              (r.jsepRegisterBuffer = (_, A, z, G) =>
                y.registerBuffer(_, A, z, G)),
                (r.jsepGetBuffer = (_) => y.getBuffer(_)),
                (r.jsepCreateDownloader = (_, A, z) =>
                  y.createDownloader(_, A, z)),
                (r.jsepOnReleaseSession = (_) => {
                  y.onReleaseSession(_);
                }),
                (r.jsepOnRunStart = (_) => y.onRunStart(_));
            }
          };
          ...
          if (b) {
            var T = (Mi(), Yt(Di)),
              S = (Wi(), Yt(Ui));
            ($ = g ? S.dirname($) + "/" : __dirname + "/"),
              (w = (l, f) => (
                (l = Ye(l) ? new URL(l) : S.normalize(l)),
                T.readFileSync(l, f ? void 0 : "utf8")
              )),
              (C = (l) => (
                (l = w(l, !0)), l.buffer || (l = new Uint8Array(l)), l
              )),
              (x = (l, f, y, _ = !0) => {
                (l = Ye(l) ? new URL(l) : S.normalize(l)),
                  T.readFile(l, _ ? void 0 : "utf8", (A, z) => {
                    A ? y(A) : f(_ ? z.buffer : z);
                  });
              }),
              !r.thisProgram &&
            ...
            (u || g) &&
              ...
              (w = (l) => {
                ...
                return f.open("GET", l, !1), f.send(null), f.responseText;
              }),
              g &&
                (C = (l) => {
                  var f = new XMLHttpRequest();
              ...
              (x = (l, f, y) => {
                ...
                _.open("GET", l, !0),
                  ...
                  (_.onload = () => {
                    _.status == 200 || (_.status == 0 && _.response)
                      ? f(_.response)
                      : y();
                  }),
                  (_.onerror = y),
          ...
          var E = console.log.bind(console),
            k = console.error.bind(console);
          Object.assign(r, d), (d = null);
          var P,
            R = !1,
            L,
            V,
          ...
          function Ie() {
            var l = P.buffer;
            (r.HEAP8 = V = new Int8Array(l)),
              (r.HEAP16 = Q = new Int16Array(l)),
              (r.HEAPU8 = Y = new Uint8Array(l)),
              (r.HEAPU16 = he = new Uint16Array(l)),
              (r.HEAP32 = N = new Int32Array(l)),
              (r.HEAPU32 = se = new Uint32Array(l)),
              (r.HEAPF32 = Ce = new Float32Array(l)),
              (r.HEAPF64 = ae = new Float64Array(l)),
              (r.HEAP64 = Ve = new BigInt64Array(l)),
              (r.HEAPU64 = ee = new BigUint64Array(l));
          }
          var me = [],
            oe = [],
            ue = [],
          ...
          function ne(l) {
            throw (
              ...
              (R = !0),
              (L = 1),
              (l = new WebAssembly.RuntimeError(
          ...
          var Se = (l) => l.startsWith("data:application/octet-stream;base64,"),
            Ye = (l) => l.startsWith("file://"),
            Be;
          if (((Be = "ort-wasm-simd.wasm"), !Se(Be))) {
            var Ge = Be;
            Be = r.locateFile ? r.locateFile(Ge, $) : $ + Ge;
          }
          function Ft(l) {
            if (C) return C(l);
            ...
            if (u || g) {
              ...
              if (x)
                return new Promise((f, y) => {
                  x(l, (_) => f(new Uint8Array(_)), y);
                });
            }
            return Promise.resolve().then(() => Ft(l));
          }
          function Xe(l, f, y) {
            return He(l)
              .then((_) => WebAssembly.instantiate(_, f))
              .then(y, (_) => {
                k(`failed to asynchronously prepare wasm: ${_}`), ne(_);
              });
          }
          function bt(l, f) {
            var y = Be;
            return typeof WebAssembly.instantiateStreaming != "function" ||
              ...
              ? Xe(y, l, f)
              : fetch(y, { credentials: "same-origin" }).then((_) =>
                  WebAssembly.instantiateStreaming(_, l).then(f, function (A) {
                    return (
          ...
          var Nt = {
            824920: (l, f, y, _) => {
              if (typeof r > "u" || !r.eb) return 1;
              if (
                ((l = Ke(l >>> 0)),
                l.startsWith("./") && (l = l.substring(2)),
                (l = r.eb.get(l)),
                !l)
              )
                return 2;
              if (((f >>>= 0), (y >>>= 0), f + y > l.byteLength)) return 3;
              try {
                return Y.set(l.subarray(f, f + y), (_ >>> 0) >>> 0), 0;
              } catch {
                return 4;
              }
            },
            ...
            826062: (l) => {
              r.Ra("Sigmoid", l, void 0);
            },
            826117: (l, f, y) => {
              r.Ra("HardSigmoid", l, { alpha: f, beta: y });
            },
            826196: (l) => {
              r.Ra("Log", l, void 0);
            },
            ...
            827153: (l, f) => {
              r.Ra("LeakyRelu", l, { alpha: f });
            },
            827217: (l, f) => {
              r.Ra("ThresholdedRelu", l, { alpha: f });
            },
            827287: (l, f) => {
              r.Ra("Cast", l, { to: f });
            },
            ...
            827653: (l) => {
              r.Ra("Greater", l, void 0);
            },
            827708: (l) => {
              r.Ra("GreaterOrEqual", l, void 0);
            },
            827770: (l) => {
              r.Ra("Less", l, void 0);
            },
            827822: (l) => {
              r.Ra("LessOrEqual", l, void 0);
            },
            827881: (l, f, y, _, A) => {
              r.Ra("ReduceMean", l, {
                keepDims: !!f,
                noopWithEmptyAxes: !!y,
                axes: _ ? Array.from(N.subarray(_ >>> 0, A >>> 0)) : []
              });
            },
            828040: (l, f, y, _, A) => {
              r.Ra("ReduceMax", l, {
            ...
            829529: (l, f, y) => {
              r.Ra("Transpose", l, {
                perm: f ? Array.from(N.subarray(f >>> 0, y >>> 0)) : []
              });
            },
            829637: (l, f, y, _) => {
              r.Ra("DepthToSpace", l, {
            ...
            829903: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be) => {
              r.Ra("ConvTranspose", l, {
                format: te ? "NHWC" : "NCHW",
                autoPad: f,
                dilations: [y],
                group: _,
                ...
                wIsConst: () => !!V[Z >>> 0],
                outputPadding: le
                  ? Array.from(N.subarray(le >>> 0, Ee >>> 0))
                  : [],
                outputShape: Re
                  ? Array.from(N.subarray(Re >>> 0, B >>> 0))
                  : [],
                activation: Ke(be)
              });
            },
            830304: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B) => {
              r.Ra("ConvTranspose", l, {
                format: q ? "NHWC" : "NCHW",
                autoPad: f,
                dilations: Array.from(
                  N.subarray(y >>> 0, ((y >>> 0) + 2) >>> 0)
                ),
                group: _,
                kernelShape: Array.from(
                  N.subarray(A >>> 0, ((A >>> 0) + 2) >>> 0)
                ),
                pads: Array.from(N.subarray(z >>> 0, ((z >>> 0) + 4) >>> 0)),
                strides: Array.from(N.subarray(G >>> 0, ((G >>> 0) + 2) >>> 0)),
                wIsConst: () => !!V[te >>> 0],
                outputPadding: Z
                  ? Array.from(N.subarray(Z >>> 0, le >>> 0))
                  : [],
                outputShape: Ee
                  ? Array.from(N.subarray(Ee >>> 0, Re >>> 0))
                  : [],
                activation: Ke(B)
              });
            },
            830869: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be) => {
              r.Ra("ConvTranspose", l, {
                format: te ? "NHWC" : "NCHW",
                autoPad: f,
                dilations: [y],
            ...
            831270: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B) => {
              r.Ra("ConvTranspose", l, {
                format: q ? "NHWC" : "NCHW",
                autoPad: f,
                dilations: Array.from(
            ...
            831835: (l, f) => {
              r.Ra("GlobalAveragePool", l, { format: f ? "NHWC" : "NCHW" });
            },
            831926: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be, Te) => {
              r.Ra("AveragePool", l, {
                format: Te ? "NHWC" : "NCHW",
                auto_pad: f,
                ceil_mode: y,
            ...
            832301: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be, Te) => {
              r.Ra("AveragePool", l, {
                format: Te ? "NHWC" : "NCHW",
                auto_pad: f,
                ceil_mode: y,
            ...
            832585: (l, f) => {
              r.Ra("GlobalMaxPool", l, { format: f ? "NHWC" : "NCHW" });
            },
            832672: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be, Te) => {
              r.Ra("MaxPool", l, {
                format: Te ? "NHWC" : "NCHW",
                auto_pad: f,
                ceil_mode: y,
            ...
            833039: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be, Te) => {
              r.Ra("MaxPool", l, {
                format: Te ? "NHWC" : "NCHW",
                auto_pad: f,
                ceil_mode: y,
            ...
            833319: (l, f, y, _, A) => {
              r.Ra("Gemm", l, { alpha: f, beta: y, transA: _, transB: A });
            },
            833423: (l) => {
              r.Ra("MatMul", l, void 0);
            },
            833477: (l, f, y, _) => {
              r.Ra("ArgMax", l, {
                keepDims: !!f,
            ...
            833693: (l, f) => {
              r.Ra("Softmax", l, { axis: f });
            },
            833756: (l, f) => {
              r.Ra("Concat", l, { axis: f });
            },
            833816: (l, f, y, _, A) => {
              r.Ra("Split", l, {
                axis: f,
                numOutputs: y,
                splitSizes: _ ? Array.from(N.subarray(_ >>> 0, A >>> 0)) : []
              });
            },
            833956: (l) => {
              r.Ra("Expand", l, void 0);
            },
            834010: (l, f) => {
              r.Ra("Gather", l, { axis: Number(f) });
            },
            834081: (l, f) => {
              r.Ra("GatherElements", l, { axis: Number(f) });
            },
            834160: (l, f, y, _, A, z, G, q, te, Z, le) => {
              r.Ra("Resize", l, {
                antialias: f,
                axes: y ? Array.from(N.subarray(y >>> 0, _ >>> 0)) : [],
                coordinateTransformMode: Ke(A),
                cubicCoeffA: z,
                excludeOutside: G,
                extrapolationValue: q,
                keepAspectRatioPolicy: Ke(te),
                mode: Ke(Z),
                nearestMode: Ke(le)
              });
            },
            834506: (l, f, y, _, A, z, G) => {
              r.Ra("Slice", l, {
                starts: f ? Array.from(N.subarray(f >>> 0, y >>> 0)) : [],
                ends: _ ? Array.from(N.subarray(_ >>> 0, A >>> 0)) : [],
                axes: z ? Array.from(N.subarray(z >>> 0, G >>> 0)) : []
              });
            },
            834722: (l) => {
              r.Ra("Tile", l, void 0);
            ...
            835166: (l, f) => {
              r.Ra("Einsum", l, { equation: Ke(f) });
            },
            835247: (l, f, y, _, A) => {
              r.Ra("Pad", l, {
                mode: f,
                value: y,
                pads: _ ? Array.from(N.subarray(_ >>> 0, A >>> 0)) : []
              });
            },
            835374: (l, f, y, _, A, z) => {
              r.Ra("BatchNormalization", l, {
                epsilon: f,
                momentum: y,
                spatial: !!A,
                trainingMode: !!_,
            ...
            835712: (l, f, y) => {
              r.Ra("CumSum", l, { exclusive: Number(f), reverse: Number(y) });
            },
            835809: (l, f, y, _, A, z, G, q, te) => {
              r.Ra("Attention", l, {
                numHeads: f,
                isUnidirectional: y,
                maskFilterValue: _,
                ...
                qkvHiddenSizes: G
                  ? Array.from(
                      N.subarray(Number(q) >>> 0, (Number(q) + G) >>> 0)
                    )
                  : [],
                pastPresentShareBuffer: !!te
              });
            },
            836081: (l) => {
              r.Ra("BiasAdd", l, void 0);
            },
            836136: (l) => {
              r.Ra("BiasSplitGelu", l, void 0);
            },
            836197: (l) => {
              r.Ra("FastGelu", l, void 0);
            },
            836253: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re) => {
              r.Ra("Conv", l, {
                format: te ? "NHWC" : "NCHW",
                auto_pad: f,
                dilations: [y],
                group: _,
                kernel_shape: [A],
                pads: z ? Array.from(N.subarray(z >>> 0, G >>> 0)) : [],
                strides: [q],
                w_is_const: () => !!V[Z >>> 0],
                activation: Ke(le),
                activation_params: Ee
                  ? Array.from(Ce.subarray(Ee >>> 0, Re >>> 0))
                  : []
              });
            },
            836623: (l, f, y, _, A, z, G, q, te, Z, le, Ee, Re, B, be, Te) => {
              r.Ra("Conv", l, {
                format: Ee ? "NHWC" : "NCHW",
                auto_pad: f,
                dilations: [y, _],
                group: A,
                kernel_shape: [z, G],
                pads: q ? Array.from(N.subarray(q >>> 0, te >>> 0)) : [],
                strides: [Z, le],
                w_is_const: () => !!V[Re >>> 0],
                activation: Ke(B),
                activation_params: be
                  ? Array.from(Ce.subarray(be >>> 0, Te >>> 0))
                  : []
              });
            },
            837014: (l) => {
            ...
            837352: (l, f, y, _, A) => {
              r.Ra("RotaryEmbedding", l, {
                interleaved: !!f,
                numHeads: y,
                rotaryEmbeddingDim: _,
                scale: A
              });
            },
            837491: (l, f, y) => {
              r.Ra("SkipLayerNormalization", l, {
                epsilon: f,
                simplified: !!y
              });
            },
            ...
            837840: (l, f) => r.wb(l, f, r.cb.xb, r.cb.errors)
          };
          function er(l) {
          ...
          var br = 0,
            tr = 0,
            Dr = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0,
            rr = (l, f, y) => {
              f >>>= 0;
              var _ = f + y;
              for (y = f; l[y] && !(y >= _); ) ++y;
              if (16 < y - f && l.buffer && Dr)
                return Dr.decode(l.subarray(f, y));
              for (_ = ""; f < y; ) {
                var A = l[f++];
                if (A & 128) {
                  var z = l[f++] & 63;
                  if ((A & 224) == 192)
                    _ += String.fromCharCode(((A & 31) << 6) | z);
                  else {
                    var G = l[f++] & 63;
                    (A =
                      (A & 240) == 224
            ...
            ct = (l, f, y, _) => {
              ...
              for (var z = 0; z < l.length; ++z) {
                var G = l.charCodeAt(z);
                if (55296 <= G && 57343 >= G) {
                  var q = l.charCodeAt(++z);
                  G = (65536 + ((G & 1023) << 10)) | (q & 1023);
                }
                if (127 >= G) {
                  if (y >= _) break;
                  f[y++ >>> 0] = G;
          ...
          function Nr(l, f, y = {}) {
            ...
            if (Ur.hasOwnProperty(l)) {
              if (y.nb) return;
              throw new pt(`Cannot register type '${_}' twice`);
            }
            (Ur[l] = f),
              delete Wr[l],
              vr.hasOwnProperty(l) &&
                ((f = vr[l]), delete vr[l], f.forEach((A) => A()));
          }
          function wt(l, f, y = {}) {
              ...
              switch (f) {
                ...
                case 4:
                  return y
                    ...
                    : (_) => se[(_ >>> 2) >>> 0];
                case 8:
                  return y ? (_) => Ve[_ >>> 3] : (_) => ee[_ >>> 3];
                default:
                  throw new TypeError(`invalid integer width (${f}): ${l}`);
              }
            },
            Vr = [],
            Ae = [];
          function wr(l) {
            (l >>>= 0),
              9 < l && --Ae[l + 1] === 0 && ((Ae[l] = void 0), Vr.push(l));
          }
          var Qe = (l) => {
              if (!l) throw new pt("Cannot use deleted val. handle = " + l);
              return Ae[l];
            },
            mt = (l) => {
              switch (l) {
                ...
                case !1:
                  return 8;
                default:
                  let f = Vr.pop() || Ae.length;
                  return (Ae[f] = l), (Ae[f + 1] = 1), f;
              }
            };
          function $r(l) {
            return this.fromWireType(se[(l >>> 2) >>> 0]);
          }
          var gi = {
              name: "emscripten::val",
              fromWireType: (l) => {
            ...
            ge = (l, f) => {
              switch (f) {
                case 4:
                  return function (y) {
                    return this.fromWireType(Ce[(y >>> 2) >>> 0]);
                  };
                case 8:
                  return function (y) {
                    return this.fromWireType(ae[(y >>> 3) >>> 0]);
                  };
                default:
                  throw new TypeError(`invalid float width (${f}): ${l}`);
              }
            },
            nr =
              typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0,
            ln = (l, f) => {
              for (var y = l >> 1, _ = y + f / 2; !(y >= _) && he[y >>> 0]; )
                ++y;
              if (((y <<= 1), 32 < y - l && nr))
                return nr.decode(Y.subarray(l >>> 0, y >>> 0));
              for (y = "", _ = 0; !(_ >= f / 2); ++_) {
                var A = Q[((l + 2 * _) >>> 1) >>> 0];
                if (A == 0) break;
            ...
            yi = (l, f, y) => {
              if (((y ??= 2147483647), 2 > y)) return 0;
              y -= 2;
              var _ = f;
              y = y < 2 * l.length ? y / 2 : l.length;
              for (var A = 0; A < y; ++A)
                (Q[(f >>> 1) >>> 0] = l.charCodeAt(A)), (f += 2);
              return (Q[(f >>> 1) >>> 0] = 0), f - _;
            },
            dn = (l) => 2 * l.length,
            bi = (l, f) => {
              for (var y = 0, _ = ""; !(y >= f / 4); ) {
            ...
            cn = (l, f, y) => {
              if (((f >>>= 0), (y ??= 2147483647), 4 > y)) return 0;
              var _ = f;
              y = _ + y - 4;
              for (var A = 0; A < l.length; ++A) {
                var z = l.charCodeAt(A);
                if (55296 <= z && 57343 >= z) {
                  var G = l.charCodeAt(++A);
                  z = (65536 + ((z & 1023) << 10)) | (G & 1023);
                }
                if (((N[(f >>> 2) >>> 0] = z), (f += 4), f + 4 > y)) break;
              }
              return (N[(f >>> 2) >>> 0] = 0), f - _;
            },
            pn = (l) => {
              for (var f = 0, y = 0; y < l.length; ++y) {
                var _ = l.charCodeAt(y);
                55296 <= _ && 57343 >= _ && ++y, (f += 4);
              }
              return f;
            },
            _r = (l, f) => {
            ...
            mn = (l) => {
              if (!R)
                try {
                  l();
                  try {
                    (L = L = l = L), r.onExit?.(l), (R = !0), m(l, new er(l));
                  } catch (f) {
                    f instanceof er || f == "unwind" || m(1, f);
                  }
                } catch (f) {
                  f instanceof er || f == "unwind" || m(1, f);
                }
                ...
                l((_ = 0) => {
                  if (!R && ((Vt = _), (f = !0), y)) {
                    ...
                    if (!ft) {
                      var G = xr;
                      G &&
                        ((xr = null), (_ ? G.reject : G.resolve)(A), (z = !0));
                    }
                    if (_ && !z) throw A;
                  }
                }),
                  ...
                  f ||
                    (($t = 1),
                    (ft = bn()),
                    typeof Browser < "u" && Browser.ib.mb && Browser.ib.pause(),
                    Le(() => sr(ft)));
              } else
                $t === 2
                  ? (($t = 0), Le(gt), it(ft), (ft = null), gn.forEach(mn))
                  : ne(`invalid state: ${$t}`);
              return Vt;
            }
          }
          ...
          var or = [],
            ...
            vi = (l, f) => {
              for (var y = Array(l), _ = 0; _ < l; ++_)
                y[_] = _r(se[((f + 4 * _) >>> 2) >>> 0], "parameter " + _);
              return y;
            },
            It = (l, f) => Object.defineProperty(f, "name", { value: l });
          function wi(l) {
            var f = Function;
            if (!(f instanceof Function))
              throw new TypeError(
                `new_ called with constructor type ${typeof f} which is not a function`
              );
            var y = It(f.name || "unknownFunctionName", function () {});
            return (
              (y.prototype = f.prototype),
              (y = new y()),
              (l = f.apply(y, l)),
              l instanceof Object ? l : y
            );
          }
          var tt = (l) => l % 4 === 0 && (l % 100 !== 0 || l % 400 === 0),
            jr = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
            Cr = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
            ht = [],
            Ir = (l, f) => {
              ht.length = 0;
              for (var y; (y = Y[l++ >>> 0]); ) {
            ...
            ut = () => {
              if (!ar) {
                var l = {
                  ...
                  f;
                for (f in Je) Je[f] === void 0 ? delete l[f] : (l[f] = Je[f]);
                var y = [];
                for (f in l) y.push(`${f}=${l[f]}`);
                ar = y;
              }
              return ar;
            },
          ...
          function _n(l, f, y, _) {
            ...
            function G(B, be) {
              function Te(Lt) {
                return 0 > Lt ? -1 : 0 < Lt ? 1 : 0;
              }
              var Gt;
              return (
                (Gt = Te(B.getFullYear() - be.getFullYear())) === 0 &&
                  (Gt = Te(B.getMonth() - be.getMonth())) === 0 &&
                  (Gt = Te(B.getDate() - be.getDate())),
                Gt
              );
            }
            function q(B) {
            ...
            function te(B) {
              var be = B.$a;
              for (
                B = new Date(new Date(B.ab + 1900, 0, 1).getTime());
                0 < be;

              ) {
                var Te = B.getMonth(),
                  Gt = (tt(B.getFullYear()) ? $n : Kr)[Te];
                if (be > Gt - B.getDate())
                  (be -= Gt - B.getDate() + 1),
                    B.setDate(1),
                    11 > Te
                      ? B.setMonth(Te + 1)
                      : (B.setMonth(0), B.setFullYear(B.getFullYear() + 1));
                else {
                  B.setDate(B.getDate() + be);
                  break;
                }
              }
              return (
                (Te = new Date(B.getFullYear() + 1, 0, 4)),
                (be = q(new Date(B.getFullYear(), 0, 4))),
                (Te = q(Te)),
                0 >= G(be, B)
                  ? 0 >= G(Te, B)
                    ? B.getFullYear() + 1
            ...
            for (var le in Z) y = y.replace(new RegExp(le, "g"), Z[le]);
            var Ee =
            ...
            (Z = {
              "%a": (B) => Ee[B.Va].substring(0, 3),
              "%A": (B) => Ee[B.Va],
              "%b": (B) => Re[B.gb].substring(0, 3),
              "%B": (B) => Re[B.gb],
              "%C": (B) => z(((B.ab + 1900) / 100) | 0, 2),
              "%d": (B) => z(B.jb, 2),
              "%e": (B) => A(B.jb, 2, " "),
              "%g": (B) => te(B).toString().substring(2),
              "%G": te,
              "%H": (B) => z(B.fb, 2),
              "%I": (B) => (
                (B = B.fb), B == 0 ? (B = 12) : 12 < B && (B -= 12), z(B, 2)
              ),
              "%j": (B) => {
                for (
                  var be = 0, Te = 0;
                  Te <= B.gb - 1;
                  be += (tt(B.ab + 1900) ? $n : Kr)[Te++]
                );
                return z(B.jb + be, 3);
              },
              "%m": (B) => z(B.gb + 1, 2),
              ...
              "%n": () => `
  `,
              "%p": (B) => (0 <= B.fb && 12 > B.fb ? "AM" : "PM"),
              "%S": (B) => z(B.Ab, 2),
              "%t": () => "	",
              "%u": (B) => B.Va || 7,
              "%U": (B) => z(Math.floor((B.$a + 7 - B.Va) / 7), 2),
              "%V": (B) => {
                var be = Math.floor((B.$a + 7 - ((B.Va + 6) % 7)) / 7);
                if ((2 >= (B.Va + 371 - B.$a - 2) % 7 && be++, be))
                  be == 53 &&
                    ((Te = (B.Va + 371 - B.$a) % 7),
                    Te == 4 || (Te == 3 && tt(B.ab)) || (be = 1));
                else {
                  be = 52;
                  var Te = (B.Va + 7 - B.$a - 1) % 7;
                  (Te == 4 || (Te == 5 && tt((B.ab % 400) - 1))) && be++;
                }
                return z(be, 2);
              },
              "%w": (B) => B.Va,
              "%W": (B) => z(Math.floor((B.$a + 7 - ((B.Va + 6) % 7)) / 7), 2),
              "%y": (B) => (B.ab + 1900).toString().substring(2),
              "%Y": (B) => B.ab + 1900,
              "%z": (B) => {
                B = B.yb;
                var be = 0 <= B;
              ...
              (y = y.replace(/%%/g, "\0\0"));
            for (le in Z)
              y.includes(le) && (y = y.replace(new RegExp(le, "g"), Z[le](_)));
            return (
              (y = y.replace(/\0\0/g, "%")),
              (le = _i(y)),
              le.length > f ? 0 : (V.set(le, l >>> 0), le.length - 1)
            );
          }
          for (var xn = Array(256), Tr = 0; 256 > Tr; ++Tr)
            xn[Tr] = String.fromCharCode(Tr);
          (Mr = xn),
            (pt = r.BindingError =
              class extends Error {
                constructor(l) {
            ...
            Ae.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1),
            (r.count_emval_handles = () => Ae.length / 2 - 5 - Vr.length);
          var xi = {
              ia: function (l, f, y) {
                return Fr(async () => {
                  await r.sb(l, f, y);
                            ...
                            : ((_ = typeof A),
                              (A =
                                ...
                                _ === "function"
                                  ...
                                  : "" + A)),
                          new TypeError(
                            `Cannot convert "${A}" to ${this.name}`
                          ))
                        );
                      return typeof A == "number" && (A = BigInt(A)), A;
                    },
                    argPackAdvance: 8,
                    readValueFromPointer: Ct(f, y >>> 0, f.indexOf("u") == -1),
                    bb: null
                  });
              },
              K: function (l, f, y, _) {
                (f = vt(f >>> 0)),
                  wt(l >>> 0, {
                    ...
                    toWireType: function (A, z) {
                      return z ? y : _;
                    },
                    argPackAdvance: 8,
                    readValueFromPointer: function (A) {
                      return this.fromWireType(Y[A >>> 0]);
                    },
                    bb: null
                  });
              },
              ...
              B: function (l, f, y) {
                (f = vt(f >>> 0)),
                  wt(l >>> 0, {
                    ...
                    toWireType: (_, A) => A,
                    argPackAdvance: 8,
                    readValueFromPointer: ge(f, y >>> 0),
                    bb: null
                  });
              },
              s: function (l, f, y, _, A) {
                if (
                  ((l >>>= 0),
                  (y >>>= 0),
                  (f = vt(f >>> 0)),
                ...
                wt(l, {
                  ...
                  toWireType: G,
                  argPackAdvance: 8,
                  readValueFromPointer: Ct(f, y, _ !== 0),
                  bb: null
                });
              },
              o: function (l, f, y) {
                ...
                wt(l >>> 0, {
                  ...
                  fromWireType: function (_) {
                    var A = se[(_ >>> 2) >>> 0],
                      z = _ + 4;
                    if (y)
                      for (var G = z, q = 0; q <= A; ++q) {
                        var te = z + q;
                        if (q == A || Y[te >>> 0] == 0) {
                          if (((G = Ke(G, te - G)), Z === void 0)) var Z = G;
                          else (Z += String.fromCharCode(0)), (Z += G);
                          G = te + 1;
                        }
                      }
                    else {
                      for (Z = Array(A), q = 0; q < A; ++q)
                        Z[q] = String.fromCharCode(Y[(z + q) >>> 0]);
                      Z = Z.join("");
                    }
                    return it(_), Z;
                  },
                  toWireType: function (_, A) {
                    ...
                    if (
                      ...
                      throw new pt("Cannot pass non-string to std::string");
                    var G = y && z ? jt(A) : A.length,
                      q = Kt(4 + G + 1),
                      te = q + 4;
                    if (((se[(q >>> 2) >>> 0] = G), y && z))
                      ct(A, Y, te, G + 1);
                    ...
                    else for (z = 0; z < G; ++z) Y[(te + z) >>> 0] = A[z];
                    return _ !== null && _.push(it, q), q;
                  },
                  argPackAdvance: 8,
                  readValueFromPointer: $r,
                  bb(_) {
              ...
              w: function (l) {
                return (l >>>= 0), Fr(() => ((l = Qe(l)), l.then(mt)));
              },
              n: function (l, f, y, _) {
                return (
                  (y >>>= 0),
              ...
              b: wr,
              A: function (l, f) {
                return (f >>>= 0), (l = Qe(l >>> 0)), (f = Qe(f)), l == f;
              },
              m: function (l) {
                return (
                  (l >>>= 0), l === 0 ? mt(Sr()) : ((l = st(l)), mt(Sr()[l]))
                );
              },
              i: function (l, f, y) {
                f = vi(l, f >>> 0);
  ...
  `,
                  ...
                  G = [];
                y === 0 && G.push("obj");
                for (var q = ["retType"], te = [_], Z = 0; Z < l; ++Z)
                  G.push("arg" + Z),
                    q.push("argType" + Z),
                    te.push(f[Z]),
                    (A += `  var arg${Z} = argType${Z}.readValueFromPointer(args${z ? "+" + z : ""});
  `),
                    (z += f[Z].argPackAdvance);
                return (
                  (A += `  var rv = ${y === 1 ? "new func" : "func.call"}(${G.join(", ")});
  `),
                  _.ob ||
                    (q.push("emval_returnValue"),
                    te.push(Hr),
                    (A += `  return emval_returnValue(retType, destructorsRef, rv);
  `)),
                  q.push(
                    A +
                      `};
  `
                  ...
                  (l = wi(q)(...te)),
                  (y = `methodCaller<(${f.map((le) => le.name).join(", ")}) => ${_.name}>`),
                  qr(It(y, l))
                );
              },
              r: function (l, f) {
                return (f >>>= 0), (l = Qe(l >>> 0)), (f = Qe(f)), mt(l[f]);
              },
              e: function (l) {
                (l >>>= 0), 9 < l && (Ae[l + 1] += 1);
              },
              ...
              l: function (l) {
                l = Qe(l >>> 0);
                for (var f = Array(l.length), y = 0; y < l.length; y++)
                  f[y] = l[y];
                return mt(f);
              },
              f: function (l) {
              ...
              c: function (l, f) {
                return (
                  (f >>>= 0),
                  (l = _r(l >>> 0, "_emval_take_value")),
                  (l = l.readValueFromPointer(f)),
                  mt(l)
                );
              },
              W: function (l, f) {
                (l =
                  -9007199254740992 > l || 9007199254740992 < l
                    ? NaN
                    : Number(l)),
                  (f >>>= 0),
                  (l = new Date(1e3 * l)),
                  (N[(f >>> 2) >>> 0] = l.getUTCSeconds()),
                  (N[((f + 4) >>> 2) >>> 0] = l.getUTCMinutes()),
                  (N[((f + 8) >>> 2) >>> 0] = l.getUTCHours()),
                  (N[((f + 12) >>> 2) >>> 0] = l.getUTCDate()),
                  (N[((f + 16) >>> 2) >>> 0] = l.getUTCMonth()),
                  (N[((f + 20) >>> 2) >>> 0] = l.getUTCFullYear() - 1900),
                  (N[((f + 24) >>> 2) >>> 0] = l.getUTCDay()),
                  (N[((f + 28) >>> 2) >>> 0] =
                    ((l.getTime() -
                      Date.UTC(l.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) /
                      864e5) |
                    0);
              },
              X: function (l, f) {
                (l =
                  ...
                  (f >>>= 0),
                  (l = new Date(1e3 * l)),
                  (N[(f >>> 2) >>> 0] = l.getSeconds()),
                  (N[((f + 4) >>> 2) >>> 0] = l.getMinutes()),
                  (N[((f + 8) >>> 2) >>> 0] = l.getHours()),
                  (N[((f + 12) >>> 2) >>> 0] = l.getDate()),
                  (N[((f + 16) >>> 2) >>> 0] = l.getMonth()),
                  (N[((f + 20) >>> 2) >>> 0] = l.getFullYear() - 1900),
                  (N[((f + 24) >>> 2) >>> 0] = l.getDay()),
                  (N[((f + 28) >>> 2) >>> 0] =
                    ((tt(l.getFullYear()) ? jr : Cr)[l.getMonth()] +
                      l.getDate() -
                      1) |
                    0),
                  (N[((f + 36) >>> 2) >>> 0] = -(60 * l.getTimezoneOffset()));
                var y = new Date(l.getFullYear(), 6, 1).getTimezoneOffset(),
                  _ = new Date(l.getFullYear(), 0, 1).getTimezoneOffset();
                N[((f + 32) >>> 2) >>> 0] =
                  (y != _ && l.getTimezoneOffset() == Math.min(_, y)) | 0;
              },
              Y: function (l) {
                l >>>= 0;
                var f = new Date(
                  ...
                  y = N[((l + 32) >>> 2) >>> 0],
                  _ = f.getTimezoneOffset(),
                  A = new Date(f.getFullYear(), 6, 1).getTimezoneOffset(),
                ...
                return (
                  0 > y
                    ...
                    : 0 < y != (G == _) &&
                      ((A = Math.max(z, A)),
                      f.setTime(f.getTime() + 6e4 * ((0 < y ? G : A) - _))),
                  (N[((l + 24) >>> 2) >>> 0] = f.getDay()),
                  (N[((l + 28) >>> 2) >>> 0] =
                    ((tt(f.getFullYear()) ? jr : Cr)[f.getMonth()] +
                      f.getDate() -
                      1) |
                    0),
                  (N[(l >>> 2) >>> 0] = f.getSeconds()),
                  (N[((l + 4) >>> 2) >>> 0] = f.getMinutes()),
                  (N[((l + 8) >>> 2) >>> 0] = f.getHours()),
                  (N[((l + 12) >>> 2) >>> 0] = f.getDate()),
                  (N[((l + 16) >>> 2) >>> 0] = f.getMonth()),
                  (N[((l + 20) >>> 2) >>> 0] = f.getYear()),
                  (l = f.getTime()),
                  BigInt(isNaN(l) ? -1 : l / 1e3)
                );
              },
              U: function () {
                return -52;
              ...
              N: function (l, f, y, _) {
                ...
                var q = G.getTimezoneOffset();
                (se[((l >>> 0) >>> 2) >>> 0] = 60 * Math.max(A, q)),
                  (N[((f >>> 0) >>> 2) >>> 0] = +(A != q)),
                  (l = (te) =>
                    te
                  ...
                  (G = l(G)),
                  q < A
                    ? (ct(z, Y, y, 17), ct(G, Y, _, 17))
                    : (ct(z, Y, _, 17), ct(G, Y, y, 17));
              },
              v: () => {
                ne("");
              },
              d: function (l, f, y) {
                return (l >>>= 0), (f = Ir(f >>> 0, y >>> 0)), Nt[l](...f);
              },
              I: function (l, f, y) {
                return (l >>>= 0), (f = Ir(f >>> 0, y >>> 0)), Nt[l](...f);
              },
              ...
              M: function (l) {
                l >>>= 0;
                var f = Y.length;
                if (4294901760 < l) return !1;
                for (var y = 1; 4 >= y; y *= 2) {
                  var _ = f * (1 + 0.2 / y);
                  _ = Math.min(_, l + 100663296);
                  var A = Math;
                  _ = Math.max(l, _);
                  e: {
                    A =
              ...
              $: function (l, f) {
                ...
                return (
                  ut().forEach((_, A) => {
                    var z = f + y;
                    for (
                      A = se[((l + 4 * A) >>> 2) >>> 0] = z, z = 0;
                      z < _.length;
                      ++z
                    )
                      V[A++ >>> 0] = _.charCodeAt(z);
                    (V[A >>> 0] = 0), (y += _.length + 1);
                  }),
                  0
                );
              },
            ...
            pe = (function () {
              function l(y) {
                return (
                  ...
                  de--,
                  de == 0 &&
                    (je !== null && (clearInterval(je), (je = null)),
                    H && ((y = H), (H = null), y())),
                  pe
                );
              }
              var f = { a: xi };
              if ((de++, r.instantiateWasm))
                try {
                  return r.instantiateWasm(f, l);
                } catch (y) {
                  k(`Module.instantiateWasm callback failed with error: ${y}`),
                    i(y);
                }
              return (
                bt(f, function (y) {
            ...
            Yr = (l) => (Yr = pe.la)(l);
          (r._OrtInit = (l, f) => (r._OrtInit = pe.ma)(l, f)),
            (r._OrtGetLastError = (l, f) => (r._OrtGetLastError = pe.na)(l, f)),
            (r._OrtCreateSessionOptions = (l, f, y, _, A, z, G, q, te, Z) =>
              (r._OrtCreateSessionOptions = pe.oa)(
                l,
                f,
                y,
                _,
            ...
            (r._OrtAppendExecutionProvider = (l, f) =>
              (r._OrtAppendExecutionProvider = pe.pa)(l, f)),
            (r._OrtAddFreeDimensionOverride = (l, f, y) =>
              (r._OrtAddFreeDimensionOverride = pe.qa)(l, f, y)),
            (r._OrtAddSessionConfigEntry = (l, f, y) =>
              (r._OrtAddSessionConfigEntry = pe.ra)(l, f, y)),
            (r._OrtReleaseSessionOptions = (l) =>
              (r._OrtReleaseSessionOptions = pe.sa)(l)),
            (r._OrtCreateSession = (l, f, y) =>
              (r._OrtCreateSession = pe.ta)(l, f, y)),
            (r._OrtReleaseSession = (l) => (r._OrtReleaseSession = pe.ua)(l)),
            (r._OrtGetInputOutputCount = (l, f, y) =>
              (r._OrtGetInputOutputCount = pe.va)(l, f, y)),
            (r._OrtGetInputName = (l, f) => (r._OrtGetInputName = pe.wa)(l, f)),
            (r._OrtGetOutputName = (l, f) =>
              (r._OrtGetOutputName = pe.xa)(l, f)),
            (r._OrtFree = (l) => (r._OrtFree = pe.ya)(l)),
            (r._OrtCreateTensor = (l, f, y, _, A, z) =>
              (r._OrtCreateTensor = pe.za)(l, f, y, _, A, z)),
            (r._OrtGetTensorData = (l, f, y, _, A) =>
              (r._OrtGetTensorData = pe.Aa)(l, f, y, _, A)),
            (r._OrtReleaseTensor = (l) => (r._OrtReleaseTensor = pe.Ba)(l)),
            (r._OrtCreateRunOptions = (l, f, y, _) =>
              (r._OrtCreateRunOptions = pe.Ca)(l, f, y, _)),
            (r._OrtAddRunConfigEntry = (l, f, y) =>
              (r._OrtAddRunConfigEntry = pe.Da)(l, f, y)),
            (r._OrtReleaseRunOptions = (l) =>
              (r._OrtReleaseRunOptions = pe.Ea)(l)),
            (r._OrtCreateBinding = (l) => (r._OrtCreateBinding = pe.Fa)(l)),
            (r._OrtBindInput = (l, f, y) => (r._OrtBindInput = pe.Ga)(l, f, y)),
            (r._OrtBindOutput = (l, f, y, _) =>
              (r._OrtBindOutput = pe.Ha)(l, f, y, _)),
            (r._OrtClearBoundOutputs = (l) =>
              (r._OrtClearBoundOutputs = pe.Ia)(l)),
            (r._OrtReleaseBinding = (l) => (r._OrtReleaseBinding = pe.Ja)(l)),
            (r._OrtRunWithBinding = (l, f, y, _, A) =>
              (r._OrtRunWithBinding = pe.Ka)(l, f, y, _, A)),
            (r._OrtRun = (l, f, y, _, A, z, G, q) =>
              (r._OrtRun = pe.La)(l, f, y, _, A, z, G, q)),
            (r._OrtEndProfiling = (l) => (r._OrtEndProfiling = pe.Ma)(l)),
            (r._JsepOutput = (l, f, y) => (r._JsepOutput = pe.Na)(l, f, y)),
            (r._JsepGetNodeName = (l) => (r._JsepGetNodeName = pe.Oa)(l));
          var Kt = (r._malloc = (l) => (Kt = r._malloc = pe.Pa)(l)),
            it = (r._free = (l) => (it = r._free = pe.Qa)(l)),
            Ar = (l) => (Ar = pe.Sa)(l),
            Er = (l) => (Er = pe.Ta)(l),
            Xr = () => (Xr = pe.Ua)(),
            sr = (l) => (sr = pe.Wa)(l),
            ...
            Tt = (l) => (Tt = pe.Ya)(l),
            gt = () => (gt = pe.Za)();
          (r.___start_em_js = 837952), (r.___stop_em_js = 838113);
          function Cn() {
            var l = pe;
            l = Object.assign({}, l);
            var f = (y) => (_) => y(_) >>> 0;
          ...
          (r.stackSave = () => Xr()),
            (r.stackRestore = (l) => Ar(l)),
            (r.stackAlloc = (l) => Er(l)),
            (r.UTF8ToString = Ke),
            (r.stringToUTF8 = (l, f, y) => ct(l, Y, f, y)),
            (r.lengthBytesUTF8 = jt);
          var Ht;
          H = function l() {
            Ht || Zr(), Ht || (H = l);
          };
            ...
            if (!(0 < de)) {
              if (r.preRun)
                for (
                  ...
                  var l = r.preRun.shift();
                  me.unshift(l);
                }
              for (; 0 < me.length; ) me.shift()(r);
              if (!(0 < de || Ht || ((Ht = !0), (r.calledRun = !0), R))) {
                for (; 0 < oe.length; ) oe.shift()(r);
                for (n(r); 0 < ue.length; ) ue.shift()(r);
              }
            }
          }
          return Zr(), s;
    ...
    typeof Ba == "object" && typeof Ni == "object"
      ? (Ni.exports = za)
      : typeof define == "function" && define.amd && define([], () => za);
  });
  var Ma = kr(() => {});
  var Ua = kr(() => {});
  var Wa = {};
  ...
  var Ga = kr((Ha, Vi) => {
    ...
    var Va = (() => {
      ...
      return (
        ...
        function (t = {}) {
          function r() {
            return ae.buffer != ue.buffer && He(), ue;
          }
          function n() {
            return ae.buffer != ue.buffer && He(), de;
          }
          function i() {
            return ae.buffer != ue.buffer && He(), je;
          }
          function s() {
            return ae.buffer != ue.buffer && He(), H;
          }
          function a() {
            return ae.buffer != ue.buffer && He(), ne;
          }
          function d() {
            return ae.buffer != ue.buffer && He(), Se;
          }
          function c() {
            return ae.buffer != ue.buffer && He(), Ye;
          }
          function m() {
            return ae.buffer != ue.buffer && He(), Ft;
          }
          var u = t,
            g,
            b,
          ...
          (u.mountExternalData = (o, p) => {
            (u.Db || (u.Db = new Map())).set(o, p);
          }),
          ...
          let w = () => {
            let o =
              ...
              p =
                ...
                async (...v) => {
                  try {
                    if (u.Cb) throw Error("Session already started");
                    let I = (u.Cb = { ec: v[0], errors: [] }),
                      O = await h(...v);
                    if (u.Cb !== I) throw Error("Session mismatch");
                    u.Kb?.flush();
                    let W = I.errors;
                    if (0 < W.length) {
                      let F = await Promise.all(W);
                      if (((F = F.filter((re) => re)), 0 < F.length))
                        throw Error(
                          F.join(`
  `)
                        );
            ...
            (u._OrtCreateSession = o(
              u._OrtCreateSession,
              () => u._OrtCreateSession,
              (h) => (u._OrtCreateSession = h)
            )),
              (u._OrtRun = p(
                o(
                  u._OrtRun,
              ...
              (u._OrtRunWithBinding = p(
                o(
                  u._OrtRunWithBinding,
                  () => u._OrtRunWithBinding,
                  (h) => (u._OrtRunWithBinding = h)
                )
              )),
              (u._OrtBindInput = o(
                u._OrtBindInput,
          ...
          u.jsepInit = (o, p) => {
            if ((w?.(), o === "webgpu")) {
              ...
              let h = u.Kb;
              (u.jsepRegisterBuffer = (v, I, O, W) =>
                h.registerBuffer(v, I, O, W)),
                (u.jsepGetBuffer = (v) => h.getBuffer(v)),
                (u.jsepCreateDownloader = (v, I, O) =>
                  h.createDownloader(v, I, O)),
                (u.jsepOnReleaseSession = (v) => {
                  h.onReleaseSession(v);
                }),
                (u.jsepOnRunStart = (v) => h.onRunStart(v));
            }
          };
          var x = Object.assign({}, u),
            ...
            R = "";
          function L(o) {
            return u.locateFile ? u.locateFile(o, R) : R + o;
          }
          var V, Y, Q;
          if (k) {
            var he = (Mi(), Yt(Di)),
              N = (Wi(), Yt(Ui));
            (R = E ? N.dirname(R) + "/" : __dirname + "/"),
              (V = (o, p) => (
                (o = jt(o) ? new URL(o) : N.normalize(o)),
                he.readFileSync(o, p ? void 0 : "utf8")
              )),
              (Q = (o) => (
                (o = V(o, !0)), o.buffer || (o = new Uint8Array(o)), o
              )),
              (Y = (o, p, h, v = !0) => {
                (o = jt(o) ? new URL(o) : N.normalize(o)),
                  he.readFile(o, v ? void 0 : "utf8", (I, O) => {
                    I ? h(I) : p(v ? O.buffer : O);
                  });
              }),
              !u.thisProgram &&
                1 < process.argv.length &&
              ...
              process.argv.slice(2),
              (T = (o, p) => {
                throw ((process.exitCode = o), p);
              }),
              (global.Worker = Ma().Worker);
          } else
            (S || E) &&
              (E
              ...
              k ||
                ((V = (o) => {
                  ...
                  return p.open("GET", o, !1), p.send(null), p.responseText;
                }),
                E &&
                  (Q = (o) => {
                    var p = new XMLHttpRequest();
                ...
                (Y = (o, p, h) => {
                  ...
                  v.open("GET", o, !0),
                    ...
                    (v.onload = () => {
                      v.status == 200 || (v.status == 0 && v.response)
                        ? p(v.response)
                        : h();
                    }),
                    (v.onerror = h),
          ...
          k &&
            ...
            (global.performance = Ua().performance);
          var se = console.log.bind(console),
  ...
  `
          ...
          function He() {
            var o = ae.buffer;
            (u.HEAP8 = ue = new Int8Array(o)),
              (u.HEAP16 = je = new Int16Array(o)),
              (u.HEAPU8 = de = new Uint8Array(o)),
              (u.HEAPU16 = H = new Uint16Array(o)),
              (u.HEAP32 = ne = new Int32Array(o)),
              (u.HEAPU32 = Se = new Uint32Array(o)),
              (u.HEAPF32 = Ye = new Float32Array(o)),
              (u.HEAPF64 = Ft = new Float64Array(o)),
              (u.HEAP64 = Be = new BigInt64Array(o)),
              (u.HEAPU64 = Ge = new BigUint64Array(o));
          }
          var Xe = 16777216;
          if (P) ae = u.wasmMemory;
          else if (u.wasmMemory) ae = u.wasmMemory;
          else if (
            ...
            !(ae.buffer instanceof SharedArrayBuffer))
          )
            throw (
              (ee(
          ...
          function Dr() {
            if (
              (qt--,
              qt == 0 && (br !== null && (clearInterval(br), (br = null)), tr))
            ) {
              var o = tr;
              (tr = null), o();
            }
          ...
          function rr(o) {
            throw (
              ...
              (me = !0),
              (oe = 1),
              (o = new WebAssembly.RuntimeError(
                o + ". Build with -sASSERTIONS for more info."
              )),
              b(o),
              o)
            );
          }
          var Ke = (o) => o.startsWith("data:application/octet-stream;base64,"),
            jt = (o) => o.startsWith("file://"),
            ct;
          (ct = "ort-wasm-simd-threaded.wasm"), Ke(ct) || (ct = L(ct));
          function Mr(o) {
            if (Q) return Q(o);
            throw "both async and sync fetching of the wasm failed";
          }
            ...
            if (S || E) {
              ...
              if (Y)
                return new Promise((p, h) => {
                  Y(o, (v) => p(new Uint8Array(v)), h);
                });
            }
            return Promise.resolve().then(() => Mr(o));
          }
          function vr(o, p, h) {
            return vt(o)
              .then((v) => WebAssembly.instantiate(v, p))
              .then(h, (v) => {
                ee(`failed to asynchronously prepare wasm: ${v}`), rr(v);
              });
          }
          function Ur(o, p) {
            var h = ct;
            return typeof WebAssembly.instantiateStreaming != "function" ||
              ...
              typeof fetch != "function"
              ? vr(h, o, p)
              : fetch(h, { credentials: "same-origin" }).then((v) =>
                  WebAssembly.instantiateStreaming(v, o).then(p, function (I) {
                    return (
                      ee(`wasm streaming compile failed: ${I}`),
          ...
          var Wr = {
            826468: (o, p, h, v) => {
              ...
              if (
                ...
                return 2;
              if (((p >>>= 0), (h >>>= 0), (v >>>= 0), p + h > o.byteLength))
                return 3;
              try {
                return n().set(o.subarray(p, p + h), v >>> 0), 0;
              } catch {
                return 4;
              }
            },
            ...
            827610: (o) => {
              u.ob("Sigmoid", o, void 0);
            },
            827665: (o, p, h) => {
              u.ob("HardSigmoid", o, { alpha: p, beta: h });
            },
            827744: (o) => {
              u.ob("Log", o, void 0);
            },
            ...
            828701: (o, p) => {
              u.ob("LeakyRelu", o, { alpha: p });
            },
            828765: (o, p) => {
              u.ob("ThresholdedRelu", o, { alpha: p });
            },
            828835: (o, p) => {
              u.ob("Cast", o, { to: p });
            },
            ...
            829201: (o) => {
              u.ob("Greater", o, void 0);
            },
            829256: (o) => {
              u.ob("GreaterOrEqual", o, void 0);
            },
            829318: (o) => {
              u.ob("Less", o, void 0);
            },
            829370: (o) => {
              u.ob("LessOrEqual", o, void 0);
            },
            829429: (o, p, h, v, I) => {
              u.ob("ReduceMean", o, {
                keepDims: !!p,
                noopWithEmptyAxes: !!h,
                axes: v ? Array.from(a().subarray(v >>> 0, I >>> 0)) : []
              });
            },
            829588: (o, p, h, v, I) => {
              u.ob("ReduceMax", o, {
            ...
            831077: (o, p, h) => {
              u.ob("Transpose", o, {
                perm: p ? Array.from(a().subarray(p >>> 0, h >>> 0)) : []
              });
            },
            831185: (o, p, h, v) => {
              u.ob("DepthToSpace", o, {
            ...
            831451: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve) => {
              u.ob("ConvTranspose", o, {
                format: re ? "NHWC" : "NCHW",
                autoPad: p,
                dilations: [h],
                group: v,
                ...
                wIsConst: () => !!r()[J >>> 0],
                outputPadding: ce
                  ? Array.from(a().subarray(ce >>> 0, ze >>> 0))
                  : [],
                outputShape: Me
                  ? Array.from(a().subarray(Me >>> 0, D >>> 0))
                  : [],
                activation: Le(ve)
              });
            },
            831852: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D) => {
              u.ob("ConvTranspose", o, {
                format: F ? "NHWC" : "NCHW",
                autoPad: p,
                dilations: Array.from(
                  a().subarray(h >>> 0, ((h >>> 0) + 2) >>> 0)
                ),
                group: v,
                kernelShape: Array.from(
                  a().subarray(I >>> 0, ((I >>> 0) + 2) >>> 0)
                ),
                pads: Array.from(a().subarray(O >>> 0, ((O >>> 0) + 4) >>> 0)),
                strides: Array.from(
                  a().subarray(W >>> 0, ((W >>> 0) + 2) >>> 0)
                ),
                wIsConst: () => !!r()[re >>> 0],
                outputPadding: J
                  ? Array.from(a().subarray(J >>> 0, ce >>> 0))
                  : [],
                outputShape: ze
                  ? Array.from(a().subarray(ze >>> 0, Me >>> 0))
                  : [],
                activation: Le(D)
              });
            },
            832417: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve) => {
              u.ob("ConvTranspose", o, {
                format: re ? "NHWC" : "NCHW",
                autoPad: p,
                dilations: [h],
            ...
            832818: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D) => {
              u.ob("ConvTranspose", o, {
                format: F ? "NHWC" : "NCHW",
                autoPad: p,
                dilations: Array.from(
            ...
            833383: (o, p) => {
              u.ob("GlobalAveragePool", o, { format: p ? "NHWC" : "NCHW" });
            },
            833474: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve, Oe) => {
              u.ob("AveragePool", o, {
                format: Oe ? "NHWC" : "NCHW",
                auto_pad: p,
                ceil_mode: h,
            ...
            833849: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve, Oe) => {
              u.ob("AveragePool", o, {
                format: Oe ? "NHWC" : "NCHW",
                auto_pad: p,
                ceil_mode: h,
            ...
            834133: (o, p) => {
              u.ob("GlobalMaxPool", o, { format: p ? "NHWC" : "NCHW" });
            },
            834220: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve, Oe) => {
              u.ob("MaxPool", o, {
                format: Oe ? "NHWC" : "NCHW",
                auto_pad: p,
                ceil_mode: h,
            ...
            834587: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve, Oe) => {
              u.ob("MaxPool", o, {
                format: Oe ? "NHWC" : "NCHW",
                auto_pad: p,
                ceil_mode: h,
            ...
            834867: (o, p, h, v, I) => {
              u.ob("Gemm", o, { alpha: p, beta: h, transA: v, transB: I });
            },
            834971: (o) => {
              u.ob("MatMul", o, void 0);
            },
            835025: (o, p, h, v) => {
              u.ob("ArgMax", o, {
                keepDims: !!p,
            ...
            835241: (o, p) => {
              u.ob("Softmax", o, { axis: p });
            },
            835304: (o, p) => {
              u.ob("Concat", o, { axis: p });
            },
            835364: (o, p, h, v, I) => {
              u.ob("Split", o, {
                axis: p,
                numOutputs: h,
                splitSizes: v ? Array.from(a().subarray(v >>> 0, I >>> 0)) : []
              });
            },
            835504: (o) => {
              u.ob("Expand", o, void 0);
            },
            835558: (o, p) => {
              u.ob("Gather", o, { axis: Number(p) });
            },
            835629: (o, p) => {
              u.ob("GatherElements", o, { axis: Number(p) });
            },
            835708: (o, p, h, v, I, O, W, F, re, J, ce) => {
              u.ob("Resize", o, {
                antialias: p,
                axes: h ? Array.from(a().subarray(h >>> 0, v >>> 0)) : [],
                coordinateTransformMode: Le(I),
                cubicCoeffA: O,
                excludeOutside: W,
                extrapolationValue: F,
                keepAspectRatioPolicy: Le(re),
                mode: Le(J),
                nearestMode: Le(ce)
              });
            },
            836054: (o, p, h, v, I, O, W) => {
              u.ob("Slice", o, {
                starts: p ? Array.from(a().subarray(p >>> 0, h >>> 0)) : [],
                ends: v ? Array.from(a().subarray(v >>> 0, I >>> 0)) : [],
                axes: O ? Array.from(a().subarray(O >>> 0, W >>> 0)) : []
              });
            },
            836270: (o) => {
              u.ob("Tile", o, void 0);
            ...
            836714: (o, p) => {
              u.ob("Einsum", o, { equation: Le(p) });
            },
            836795: (o, p, h, v, I) => {
              u.ob("Pad", o, {
                mode: p,
                value: h,
                pads: v ? Array.from(a().subarray(v >>> 0, I >>> 0)) : []
              });
            },
            836922: (o, p, h, v, I, O) => {
              u.ob("BatchNormalization", o, {
                epsilon: p,
                momentum: h,
                spatial: !!I,
                trainingMode: !!v,
            ...
            837260: (o, p, h) => {
              u.ob("CumSum", o, { exclusive: Number(p), reverse: Number(h) });
            },
            837357: (o, p, h, v, I, O, W, F, re) => {
              u.ob("Attention", o, {
                numHeads: p,
                isUnidirectional: h,
                maskFilterValue: v,
                ...
                qkvHiddenSizes: W
                  ? Array.from(
                      a().subarray(Number(F) >>> 0, (Number(F) + W) >>> 0)
                    )
                  : [],
                pastPresentShareBuffer: !!re
              });
            },
            837629: (o) => {
              u.ob("BiasAdd", o, void 0);
            },
            837684: (o) => {
              u.ob("BiasSplitGelu", o, void 0);
            },
            837745: (o) => {
              u.ob("FastGelu", o, void 0);
            },
            837801: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me) => {
              u.ob("Conv", o, {
                format: re ? "NHWC" : "NCHW",
                auto_pad: p,
                dilations: [h],
                group: v,
                kernel_shape: [I],
                pads: O ? Array.from(a().subarray(O >>> 0, W >>> 0)) : [],
                strides: [F],
                w_is_const: () => !!r()[J >>> 0],
                activation: Le(ce),
                activation_params: ze
                  ? Array.from(c().subarray(ze >>> 0, Me >>> 0))
                  : []
              });
            },
            838171: (o, p, h, v, I, O, W, F, re, J, ce, ze, Me, D, ve, Oe) => {
              u.ob("Conv", o, {
                format: ze ? "NHWC" : "NCHW",
                auto_pad: p,
                dilations: [h, v],
                group: I,
                kernel_shape: [O, W],
                pads: F ? Array.from(a().subarray(F >>> 0, re >>> 0)) : [],
                strides: [J, ce],
                w_is_const: () => !!r()[Me >>> 0],
                activation: Le(D),
                activation_params: ve
                  ? Array.from(c().subarray(ve >>> 0, Oe >>> 0))
                  : []
              });
            },
            838562: (o) => {
            ...
            838900: (o, p, h, v, I) => {
              u.ob("RotaryEmbedding", o, {
                interleaved: !!p,
                numHeads: h,
                rotaryEmbeddingDim: v,
                scale: I
              });
            },
            839039: (o, p, h) => {
              u.ob("SkipLayerNormalization", o, {
                epsilon: p,
                simplified: !!h
              });
            },
            ...
            839388: (o, p) => u.cc(o, p, u.Cb.ec, u.Cb.errors)
          };
          function pt(o) {
            (this.name = "ExitStatus"),
              (this.message = `Program terminated with exit(${o})`),
              (this.status = o);
          }
          var Nr = (o) => {
            ...
            wt = (o) => {
              ge.xb.length == 0 && ($r(), ge.Mb(ge.xb[0]));
              var p = ge.xb.pop();
              if (!p) return 6;
              ge.yb.push(p), (ge.ub[o.wb] = p), (p.wb = o.wb);
              var h = {
                cmd: "run",
                start_routine: o.fc,
                arg: o.Rb,
              ...
              return k && p.unref(), p.postMessage(h, o.mc), 0;
            },
            Ct = 0,
            Vr = (o) => {
              var p = ki();
            ...
            Ae = (o, p, ...h) =>
              Vr(() => {
                for (
                  var v = 2 * h.length, I = Ei(8 * v), O = I >>> 3, W = 0;
                  W < h.length;
                  W++
                ) {
                  var F = h[W];
                  typeof F == "bigint"
                    ? ((Be[O + 2 * W] = 1n), (Be[O + 2 * W + 1] = F))
                    : ((Be[O + 2 * W] = 0n), (m()[(O + 2 * W + 1) >>> 0] = F));
                }
                return qo(o, 0, v, I, p);
              });
          function wr(o) {
            if (P) return Ae(0, 1, o);
            (oe = o),
              0 < Ct || (ge.hc(), u.onExit?.(o), (me = !0)),
              T(o, new pt(o));
          }
          var Qe = (o) => {
            if (((oe = o), P)) throw (ln(o), "unwind");
            wr(o);
          };
          function mt() {
            for (var o = u.numThreads; o--; ) $r();
            bt.unshift(() => {
              qt++, gi(() => Dr());
            });
          }
          function $r() {
            var o = L("ort-wasm-simd-threaded.worker.js");
            (o = new Worker(o)), ge.xb.push(o);
          }
          function gi(o) {
            P ? o() : Promise.all(ge.xb.map(ge.Mb)).then(o);
          }
          var ge = {
            xb: [],
            yb: [],
            ...
            Gb() {
              P
                ? ((ge.receiveObjectTransfer = ge.dc),
                  (ge.threadInitTLS = ge.Pb),
                  (ge.setExitStatus = ge.Ob))
                : mt();
            },
            Ob: (o) => (oe = o),
            pc: ["$terminateWorker"],
            hc: () => {
              for (var o of ge.yb) Nr(o);
              for (o of ge.xb) Nr(o);
              (ge.xb = []), (ge.yb = []), (ge.ub = []);
            },
            Nb: (o) => {
              ...
              delete ge.ub[p],
                ge.xb.push(o),
                ge.yb.splice(ge.yb.indexOf(o), 1),
                (o.wb = 0),
                Ti(p);
            },
            dc() {},
            ...
            Mb: (o) =>
              new Promise((p) => {
                (o.onmessage = (O) => {
                  O = O.data;
                  var W = O.cmd;
                  if (O.targetThread && O.targetThread != Tn()) {
                    var F = ge.ub[O.targetThread];
                    F
                      ? F.postMessage(O, O.transferList)
                      : ee(
                          `Internal error! Worker sent a message "${W}" to target pthread ${O.targetThread}, but that thread no longer exists!`
                        );
                  } else
                    W === "checkMailbox"
                      ? it()
                        ...
                        : W === "cleanupThread"
                          ...
                          : W === "killThread"
                            ? ((O = O.thread),
                              ...
                              Nr(W),
                              Ti(O),
                              ge.yb.splice(ge.yb.indexOf(W), 1),
                              (W.wb = 0))
                            : W === "cancelThread"
                              ? ge.ub[O.thread].postMessage({ cmd: "cancel" })
                              : W === "loaded"
                                ? ((o.loaded = !0),
                                  k && !o.wb && o.unref(),
                                  p(o))
                                : W === "alert"
                                  ? alert(`Thread ${O.threadId}: ${O.text}`)
                                  : O.target === "setimmediate"
                                    ...
                                    : W === "callHandler"
                                      ...
                                      : W &&
                                        ee(
                                          `worker sent an unknown command ${W}`
                                        );
                }),
                  (o.onerror = (O) => {
                    throw (
                      (ee(
                        `worker sent an error! ${O.filename}:${O.lineno}: ${O.message}`
                      ),
                      O)
                    );
                  }),
                  k &&
                    (o.on("message", (O) => o.onmessage({ data: O })),
                    o.on("error", (O) => o.onerror(O)));
                var h = [],
                  v = ["onExit"],
                  I;
                for (I of v) u.hasOwnProperty(I) && h.push(I);
                o.postMessage({
                  cmd: "load",
                  handlers: h,
          ...
          u.PThread = ge;
          var nr = (o) => {
            for (; 0 < o.length; ) o.shift()(u);
          };
          u.establishStackSpace = () => {
            var o = Tn(),
              p = d()[((o + 52) >>> 2) >>> 0];
            (o = d()[((o + 56) >>> 2) >>> 0]), Ko(p, p - o), En(p);
          };
          function ln(o) {
            if (P) return Ae(1, 0, o);
            Qe(o);
          }
          u.invokeEntryPoint = (o, p) => {
            (Ct = 0), (o = Yo(o, p)), 0 < Ct ? ge.Ob(o) : Ai(o);
          };
          class yi {
            constructor(p) {
              this.Ib = p - 24;
          ...
          var dn = 0,
            bi = 0;
          function cn(o, p, h, v) {
            return P ? Ae(2, 1, o, p, h, v) : pn(o, p, h, v);
          }
          function pn(o, p, h, v) {
            if (
              ((o >>>= 0),
            ...
            return P && I.length === 0
              ? cn(o, p, h, v)
              : ((o = { fc: h, wb: o, Rb: v, mc: I }),
                P ? ((o.oc = "spawnThread"), postMessage(o, I), 0) : wt(o));
          }
            ...
            Hr = (o, p, h) => {
              ...
              for (v = ""; p < h; ) {
                ...
                if (I & 128) {
                  var O = o[p++] & 63;
                  if ((I & 224) == 192)
                    v += String.fromCharCode(((I & 31) << 6) | O);
                  else {
                    var W = o[p++] & 63;
                    (I =
                      (I & 240) == 224
                ...
                } else v += String.fromCharCode(I);
              }
              return v;
            },
            Le = (o, p) => ((o >>>= 0) ? Hr(n(), o, p) : "");
          function mn(o, p, h) {
            return P ? Ae(3, 1, o, p, h) : 0;
          }
          function fn(o, p) {
            if (P) return Ae(4, 1, o, p);
          }
          var $t = (o) => {
              for (var p = 0, h = 0; h < o.length; ++h) {
            ...
            ft = (o, p, h, v) => {
              ...
              for (var O = 0; O < o.length; ++O) {
                var W = o.charCodeAt(O);
                if (55296 <= W && 57343 >= W) {
                  var F = o.charCodeAt(++O);
            ...
            Vt = (o, p, h) => ft(o, n(), p, h);
          function ir(o, p) {
            if (P) return Ae(5, 1, o, p);
          }
          function Gr(o, p, h) {
            if (P) return Ae(6, 1, o, p, h);
          }
          function Lr(o, p, h) {
            return P ? Ae(7, 1, o, p, h) : 0;
          }
          function hn(o, p) {
            if (P) return Ae(8, 1, o, p);
          }
          function xr(o, p, h) {
            if (P) return Ae(9, 1, o, p, h);
          }
          function gn(o, p, h, v) {
            if (P) return Ae(10, 1, o, p, h, v);
          }
          function yn(o, p, h, v) {
            if (P) return Ae(11, 1, o, p, h, v);
          }
          function bn(o, p, h, v) {
            if (P) return Ae(12, 1, o, p, h, v);
          }
          function vn(o) {
            if (P) return Ae(13, 1, o);
          }
          function Fr(o, p) {
            if (P) return Ae(14, 1, o, p);
          }
          function or(o, p, h) {
            if (P) return Ae(15, 1, o, p, h);
          }
          var wn,
            st = (o) => {
              for (var p = ""; n()[o >>> 0]; ) p += wn[n()[o++ >>> 0]];
              return p;
            },
            Sr = {},
            qr = {},
          ...
          function wi(o, p, h = {}) {
            ...
            if (!o)
              throw new It(
                `type "${v}" must have a positive integer typeid pointer`
              );
            if (qr.hasOwnProperty(o)) {
              if (h.Ub) return;
              throw new It(`Cannot register type '${v}' twice`);
            }
            (qr[o] = p),
              delete vi[o],
              Sr.hasOwnProperty(o) &&
                ((p = Sr[o]), delete Sr[o], p.forEach((I) => I()));
          }
          function tt(o, p, h = {}) {
          ...
          function Ir(o) {
            (o >>>= 0),
              9 < o && --ht[o + 1] === 0 && ((ht[o] = void 0), Cr.push(o));
          }
          var Je = (o) => {
              if (!o) throw new It("Cannot use deleted val. handle = " + o);
              return ht[o];
            },
            ut = (o) => {
              switch (o) {
                ...
                case !1:
                  return 8;
                default:
                  let p = Cr.pop() || ht.length;
                  return (ht[p] = o), (ht[p + 1] = 1), p;
              }
            };
          function ar(o) {
          ...
          var $i = {
            ...
            $n = (o, p) => {
              switch (p) {
                case 4:
                  return function (h) {
                    return this.fromWireType(c()[(h >>> 2) >>> 0]);
                  };
                case 8:
                  return function (h) {
                    return this.fromWireType(m()[(h >>> 3) >>> 0]);
                  };
                default:
            ...
            Kr =
              typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0,
            _i = (o, p) => {
              for (var h = o >> 1, v = h + p / 2; !(h >= v) && s()[h >>> 0]; )
                ++h;
              if (((h <<= 1), 32 < h - o && Kr))
                return Kr.decode(n().slice(o, h));
              for (h = "", v = 0; !(v >= p / 2); ++v) {
                var I = i()[((o + 2 * v) >>> 1) >>> 0];
                if (I == 0) break;
            ...
            _n = (o, p, h) => {
              ...
              h -= 2;
              var v = p;
              h = h < 2 * o.length ? h / 2 : o.length;
              for (var I = 0; I < h; ++I) {
                var O = o.charCodeAt(I);
                (i()[(p >>> 1) >>> 0] = O), (p += 2);
              }
              return (i()[(p >>> 1) >>> 0] = 0), p - v;
            },
            xn = (o) => 2 * o.length,
            Tr = (o, p) => {
              for (var h = 0, v = ""; !(h >= p / 4); ) {
            ...
            xi = (o, p, h) => {
              if (((p >>>= 0), (h ??= 2147483647), 4 > h)) return 0;
              var v = p;
              h = v + h - 4;
              for (var I = 0; I < o.length; ++I) {
                var O = o.charCodeAt(I);
                if (55296 <= O && 57343 >= O) {
                  var W = o.charCodeAt(++I);
                  O = (65536 + ((O & 1023) << 10)) | (W & 1023);
                }
                if (((a()[(p >>> 2) >>> 0] = O), (p += 4), p + 4 > h)) break;
              }
              return (a()[(p >>> 2) >>> 0] = 0), p - v;
            },
            pe = (o) => {
              for (var p = 0, h = 0; h < o.length; ++h) {
                var v = o.charCodeAt(h);
                55296 <= v && 57343 >= v && ++h, (p += 4);
              }
              return p;
            },
            Yr = (o) => {
                ...
                try {
                  if ((o(), !(0 < Ct)))
                    try {
                      ...
                      p instanceof pt || p == "unwind" || T(1, p);
                    }
                } catch (p) {
                  p instanceof pt || p == "unwind" || T(1, p);
                }
          ...
          function Kt(o) {
            (o >>>= 0),
              typeof Atomics.nc == "function" &&
                (Atomics.nc(a(), o >>> 2, o).value.then(it),
                (o += 128),
                Atomics.store(a(), o >>> 2, 1));
          }
          u.__emscripten_thread_mailbox_await = Kt;
          var it = () => {
            var o = Tn();
            o && (Kt(o), Yr(jo));
          };
          ...
          function Sn() {
            var o = ie,
              p = {};
            for (let [h, v] of Object.entries(o))
              p[h] =
                typeof v == "function"
                  ? (...I) => {
                      Ht.push(h);
                ...
                o((v = 0) => {
                  if (!me && ((Cn = v), (p = !0), h)) {
                    ...
                    if (!gt) {
                      var W = y;
                      W &&
                        ((y = null), (v ? W.reject : W.resolve)(I), (O = !0));
                    }
                    if (v && !O) throw I;
                  }
                }),
                  ...
                  p ||
                    ((Tt = 1),
                    (gt = z()),
                    typeof Browser < "u" && Browser.Hb.Tb && Browser.Hb.pause(),
                    sr(() => Xo(gt)));
              } else
                Tt === 2
                  ? ((Tt = 0), sr(Jo), Rt(gt), (gt = null), _.forEach(Yr))
                  : rr(`invalid state: ${Tt}`);
              return Cn;
            }
          }
          ...
          var Z = [],
            ...
            be = (o, p) => {
              for (var h = Array(o), v = 0; v < o; ++v)
                h[v] = Er(d()[((p + 4 * v) >>> 2) >>> 0], "parameter " + v);
              return h;
            },
            Te = (o, p) => Object.defineProperty(p, "name", { value: o });
          function Gt(o) {
            var p = Function;
            if (!(p instanceof Function))
              throw new TypeError(
                `new_ called with constructor type ${typeof p} which is not a function`
              );
            var h = Te(p.name || "unknownFunctionName", function () {});
            return (
              (h.prototype = p.prototype),
              (h = new h()),
              (o = p.apply(h, o)),
              o instanceof Object ? o : h
            );
          }
          var Lt = (o) => o % 4 === 0 && (o % 100 !== 0 || o % 400 === 0),
            Ao = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
            Eo = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
          function ko(o, p, h, v, I, O, W) {
            return P ? Ae(16, 1, o, p, h, v, I, O, W) : -52;
          }
          function Oo(o, p, h, v, I, O) {
            if (P) return Ae(17, 1, o, p, h, v, I, O);
          }
          var Si = [],
            Po = (o, p) => {
              Si.length = 0;
            ...
            Ro = () => {
              if (!Ii) {
                var o = {
                  ...
                  p;
                for (p in Ci) Ci[p] === void 0 ? delete o[p] : (o[p] = Ci[p]);
                var h = [];
                for (p in o) h.push(`${p}=${o[p]}`);
                Ii = h;
              }
              return Ii;
            },
            ...
            return (
              Ro().forEach((v, I) => {
                ...
                for (
                  ...
                  r()[I++ >>> 0] = v.charCodeAt(O);
                (r()[I >>> 0] = 0), (h += v.length + 1);
              }),
              0
            );
          }
          function Bo(o, p) {
            if (P) return Ae(19, 1, o, p);
            (o >>>= 0), (p >>>= 0);
            var h = Ro();
            d()[(o >>> 2) >>> 0] = h.length;
            var v = 0;
            return (
              h.forEach((I) => (v += I.length + 1)),
              (d()[(p >>> 2) >>> 0] = v),
              0
            );
          }
          function Do(o) {
            return P ? Ae(20, 1, o) : 52;
          }
          function Mo(o, p, h, v) {
            return P ? Ae(21, 1, o, p, h, v) : 52;
          }
          function Uo(o, p, h, v) {
            return P ? Ae(22, 1, o, p, h, v) : 70;
          }
          var Jd = [null, [], []];
          function Wo(o, p, h, v) {
            if (P) return Ae(23, 1, o, p, h, v);
            (p >>>= 0), (h >>>= 0), (v >>>= 0);
            for (var I = 0, O = 0; O < h; O++) {
              var W = d()[(p >>> 2) >>> 0],
                F = d()[((p + 4) >>> 2) >>> 0];
              p += 8;
          ...
          var No = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
            Vo = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
          function ec(o) {
            var p = Array($t(o) + 1);
            return ft(o, p, 0, p.length), p;
          }
          var tc = (o, p) => {
            r().set(o, p >>> 0);
          };
          function Ho(o, p, h, v) {
            ...
            function W(D, ve) {
              ...
              var ur;
              return (
                (ur = Oe(D.getFullYear() - ve.getFullYear())) === 0 &&
                  (ur = Oe(D.getMonth() - ve.getMonth())) === 0 &&
                  (ur = Oe(D.getDate() - ve.getDate())),
                ur
              );
            }
            function F(D) {
            ...
            function re(D) {
              var ve = D.zb;
              for (
                D = new Date(new Date(D.Ab + 1900, 0, 1).getTime());
                0 < ve;

              ) {
                var Oe = D.getMonth(),
                  ur = (Lt(D.getFullYear()) ? No : Vo)[Oe];
                if (ve > ur - D.getDate())
                  (ve -= ur - D.getDate() + 1),
                    D.setDate(1),
                    11 > Oe
                  ...
                  D.setDate(D.getDate() + ve);
                  break;
                }
              }
              return (
                (Oe = new Date(D.getFullYear() + 1, 0, 4)),
                (ve = F(new Date(D.getFullYear(), 0, 4))),
                (Oe = F(Oe)),
                0 >= W(ve, D)
                  ? 0 >= W(Oe, D)
                    ? D.getFullYear() + 1
            ...
            for (var ce in J) h = h.replace(new RegExp(ce, "g"), J[ce]);
            var ze =
                "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(
                  " "
                ),
            ...
            (J = {
              "%a": (D) => ze[D.vb].substring(0, 3),
              "%A": (D) => ze[D.vb],
              "%b": (D) => Me[D.Fb].substring(0, 3),
              "%B": (D) => Me[D.Fb],
              "%C": (D) => O(((D.Ab + 1900) / 100) | 0, 2),
              "%d": (D) => O(D.Jb, 2),
              "%e": (D) => I(D.Jb, 2, " "),
              "%g": (D) => re(D).toString().substring(2),
              "%G": re,
              "%H": (D) => O(D.Eb, 2),
              "%I": (D) => (
                (D = D.Eb), D == 0 ? (D = 12) : 12 < D && (D -= 12), O(D, 2)
              ),
              "%j": (D) => {
                for (
                  var ve = 0, Oe = 0;
                  Oe <= D.Fb - 1;
                  ve += (Lt(D.Ab + 1900) ? No : Vo)[Oe++]
                );
                return O(D.Jb + ve, 3);
              },
              "%m": (D) => O(D.Fb + 1, 2),
              ...
              "%n": () => `
  `,
              "%p": (D) => (0 <= D.Eb && 12 > D.Eb ? "AM" : "PM"),
              "%S": (D) => O(D.kc, 2),
              "%t": () => "	",
              "%u": (D) => D.vb || 7,
              "%U": (D) => O(Math.floor((D.zb + 7 - D.vb) / 7), 2),
              "%V": (D) => {
                var ve = Math.floor((D.zb + 7 - ((D.vb + 6) % 7)) / 7);
                if ((2 >= (D.vb + 371 - D.zb - 2) % 7 && ve++, ve))
                  ve == 53 &&
                    ((Oe = (D.vb + 371 - D.zb) % 7),
                    Oe == 4 || (Oe == 3 && Lt(D.Ab)) || (ve = 1));
                else {
                  ve = 52;
                  var Oe = (D.vb + 7 - D.zb - 1) % 7;
                  (Oe == 4 || (Oe == 5 && Lt((D.Ab % 400) - 1))) && ve++;
                }
                return O(ve, 2);
              },
              "%w": (D) => D.vb,
              "%W": (D) => O(Math.floor((D.zb + 7 - ((D.vb + 6) % 7)) / 7), 2),
              "%y": (D) => (D.Ab + 1900).toString().substring(2),
              "%Y": (D) => D.Ab + 1900,
              "%z": (D) => {
                D = D.ic;
                var ve = 0 <= D;
              ...
              (h = h.replace(/%%/g, "\0\0"));
            for (ce in J)
              h.includes(ce) && (h = h.replace(new RegExp(ce, "g"), J[ce](v)));
            return (
              (h = h.replace(/\0\0/g, "%")),
              (ce = ec(h)),
              ce.length > p ? 0 : (tc(ce, o), ce.length - 1)
            );
          }
          ge.Gb();
          for (var Go = Array(256), In = 0; 256 > In; ++In)
            Go[In] = String.fromCharCode(In);
          (wn = Go),
            (It = u.BindingError =
              class extends Error {
                constructor(o) {
            ...
            ht.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1),
            (u.count_emval_handles = () => ht.length / 2 - 5 - Cr.length);
          var rc = [
              wr,
              ln,
              cn,
            ...
            nc = {
              ...
              ia: function (o) {
                Fo(o >>> 0, !E, 1, !S, 131072, !1), ge.Pb();
              },
              G: function (o) {
                (o >>>= 0),
                  P
                    ? postMessage({ cmd: "cleanupThread", thread: o })
                    : ge.Nb(ge.ub[o]);
              },
              _: pn,
              A: mn,
              ...
              E: function (o, p, h) {
                (o >>>= 0),
                  ...
                  tt(o, {
                    name: p,
                    fromWireType: (v) => v,
                    toWireType: function (v, I) {
                      if (typeof I != "bigint" && typeof I != "number")
                        throw (
                          (I === null
                            ? (I = "null")
                            : ((v = typeof I),
                              (I =
                                ...
                                v === "function"
                                  ...
                                  : "" + I)),
                          new TypeError(
                            `Cannot convert "${I}" to ${this.name}`
                          ))
                        );
                      return typeof I == "number" && (I = BigInt(I)), I;
                    },
                    argPackAdvance: 8,
                    readValueFromPointer: jr(p, h, p.indexOf("u") == -1),
                    Bb: null
                  });
              },
              O: function (o, p, h, v) {
                (o >>>= 0),
                  ...
                  tt(o, {
                    ...
                    readValueFromPointer: function (I) {
                      return this.fromWireType(n()[I >>> 0]);
                    },
                    Bb: null
                  });
              },
              ...
              D: function (o, p, h) {
                (o >>>= 0),
                  ...
                  tt(o, {
                    ...
                    toWireType: (v, I) => I,
                    argPackAdvance: 8,
                    readValueFromPointer: $n(p, h),
                    Bb: null
                  });
              },
              t: function (o, p, h, v, I) {
                if (
                  ((o >>>= 0),
                  (h >>>= 0),
                  (p = st(p >>> 0)),
                ...
                tt(o, {
                  ...
                  toWireType: W,
                  argPackAdvance: 8,
                  readValueFromPointer: jr(p, h, v !== 0),
                  Bb: null
                });
              },
              p: function (o, p, h) {
                function v(O) {
                  var W = d()[(O >>> 2) >>> 0];
                  return (
                    (O = d()[((O + 4) >>> 2) >>> 0]), new I(r().buffer, O, W)
                  );
                }
                o >>>= 0;
                var I = [
                ...
                tt(o, {
                  ...
                  fromWireType: function (v) {
                    var I = d()[(v >>> 2) >>> 0],
                      O = v + 4;
                    if (h)
                      for (var W = O, F = 0; F <= I; ++F) {
                        var re = O + F;
                        if (F == I || n()[re >>> 0] == 0) {
                          if (((W = Le(W, re - W)), J === void 0)) var J = W;
                          else (J += String.fromCharCode(0)), (J += W);
                          W = re + 1;
                        }
                      }
                    else {
                      for (J = Array(I), F = 0; F < I; ++F)
                        J[F] = String.fromCharCode(n()[(O + F) >>> 0]);
                      J = J.join("");
                    }
                    return Rt(v), J;
                  },
                  toWireType: function (v, I) {
                    ...
                    if (
                      ...
                      throw new It("Cannot pass non-string to std::string");
                    var W = h && O ? $t(I) : I.length,
                      F = An(4 + W + 1),
                      re = F + 4;
                    if (((d()[(F >>> 2) >>> 0] = W), h && O)) Vt(I, re, W + 1);
                    else if (O)
                      for (O = 0; O < W; ++O) {
                        var J = I.charCodeAt(O);
                        if (255 < J)
                          throw (
                            (Rt(re),
                            new It(
                    ...
                    else for (O = 0; O < W; ++O) n()[(re + O) >>> 0] = I[O];
                    return v !== null && v.push(Rt, F), F;
                  },
                  argPackAdvance: 8,
                  readValueFromPointer: ar,
                  Bb(v) {
              ...
              z: function (o, p, h) {
                ...
                tt(o, {
                  ...
                  toWireType: (F, re) => {
                    if (typeof re != "string")
                      throw new It(
                        `Cannot pass non-string to C++ string type ${h}`
                      );
                    var J = O(re),
                      ce = An(4 + J + p);
                    return (
              ...
              S: function (o, p) {
                (o >>>= 0),
                  o == p >>> 0
                    ? setTimeout(it)
                    : P
                      ? postMessage({ targetThread: o, cmd: "checkMailbox" })
                      : (o = ge.ub[o]) &&
                        o.postMessage({ cmd: "checkMailbox" });
              },
              $: function (o, p, h, v, I) {
                (p >>>= 0),
                  (h >>>= 0),
              ...
              y: function (o) {
                return (o >>>= 0), te(() => ((o = Je(o)), o.then(ut)));
              },
              o: function (o, p, h, v) {
                return (
                  (h >>>= 0),
              ...
              c: Ir,
              C: function (o, p) {
                return (p >>>= 0), (o = Je(o >>> 0)), (p = Je(p)), o == p;
              },
              n: function (o) {
                return (
                  (o >>>= 0), o === 0 ? ut(Re()) : ((o = Ee(o)), ut(Re()[o]))
                );
              },
              j: function (o, p, h) {
                p = be(o, p >>> 0);
  ...
  `,
                  ...
                  W = [];
                h === 0 && W.push("obj");
                for (var F = ["retType"], re = [v], J = 0; J < o; ++J)
                  W.push("arg" + J),
                    F.push("argType" + J),
                    re.push(p[J]),
                    (I += `  var arg${J} = argType${J}.readValueFromPointer(args${O ? "+" + O : ""});
  `),
                    (O += p[J].argPackAdvance);
                return (
                  (I += `  var rv = ${h === 1 ? "new func" : "func.call"}(${W.join(", ")});
  `),
                  v.Vb ||
  ...
  `
                  ...
                  (o = Gt(F)(...re)),
                  (h = `methodCaller<(${p.map((ce) => ce.name).join(", ")}) => ${v.name}>`),
                  B(Te(h, o))
                );
              },
              s: function (o, p) {
                return (p >>>= 0), (o = Je(o >>> 0)), (p = Je(p)), ut(o[p]);
              },
              d: function (o) {
                (o >>>= 0), 9 < o && (ht[o + 1] += 1);
              },
              ...
              m: function (o) {
                o = Je(o >>> 0);
                for (var p = Array(o.length), h = 0; h < o.length; h++)
                  p[h] = o[h];
                return ut(p);
              },
              g: function (o) {
              ...
              e: function (o, p) {
                return (
                  (p >>>= 0),
                  (o = Er(o >>> 0, "_emval_take_value")),
                  (o = o.readValueFromPointer(p)),
                  ut(o)
                );
              },
              ca: function (o, p) {
                (o =
                  -9007199254740992 > o || 9007199254740992 < o
                    ? NaN
                    : Number(o)),
                  (p >>>= 0),
                  (o = new Date(1e3 * o)),
                  ...
                  (o =
                    ((o.getTime() -
                      Date.UTC(o.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) /
                      864e5) |
                    0),
                  (a()[((p + 28) >>> 2) >>> 0] = o);
              },
              da: function (o, p) {
                (o =
                  ...
                  (a()[((p + 24) >>> 2) >>> 0] = o.getDay());
                var h =
                  ((Lt(o.getFullYear()) ? Ao : Eo)[o.getMonth()] +
                    o.getDate() -
                    1) |
                  0;
                (a()[((p + 28) >>> 2) >>> 0] = h),
                  (a()[((p + 36) >>> 2) >>> 0] = -(60 * o.getTimezoneOffset())),
                  (h = new Date(o.getFullYear(), 6, 1).getTimezoneOffset());
                var v = new Date(o.getFullYear(), 0, 1).getTimezoneOffset();
                (o = (h != v && o.getTimezoneOffset() == Math.min(v, h)) | 0),
                  (a()[((p + 32) >>> 2) >>> 0] = o);
              },
              ea: function (o) {
                o >>>= 0;
                var p = new Date(
                  ...
                  I = new Date(p.getFullYear(), 6, 1).getTimezoneOffset(),
                  O = new Date(p.getFullYear(), 0, 1).getTimezoneOffset(),
                  W = Math.min(O, I);
                return (
                  0 > h
                    ? (a()[((o + 32) >>> 2) >>> 0] = +(I != O && W == v))
                    : 0 < h != (W == v) &&
                      ((I = Math.max(O, I)),
                      p.setTime(p.getTime() + 6e4 * ((0 < h ? W : I) - v))),
                  (a()[((o + 24) >>> 2) >>> 0] = p.getDay()),
                  (h =
                    ((Lt(p.getFullYear()) ? Ao : Eo)[p.getMonth()] +
                      p.getDate() -
                      1) |
                    0),
                  (a()[((o + 28) >>> 2) >>> 0] = h),
              ...
              R: function (o, p, h, v) {
                ...
                var F = W.getTimezoneOffset(),
                  re = Math.max(I, F);
                (d()[(o >>> 2) >>> 0] = 60 * re),
                  (a()[(p >>> 2) >>> 0] = +(I != F)),
                  (o = (J) =>
                    J.toLocaleTimeString(void 0, {
                      hour12: !1,
                      timeZoneName: "short"
                    }).split(" ")[1]),
                  (O = o(O)),
              ...
              f: function (o, p, h) {
                return (o >>>= 0), (p = Po(p >>> 0, h >>> 0)), Wr[o](...p);
              },
              M: function (o, p, h) {
                return (o >>>= 0), (p = Po(p >>> 0, h >>> 0)), Wr[o](...p);
              },
              ...
              u: () => performance.timeOrigin + performance.now(),
              x: () =>
                k
                  ? (Na(), Yt(Wa)).cpus().length
            ...
            ie = (function () {
              ...
              var p = { a: nc };
              if ((qt++, u.instantiateWasm))
                try {
                  return u.instantiateWasm(p, o);
                } catch (h) {
                  ee(`Module.instantiateWasm callback failed with error: ${h}`),
                    b(h);
                }
              return (
                Ur(p, function (h) {
                  o(h.instance, h.module);
                }).catch(b),
                {}
              );
            })(),
          ...
          (u.__embind_initialize_bindings = () =>
            (u.__embind_initialize_bindings = ie.xa)()),
            (u._OrtInit = (o, p) => (u._OrtInit = ie.ya)(o, p)),
            (u._OrtGetLastError = (o, p) => (u._OrtGetLastError = ie.za)(o, p)),
            (u._OrtCreateSessionOptions = (o, p, h, v, I, O, W, F, re, J) =>
              (u._OrtCreateSessionOptions = ie.Aa)(
                o,
                p,
                h,
                v,
            ...
            (u._OrtAppendExecutionProvider = (o, p) =>
              (u._OrtAppendExecutionProvider = ie.Ba)(o, p)),
            (u._OrtAddFreeDimensionOverride = (o, p, h) =>
              (u._OrtAddFreeDimensionOverride = ie.Ca)(o, p, h)),
            (u._OrtAddSessionConfigEntry = (o, p, h) =>
              (u._OrtAddSessionConfigEntry = ie.Da)(o, p, h)),
            (u._OrtReleaseSessionOptions = (o) =>
              (u._OrtReleaseSessionOptions = ie.Ea)(o)),
            (u._OrtCreateSession = (o, p, h) =>
              (u._OrtCreateSession = ie.Fa)(o, p, h)),
            (u._OrtReleaseSession = (o) => (u._OrtReleaseSession = ie.Ga)(o)),
            (u._OrtGetInputOutputCount = (o, p, h) =>
              (u._OrtGetInputOutputCount = ie.Ha)(o, p, h)),
            (u._OrtGetInputName = (o, p) => (u._OrtGetInputName = ie.Ia)(o, p)),
            (u._OrtGetOutputName = (o, p) =>
              (u._OrtGetOutputName = ie.Ja)(o, p)),
            (u._OrtFree = (o) => (u._OrtFree = ie.Ka)(o)),
            (u._OrtCreateTensor = (o, p, h, v, I, O) =>
              (u._OrtCreateTensor = ie.La)(o, p, h, v, I, O)),
            (u._OrtGetTensorData = (o, p, h, v, I) =>
              (u._OrtGetTensorData = ie.Ma)(o, p, h, v, I)),
            (u._OrtReleaseTensor = (o) => (u._OrtReleaseTensor = ie.Na)(o)),
            (u._OrtCreateRunOptions = (o, p, h, v) =>
              (u._OrtCreateRunOptions = ie.Oa)(o, p, h, v)),
            (u._OrtAddRunConfigEntry = (o, p, h) =>
              (u._OrtAddRunConfigEntry = ie.Pa)(o, p, h)),
            (u._OrtReleaseRunOptions = (o) =>
              (u._OrtReleaseRunOptions = ie.Qa)(o)),
            (u._OrtCreateBinding = (o) => (u._OrtCreateBinding = ie.Ra)(o)),
            (u._OrtBindInput = (o, p, h) => (u._OrtBindInput = ie.Sa)(o, p, h)),
            (u._OrtBindOutput = (o, p, h, v) =>
              (u._OrtBindOutput = ie.Ta)(o, p, h, v)),
            (u._OrtClearBoundOutputs = (o) =>
              (u._OrtClearBoundOutputs = ie.Ua)(o)),
            (u._OrtReleaseBinding = (o) => (u._OrtReleaseBinding = ie.Va)(o)),
            (u._OrtRunWithBinding = (o, p, h, v, I) =>
              (u._OrtRunWithBinding = ie.Wa)(o, p, h, v, I)),
            (u._OrtRun = (o, p, h, v, I, O, W, F) =>
              (u._OrtRun = ie.Xa)(o, p, h, v, I, O, W, F)),
            (u._OrtEndProfiling = (o) => (u._OrtEndProfiling = ie.Ya)(o)),
            (u._JsepOutput = (o, p, h) => (u._JsepOutput = ie.Za)(o, p, h)),
            (u._JsepGetNodeName = (o) => (u._JsepGetNodeName = ie._a)(o));
          var Tn = (u._pthread_self = () => (Tn = u._pthread_self = ie.$a)()),
            An = (u._malloc = (o) => (An = u._malloc = ie.ab)(o)),
            Rt = (u._free = (o) => (Rt = u._free = ie.bb)(o));
          u.__emscripten_tls_init = () => (u.__emscripten_tls_init = ie.cb)();
          var Fo = (u.__emscripten_thread_init = (o, p, h, v, I, O) =>
            (Fo = u.__emscripten_thread_init = ie.eb)(o, p, h, v, I, O));
          u.__emscripten_thread_crashed = () =>
            (u.__emscripten_thread_crashed = ie.fb)();
          var qo = (o, p, h, v, I) => (qo = ie.gb)(o, p, h, v, I),
            Ti = (o) => (Ti = ie.hb)(o),
            Ai = (u.__emscripten_thread_exit = (o) =>
              (Ai = u.__emscripten_thread_exit = ie.ib)(o)),
            jo = () => (jo = ie.jb)(),
            Ko = (o, p) => (Ko = ie.kb)(o, p),
            En = (o) => (En = ie.lb)(o),
            Ei = (o) => (Ei = ie.mb)(o),
            ki = () => (ki = ie.nb)(),
            Yo = (u.dynCall_ii = (o, p) => (Yo = u.dynCall_ii = ie.pb)(o, p)),
            Xo = (o) => (Xo = ie.qb)(o),
            Zo = () => (Zo = ie.rb)(),
            Qo = (o) => (Qo = ie.sb)(o),
            Jo = () => (Jo = ie.tb)();
          (u.___start_em_js = 839500), (u.___stop_em_js = 839661);
          function ic() {
            var o = ie;
            o = Object.assign({}, o);
            var p = (v) => (I) => v(I) >>> 0,
            ...
            return (
              ...
              (o.$a = h(o.$a)),
              (o.ab = p(o.ab)),
              (o.emscripten_main_runtime_thread_id = h(
                o.emscripten_main_runtime_thread_id
              )),
              (o.mb = p(o.mb)),
              (o.nb = h(o.nb)),
              o
          ...
          (u.wasmMemory = ae),
            (u.stackSave = () => ki()),
            (u.stackRestore = (o) => En(o)),
            (u.stackAlloc = (o) => Ei(o)),
            (u.keepRuntimeAlive = () => 0 < Ct),
            (u.UTF8ToString = Le),
            (u.stringToUTF8 = Vt),
            (u.lengthBytesUTF8 = $t),
            (u.ExitStatus = pt),
          ...
          function ea() {
            if (!(0 < qt))
              if (P) g(u), P || nr(Nt), startWorker(u);
              else {
                if (u.preRun)
                  for (
                    ...
                    bt.unshift(u.preRun.shift());
                nr(bt),
                  0 < qt ||
                    kn ||
                    ((kn = !0),
                    (u.calledRun = !0),
                    me || (P || nr(Nt), g(u), P || nr(er)));
              }
          }
          return ea(), $;
        }
    ...
    typeof Ha == "object" && typeof Vi == "object"
      ? (Vi.exports = Va)
      : typeof define == "function" && define.amd && define([], () => Va);
  });
  var La = kr((bh, hc) => {
    hc.exports =
      ...
      (gc = Ga()),
        ...
        (yc = (e) => {
          ...
          typeof process < "u" &&
            ...
            console.warn(
              "env.wasm.numThreads is set to " +
                e +
                ", however, currently onnxruntime-web does not support multi-threads in Node.js. Please consider using onnxruntime-node for performance critical scenarios."
            );
          try {
            return (
        ...
        (ja = async (e) => {
          ...
          let t = e.initTimeout,
            ...
            s = n && bc(),
            a = e.wasmPaths,
            d = typeof a == "string" ? a : void 0,
            c = vc(s, i),
            m = typeof a == "object" ? a[c] : void 0,
            u = !1,
            g = [];
          if (
            (t > 0 &&
            ...
            g.push(
              new Promise((b, $) => {
                let w = i ? gc : qa,
                  x = {
                    locateFile: (C, T) => {
                      if (i && C.endsWith(".worker.js") && typeof Blob < "u")
                        return URL.createObjectURL(
                          new Blob([La()], { type: "text/javascript" })
                        );
                      if (C.endsWith(".wasm")) {
                        if (m) return m;
                        let S = d ?? T;
                        return c === "ort-wasm-simd.wasm"
                          ? S + "ort-wasm-simd.jsep.wasm"
                          : c === "ort-wasm-simd-threaded.wasm"
                            ? S + "ort-wasm-simd-threaded.jsep.wasm"
                            : S + c;
                      }
                      return T + C;
                    }
                ...
                if (i)
                  if (((x.numThreads = r), typeof Blob > "u"))
                    x.mainScriptUrlOrBlob = (void 0)(
                      __dirname,
                      "ort-wasm-threaded.js"
                    );
                  else {
                    let C = `var ortWasmThreaded=${w.toString()};`;
                    x.mainScriptUrlOrBlob = new Blob([C], {
      ...
      (qe = (e, t) => {
        ...
        (en = (e, t, r, n) => {
          ...
          Object.entries(e).forEach(([i, s]) => {
            let a = t ? t + i : i;
            if (typeof s == "object") en(s, a + ".", r, n);
            else if (typeof s == "string" || typeof s == "number")
              n(a, s.toString());
            else if (typeof s == "boolean") n(a, s ? "1" : "0");
            else throw new Error(`Can't handle extra config type: ${typeof s}`);
          });
        }),
        (We = (e) => {
          let t = Fe(),
      ...
      Ka = (e) => {
        ...
        try {
          if (e?.logSeverityLevel === void 0) i.logSeverityLevel = 2;
            ...
            throw new Error(
              `log serverity level is not valid: ${e.logSeverityLevel}`
            );
          ...
          let s = 0;
          return (
            e?.tag !== void 0 && (s = qe(e.tag, n)),
            (r = t._OrtCreateRunOptions(
              i.logSeverityLevel,
              i.logVerbosityLevel,
              !!i.terminate,
              s
            )),
            r === 0 && We("Can't create run options."),
            e?.extra !== void 0 &&
              en(e.extra, "", new WeakSet(), (a, d) => {
                let c = qe(a, n),
                  m = qe(d, n);
                t._OrtAddRunConfigEntry(r, c, m) !== 0 &&
                  We(`Can't set a run config entry: ${a} - ${d}.`);
              }),
            [r, n]
          );
        } catch (s) {
          throw (
            (r !== 0 && t._OrtReleaseRunOptions(r),
            n.forEach((a) => t._free(a)),
            s)
          );
        }
      };
      ...
      (wc = (e) => {
          ...
          t.use_ort_model_bytes_directly ||
            ...
            e.executionProviders &&
              e.executionProviders.some(
                (r) => (typeof r == "string" ? r : r.name) === "webgpu"
              ) &&
        ...
        (xc = (e, t, r) => {
          for (let n of t) {
            ...
            switch (i) {
              case "webnn":
                if (((i = "WEBNN"), typeof n != "string")) {
                  let a = n;
                  if (a?.deviceType) {
                    let d = qe("deviceType", r),
                      c = qe(a.deviceType, r);
                    Fe()._OrtAddSessionConfigEntry(e, d, c) !== 0 &&
                      We(
                        `Can't set a session config entry: 'deviceType' - ${a.deviceType}.`
                      );
                  }
                  if (a?.numThreads) {
                    let d = a.numThreads;
                    (typeof d != "number" || !Number.isInteger(d) || d < 0) &&
                      (d = 0);
                    let c = qe("numThreads", r),
                      m = qe(d.toString(), r);
                    Fe()._OrtAddSessionConfigEntry(e, c, m) !== 0 &&
                      We(
                        `Can't set a session config entry: 'numThreads' - ${a.numThreads}.`
                      );
                  }
                  if (a?.powerPreference) {
                    let d = qe("powerPreference", r),
                      c = qe(a.powerPreference, r);
                    Fe()._OrtAddSessionConfigEntry(e, d, c) !== 0 &&
                      We(
                        `Can't set a session config entry: 'powerPreference' - ${a.powerPreference}.`
                      );
                  }
                }
                break;
              case "webgpu":
                if (((i = "JS"), typeof n != "string")) {
                  ...
                  if (a?.preferredLayout) {
                    if (
                      a.preferredLayout !== "NCHW" &&
                      a.preferredLayout !== "NHWC"
                    )
                      throw new Error(
                        `preferredLayout must be either 'NCHW' or 'NHWC': ${a.preferredLayout}`
                      );
                    let d = qe("preferredLayout", r),
                      c = qe(a.preferredLayout, r);
                    Fe()._OrtAddSessionConfigEntry(e, d, c) !== 0 &&
                      We(
                        `Can't set a session config entry: 'preferredLayout' - ${a.preferredLayout}.`
                      );
                  }
                }
                break;
            ...
            let s = qe(i, r);
            Fe()._OrtAppendExecutionProvider(e, s) !== 0 &&
              We(`Can't append execution provider: ${i}.`);
          }
        }),
        (Xa = (e) => {
          let t = Fe(),
          ...
          _c(i);
          try {
            let s = wc(i.graphOptimizationLevel ?? "all"),
              a = $c(i.executionMode ?? "sequential"),
              d = typeof i.logId == "string" ? qe(i.logId, n) : 0,
              c = i.logSeverityLevel ?? 2;
            if (!Number.isInteger(c) || c < 0 || c > 4)
              throw new Error(`log serverity level is not valid: ${c}`);
            let m = i.logVerbosityLevel ?? 0;
            if (!Number.isInteger(m) || m < 0 || m > 4)
              throw new Error(`log verbosity level is not valid: ${m}`);
            let u =
              typeof i.optimizedModelFilePath == "string"
                ? qe(i.optimizedModelFilePath, n)
                : 0;
            if (
              ((r = t._OrtCreateSessionOptions(
                s,
                !!i.enableCpuMemArena,
                !!i.enableMemPattern,
                a,
              ...
              r === 0 && We("Can't create session options."),
              i.executionProviders && xc(r, i.executionProviders, n),
              ...
              let g = qe("enableGraphCapture", n),
                b = qe(i.enableGraphCapture.toString(), n);
              t._OrtAddSessionConfigEntry(r, g, b) !== 0 &&
                We(
                  `Can't set a session config entry: 'enableGraphCapture' - ${i.enableGraphCapture}.`
                );
            }
            if (i.freeDimensionOverrides)
              for (let [g, b] of Object.entries(i.freeDimensionOverrides)) {
                if (typeof g != "string")
                  throw new Error(
                    `free dimension override name must be a string: ${g}`
                  );
                if (typeof b != "number" || !Number.isInteger(b) || b < 0)
                  throw new Error(
                    `free dimension override value must be a non-negative integer: ${b}`
                  );
                let $ = qe(g, n);
                t._OrtAddFreeDimensionOverride(r, $, b) !== 0 &&
                  We(`Can't set a free dimension override: ${g} - ${b}.`);
              }
            return (
              i.extra !== void 0 &&
                en(i.extra, "", new WeakSet(), (g, b) => {
                  let $ = qe(g, n),
                    w = qe(b, n);
                  t._OrtAddSessionConfigEntry(r, $, w) !== 0 &&
                    We(`Can't set a session config entry: ${g} - ${b}.`);
                }),
              [r, n]
            );
          } catch (s) {
            throw (
              (r !== 0 && t._OrtReleaseSessionOptions(r),
              n.forEach((a) => t._free(a)),
              s)
            );
          }
            ...
            if (n < 1073741824) return new Uint8Array(await t.arrayBuffer());
            {
              ...
              try {
                ...
                if (d instanceof RangeError) {
                  let c = Math.ceil(n / 65536);
                  s = new WebAssembly.Memory({ initial: c, maximum: c }).buffer;
                } else throw d;
              }
              let a = 0;
              for (;;) {
                let { done: d, value: c } = await i.read();
                if (d) break;
                let m = c.byteLength;
                new Uint8Array(s, a, m).set(c), (a += m);
              }
  ...
  var Sc,
    ...
    Qt = j(() => {
      ...
      (Sc = ["V", "I", "W", "E", "F"]),
        (Cc = (e, t) => {
          console.log(`[${Sc[e]},${new Date().toISOString()}]${t}`);
        }),
        (es = (e, t) => {
          (Qa = e), (Ja = t);
        }),
        (Ic = (e, t) => {
          let r = tn(e),
            n = tn(Qa);
          r >= n && Cc(r, typeof t == "function" ? t() : t);
        }),
        (Ne = (...e) => {
          Ja && Ic(...e);
        });
      ...
      (ns = new Map([
        ...
        (Xi = async (e, t, r, n) => {
          ...
          try {
            ...
            e.endComputePass(),
              a.copyBufferToBuffer(t, 0, s, 0, i),
              e.flush(),
              await s.mapAsync(GPUMapMode.READ);
            let d = s.getMappedRange();
            if (n) {
              let c = n();
              return c.set(new Uint8Array(d, 0, r)), c;
        ...
        (Yi = class {
          constructor(t) {
            ...
            for (let [r] of ns)
              ji.push(r),
                this.freeBuffers.set(r, []),
                this.freeUniformBuffers.set(r, []);
          }
          upload(t, r) {
            let n = r.buffer,
              i = r.byteOffset,
              s = r.byteLength,
              a = Ki(s),
              d = this.storageCache.get(t);
            if (!d) throw new Error("gpu data for uploading does not exist");
            if (d.originalSize !== s)
              throw new Error(
                `inconsistent data size. gpu data size=${d.originalSize}, data size=${s}`
              );
            let c = this.backend.device.createBuffer({
              ...
              m = c.getMappedRange();
            new Uint8Array(m).set(new Uint8Array(n, i, s)), c.unmap();
            let u = this.backend.getCommandEncoder();
            this.backend.endComputePass(),
              u.copyBufferToBuffer(c, 0, d.gpuData.buffer, 0, a),
              Ne("verbose", () => `[WebGPU] GpuDataManager.upload(id=${t})`),
              this.buffersForUploadingPending.push(c);
          }
          memcpy(t, r) {
            ...
            if (n.originalSize !== i.originalSize)
              throw new Error(
                "inconsistent source and destination gpu data size"
              );
            let s = Ki(n.originalSize),
              a = this.backend.getCommandEncoder();
            this.backend.endComputePass(),
              a.copyBufferToBuffer(n.gpuData.buffer, 0, i.gpuData.buffer, 0, s);
          }
          registerExternalBuffer(t, r, n) {
            let i;
            if (n) {
              if (((i = this.externalBuffers.get(n)), i === void 0))
              ...
              if (t === n)
                return (
                  Ne(
                    "verbose",
                    () =>
                      `[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${i}, buffer is the same, skip.`
                  ),
                  i
                );
              if (
            ...
            return (
              this.storageCache.set(i, {
                gpuData: { id: i, type: 0, buffer: t },
                originalSize: r
              }),
              this.externalBuffers.set(t, i),
              Ne(
                "verbose",
                () =>
                  `[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${i}, registered.`
              ),
              i
            );
          }
          unregisterExternalBuffer(t) {
            ...
            r !== void 0 &&
              ...
              this.externalBuffers.delete(t),
              Ne(
                "verbose",
                () =>
                  `[WebGPU] GpuDataManager.unregisterExternalBuffer() => id=${r}`
              ));
          }
          create(
            t,
            r = GPUBufferUsage.STORAGE |
              GPUBufferUsage.COPY_SRC |
              GPUBufferUsage.COPY_DST
          ) {
            let n = Tc(t),
              i,
              s = (r & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE,
              a = (r & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
            if (s || a) {
              let m = (s ? this.freeBuffers : this.freeUniformBuffers).get(n);
              m
                ? m.length > 0
                  ? (i = m.pop())
                ...
                : (i = this.backend.device.createBuffer({ size: n, usage: r }));
            } else i = this.backend.device.createBuffer({ size: n, usage: r });
            let d = { id: is(), type: 0, buffer: i };
            return (
              this.storageCache.set(d.id, { gpuData: d, originalSize: t }),
              Ne(
                "verbose",
                () => `[WebGPU] GpuDataManager.create(size=${t}) => id=${d.id}`
              ),
              d
            );
          }
          ...
          async download(t, r) {
            ...
            await Xi(this.backend, n.gpuData.buffer, n.originalSize, r);
          }
          refreshPendingBuffers() {
            ...
            if (
              ...
              if (this.backend.sessionStatus === "default") {
                ...
                let t = this.capturedPendingBuffers.get(
                  this.backend.currentSessionId
                );
                t ||
                  ((t = []),
      ...
      (Qi = class {
        ...
        (zt = class {
          static calcShape(t, r, n = !1) {
            ...
            if (i === 0) return r;
            if (s === 0) return t;
            let a = Math.max(t.length, r.length),
              d = new Array(a);
            if (n) {
              if (i < 2 || s < 2) return;
              let c = Qi.calcMatMulShape(
                [t[i - 2], t[i - 1]],
                [r[s - 2], r[s - 1]]
              );
              if (c === void 0) return;
            ...
            for (let c = n ? 3 : 1; c <= a; c++) {
              let m = i - c < 0 ? 1 : t[i - c],
                u = s - c < 0 ? 1 : r[s - c];
              if (m !== u && m > 1 && u > 1) return;
              let g = Math.max(m, u);
              if (m && u) d[a - c] = Math.max(m, u);
              else {
                if (g > 1) return;
                d[a - c] = 0;
              }
          ...
          static isValidBroadcast(t, r) {
            ...
            if (n > i) return !1;
            for (let s = 1; s <= n; s++)
              if (t[n - s] !== 1 && t[n - s] !== r[i - s]) return !1;
            return !0;
          }
        }),
        (M = class e {
          ...
          static convertShape(t, r = 4) {
            ...
            for (; s >= 0; ) {
              ...
              if (r % t[s] !== 0) throw new Error("cannot convert shape");
              (i[s] = 1), (r /= t[s]), s--;
            }
            for (s--; s >= 0; s--) i[s] = t[s];
            return i;
          ...
          static sizeFromDimension(t, r) {
            if (r < 0 || r > t.length)
              throw new Error(
                `invalid dimension of ${r} for sizeFromDimension as Tensor has ${t.length} dimensions.`
              );
          ...
          static sizeToDimension(t, r) {
            if (r < 0 || r > t.length)
              throw new Error(
                `invalid dimension of ${r} for sizeToDimension as Tensor has ${t.length} dimensions.`
              );
        ...
        (mr = class e {
          static adjustPoolAttributes(t, r, n, i, s, a) {
            ...
            for (let d = 0; d < n.length; d++) {
              ...
              if (a[d] >= n[d] || a[d + n.length] >= n[d])
                throw new Error("pads should be smaller than kernel");
            }
          }
          static adjustPadsBasedOnAutoPad(t, r, n, i, s, a, d) {
            if (d) {
          ...
          static computePoolOutputShape(t, r, n, i, s, a, d) {
            if (r.length <= 0)
              throw new Error("input shape must be of size greater than 0");
            let c = [r[0], r[1]];
            return e.computeShapeHelper(t, r, c, n, i, s, a, d), c;
          }
          static computeConvOutputShape(t, r, n, i, s, a, d) {
            if (t.length <= 0 || r.length <= 0)
              throw new Error(
                "invalid input tensor dims or invalid filter tensor dims"
              );
            let c = [t[0], r[0]];
            return e.computeShapeHelper(!1, t, c, n, i, s, a, d), c;
          }
          static computeShapeHelper(t, r, n, i, s, a, d, c) {
            if (t) for (let m = 0; m < r.length - 2; m++) n.push(1);
            else
              for (let m = 0; m < r.length - 2; m++)
                n.push(
                  e.adjustPadAndReturnShape(
                    r[m + 2],
                    i[m],
          ...
          static adjustPadAndReturnShape(t, r, n, i, s, a, d, c) {
            let m = n * (i - 1) + 1;
            if (c && c !== "NOTSET")
              switch (c) {
                case "VALID":
                  return (s[a] = 0), (s[d] = 0), Math.floor((t - m) / r + 1);
                case "SAME_LOWER":
                case "SAME_UPPER":
                  if (n !== 1)
                    throw new Error(
                  ...
                  {
                    let g = ((t + r - 1) / r - 1) * r + i - t;
                    return (
                      (s[a] = Math.floor(
                        c === "SAME_LOWER" ? (g + 1) / 2 : g / 2
                      )),
                      (s[d] = g - s[a]),
                      Math.floor((t + g - i) / r + 1)
                    );
                  }
                default:
                  throw new Error("Unsupported AutoPad type");
              }
            else return Math.floor((t + s[a] + s[d] - m) / r + 1);
          }
        }),
        (Gn = class {
          static getShapeOfGemmResult(t, r, n, i, s) {
            if (t.length !== 2 || n.length !== 2)
              throw new Error("shape need to be of size 2");
            let a, d, c;
            r ? ((a = t[1]), (d = t[0])) : ((a = t[0]), (d = t[1]));
            let m = -1;
            if ((i ? ((c = n[0]), (m = 1)) : ((c = n[1]), (m = 0)), n[m] !== d))
              throw new Error("dimension mismatch");
            if (a <= 0 || c <= 0 || d <= 0)
              throw new Error("invalid shape specified");
            if (s && !zt.isValidBroadcast(s, [a, c]))
              throw new Error("gemm: invalid bias shape for broadcast");
            return [a, c, d];
          }
        }),
        (Ln = -34028234663852886e22),
        (Fn = 34028234663852886e22);
    });
  var fr,
    eo,
    De,
          ...
          return (
            e.forEach((r) => {
              r.length !== 0 &&
                t.push(
                  { type: 12, data: r },
                  { type: 12, data: M.computeStrides(r) }
                );
            }),
            t
          );
        }),
        (Ue = (e) => (e % 4 === 0 ? 4 : e % 2 === 0 ? 2 : 1)),
        (At = (e = "f32", t, r = "0") =>
          !t || t === 1 ? `${e}(${r})` : `vec${t}<${e}>(${r})`),
        (hr = (e, t, r) =>
        ...
        (fe = (e, t, r, n) =>
          e.startsWith("uniforms.") && r > 4
            ...
            : r > 1
              ...
              : e),
        (to = (e, t, r, n, i) => {
          let s = typeof r == "number",
            a = s ? r : r.length,
            d = [...new Array(a).keys()],
            c = a < 2 ? "u32" : a <= 4 ? `vec${a}<u32>` : `array<u32, ${a}>`,
            m = eo(t, i),
            u = typeof m == "string" ? m : m[1],
            g = typeof m == "string" ? m : m[0],
            b = { indices: c, value: u, storage: g, tensor: t },
            $ = (H) => (typeof H == "string" ? H : `${H}u`),
            w = {
              offsetToIndices: !1,
              indicesToOffset: !1,
    ...
    fn o2i_${e}(offset: u32) -> ${b.indices} {
      ...
      return indices;
            ...
            k = (H) => ((w.offsetToIndices = !0), a < 2 ? H : `o2i_${e}(${H})`),
            P = [];
          if (a >= 2)
            for (let H = a - 1; H >= 0; H--)
              P.push(`${fe(T, H, a)} * (indices[${H}])`);
          let R =
              a < 2
                ? ""
                : `
    fn i2o_${e}(indices: ${b.indices}) -> u32 {
      return ${P.join("+")};
            ...
            L = (H) => ((w.indicesToOffset = !0), a < 2 ? H : `i2o_${e}(${H})`),
            V = (...H) =>
              a === 0 ? "0u" : `${b.indices}(${H.map($).join(",")})`,
            Y = (H, ne) => (a < 2 ? `${H}` : `${fe(H, ne, a)}`),
            Q = (H, ne, Se) =>
              a < 2 ? `${H}=${Se};` : `${fe(H, ne, a)}=${Se};`,
            he = {},
            N = (H, ne) => {
              w.broadcastedIndicesToOffset = !0;
              let Se = `${ne.name}broadcastedIndicesTo${e}Offset`;
              if (Se in he) return `${Se}(${H})`;
              let Ye = [];
              for (let Be = a - 1; Be >= 0; Be--) {
                let Ge = ne.indicesGet("outputIndices", Be + ne.rank - a);
                Ye.push(`${Y(T, Be)} * (${Ge} % ${Y(C, Be)})`);
              }
              return (
                (he[Se] = `fn ${Se}(outputIndices: ${ne.type.indices}) -> u32 {
            ...
            se = (H, ne) =>
              (() => {
                if (b.storage === b.value) return `${e}[${H}]=${ne};`;
                if (b.storage === "vec2<u32>" && b.value === "i32")
                  return `${e}[${H}]=vec2<u32>(u32(${ne}), select(0u, 0xFFFFFFFFu, ${ne} < 0));`;
                if (b.storage === "vec2<u32>" && b.value === "u32")
                  return `${e}[${H}]=vec2<u32>(u32(${ne}), 0u);`;
                if (b.storage === "u32" && b.value === "vec4<bool>")
                  return `${e}[${H}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${ne}));`;
                throw new Error(
                  `not supported combination of storage type ${b.storage} and value type ${b.value} yet`
                );
              })(),
            Ce = (H) =>
              (() => {
                if (b.storage === b.value) return `${e}[${H}]`;
                if (b.storage === "vec2<u32>" && b.value === "i32")
                  return `i32(${e}[${H}].x)`;
                if (b.storage === "vec2<u32>" && b.value === "u32")
                  return `u32(${e}[${H}].x)`;
                if (b.storage === "u32" && b.value === "vec4<bool>")
                  return `vec4<bool>(bool(${e}[${H}] & 0xFFu), bool(${e}[${H}] & 0xFF00u), bool(${e}[${H}] & 0xFF0000u), bool(${e}[${H}] & 0xFF000000u))`;
                throw new Error(
                  `not supported combination of storage type ${b.storage} and value type ${b.value} yet`
                );
              })(),
      ...
      return ${Ce(`i2o_${e}(indices)`)};
            ...
            ee =
              a < 2
                ? ""
                : (() => {
                    let H = d.map((Se) => `d${Se}: u32`).join(", "),
                      ne = d.map((Se) => `d${Se}`).join(", ");
                    return `
    fn get_${e}(${H}) -> ${u} {
      return get_${e}ByIndices(${V(ne)});
            ...
            ae = (...H) => {
              if (H.length !== a)
                throw new Error(`indices length must be ${a}`);
              let ne = H.map($).join(",");
              return a === 0
                ? Ce("0u")
                : a === 1
          ...
          return {
            impl: () => {
              let H = [],
                ne = !1;
              return (
                w.offsetToIndices && (H.push(E), (ne = !0)),
                w.indicesToOffset && (H.push(R), (ne = !0)),
                w.broadcastedIndicesToOffset &&
                  (Object.values(he).forEach((Se) => H.push(Se)), (ne = !0)),
                w.set && (H.push(oe), (ne = !0)),
                w.setByIndices && (H.push(me), (ne = !0)),
                w.get && (H.push(ee), (ne = !0)),
                w.getByIndices && (H.push(Ve), (ne = !0)),
                !s &&
                  ne &&
                  H.unshift(
                    `const ${C} = ${b.indices}(${r.join(",")});`,
                    `const ${T} = ${b.indices}(${M.computeStrides(r).join(",")});`
                  ),
                H.join(`
  `)
              );
        ...
        (U = (e, t, r, n = 1) => to(e, t, r, "input", n)),
        (K = (e, t, r, n = 1) => to(e, t, r, "output", n)),
        (qn = (e, t, r, n = 1) => to(e, t, r, "internal", n)),
        (Ji = class {
          constructor(t, r) {
          ...
          mainStart(t = fr) {
            let r = typeof t == "number" ? t : t[0],
              n = typeof t == "number" ? 1 : t[1],
              i = typeof t == "number" ? 1 : t[2];
            if (
              r > this.limits.maxComputeWorkgroupSizeX ||
              n > this.limits.maxComputeWorkgroupSizeY ||
              i > this.limits.maxComputeWorkgroupSizeZ
            )
              throw new Error(
                `workgroup size [${r}, ${n}, ${i}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`
              );
            if (r * n * i > this.limits.maxComputeInvocationsPerWorkgroup)
              throw new Error(
                `workgroup size [${r}, ${n}, ${i}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`
              );
            let s =
      ...
      @builtin(num_workgroups) num_workgroups : vec3<u32>`,
            ...
            workgroup_id.y * num_workgroups[0] + workgroup_id.x) * ${r * n * i}u + local_idx;`;
            return `@compute @workgroup_size(${r}, ${n}, ${i})
    fn main(${a}) {
      ${d}
    `;
          }
          ...
          declareVariable(t, r) {
            ...
            let n = t.usage === "input" ? "read" : "read_write",
              i = t.type.storage;
            return `@group(0) @binding(${r}) var<storage, ${n}> ${t.name}: array<${i}>;`;
          }
          declareVariables(...t) {
            return t.map((r) => this.declareVariable(r, this.variableIndex++))
              .join(`
  `);
          }
          ...
          uniformDeclaration() {
            ...
            let t = [];
            for (let { name: r, type: n, length: i } of this.uniforms)
              if (i && i > 4)
                n === "f16"
                  ? t.push(
                      `@align(16) ${r}:array<mat2x4<${n}>, ${Math.ceil(i / 8)}>`
                    )
                  : t.push(`${r}:array<vec4<${n}>, ${Math.ceil(i / 4)}>`);
              else {
                let s = i == null || i === 1 ? n : `vec${i}<${n}>`;
                t.push(`${r}:${s}`);
              }
            return `
        ...
        @group(0) @binding(${this.variableIndex}) var<uniform> uniforms: Uniforms;`;
          ...
          get additionalImplementations() {
            return (
              ...
              this.variables.map((t) => t.impl()).join(`
  `) +
  ...
  `)
          ...
          get variablesInfo() {
            if (this.uniforms.length === 0) return;
            let t = (r) =>
              [12, 10, 1, 6][["u32", "f16", "f32", "i32"].indexOf(r)];
        ...
        (Pr = (e, t) => {
          ...
          for (let i = 0; i < r; i++) {
            let s = r - 1 - i,
              a = e[s] || 1;
            (t[t.length - 1 - i] || 1) > 1 && a === 1 && n.unshift(s);
          }
          return n;
        });
    });
  var Ec,
    ...
    Rr = j(() => {
      ...
      (Ec = (e) => {
        ...
        (ls = (e, t) =>
          t && t.length !== e ? [...new Array(e).keys()].reverse() : t),
        (kc = (e, t) => M.sortBasedOnPerm(e, ls(e.length, t))),
        (Oc = (e, t, r, n) => {
          let i = [];
          i.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
      var a: ${r.type.indices};`);
          for (let s = 0; s < t; ++s)
            i.push(r.indicesSet("a", e[s], `i[${s}]`));
          return (
            i.push("return a;}"),
            i.join(`
  `)
      ...
      ${a.setByOffset("global_idx", d.getByIndices("aIndices"))}
          ...
          return {
            ...
            getRunData: (m) => {
              let u = M.size(s);
              return {
                outputs: [{ dims: s, dataType: m[0].dataType }],
                dispatchGroup: { x: Math.ceil(u / 64) },
                programUniforms: [{ type: 12, data: u }, ...X(m[0].dims, s)]
              };
            },
            getShaderSource: c
          };
        ...
        (ds = (e, t) => {
          Ec(e.inputs), e.compute(xt(e.inputs[0], t.perm));
        }),
        (cs = (e) => we({ perm: e.perm }));
    });
  var Pc,
    ...
    _s = j(() => {
      ...
      (Pc = {
        ...
        (Mc = (e, t) => {
          let r = [],
            n = e.length;
          for (let s = 0; s < n; s++) t.indexOf(s) === -1 && r.push(e[s]);
          let i = t.map((s) => e[s]);
          return [r, i];
        }),
        (Uc = (e, t) => {
          let r = e.length + t.length,
            ...
            i = 0;
          for (let s = 0; s < r; s++)
            t.indexOf(s) === -1 ? n.push(e[i++]) : n.push(1);
          return n;
        }),
        (Wc = (e, t) => {
          for (let r = 0; r < e.length; ++r)
         ...
         `;
          ...
          fn DIV_CEIL(a : u32, b : u32) -> u32 {
           ...
           if (local_idx == 0u) {
            ...
            getRunData: () => ({
              outputs: [{ dims: s, dataType: i }],
              dispatchGroup: { x: c },
              programUniforms: [{ type: 12, data: m }]
            })
          };
        }),
        (Bt = (e, t, r, n) => {
          let i = e.inputs.length === 1 ? r : ro(e.inputs, r),
            s = i.axes;
          s.length === 0 &&
            !i.noopWithEmptyAxes &&
            (s = e.inputs[0].dims.map(($, w) => w));
          let a = M.normalizeAxes(s, e.inputs[0].dims.length),
            d = a,
            c = e.inputs[0],
            m = Nc(d, e.inputs[0].dims.length);
          m.length > 0 &&
            ((c = e.compute(xt(e.inputs[0], m), {
              inputs: [0],
              outputs: [-1]
            })[0]),
            (d = Dc(d.length, c.dims.length)));
          let [u, g] = Mc(c.dims, d),
            b = u;
          i.keepDims && (b = Uc(u, a)),
            e.compute(
              Vc(
                t,
                { hint: i.cacheKey, inputDependencies: ["type"] },
                [c],
                n,
                e.inputs[0].dataType,
                b,
        ...
        (ps = (e, t) => {
          Bt(e, "ReduceMeanShared", t, "mean");
        }),
        (ms = (e, t) => {
          Bt(e, "ReduceL1Shared", t, "l1");
        }),
        (fs = (e, t) => {
          Bt(e, "ReduceL2Shared", t, "l2");
        }),
        (hs = (e, t) => {
          Bt(e, "ReduceLogSumExpShared", t, "logSumExp");
        }),
        (gs = (e, t) => {
          Bt(e, "ReduceMaxShared", t, "max");
        }),
        (ys = (e, t) => {
          Bt(e, "ReduceMinShared", t, "min");
        }),
        (bs = (e, t) => {
          Bt(e, "ReduceProdShared", t, "prod");
        }),
        (vs = (e, t) => {
          Bt(e, "ReduceSumShared", t, "sum");
        }),
        (ws = (e, t) => {
          Bt(e, "ReduceSumSquareShared", t, "sumSquare");
        }),
        ($s = (e, t) => {
          Bt(e, "ReduceLogSumShared", t, "logSum");
        });
    });
  var Dt,
    Hc,
    ...
    jn = j(() => {
      ...
      (Dt = (e) => {
        ...
        (Kn = (e, t, r, n, i, s, a = !1, d = !1) => {
          let c = [],
            m = r[0].dims,
            u = m.length,
            g = M.normalizeAxes(i, u),
            b = !d && g.length === 0;
          m.forEach((C, T) => {
            b || g.indexOf(T) >= 0 ? a && c.push(1) : c.push(C);
          });
          let $ = c.length,
            w = M.size(c);
          return {
            ...
            getShaderSource: (C) => {
              let T = [],
                S = U("_A", r[0].dataType, u),
                E = K("output", s, $),
                k = n(S, E, g),
                P = k[2];
              for (let R = 0, L = 0; R < u; R++)
                b || g.indexOf(R) >= 0
                  ? (a && L++,
                    (P = `for(var j${R}: u32 = 0; j${R} < ${m[R]}; j${R}++) {
                    ${k[2].includes("last_index") ? `let last_index = j${R};` : ""}
                    ${S.indicesSet("input_indices", R, `j${R}`)}
                    ${P}
                  }`))
                  : (T.push(
                      `${S.indicesSet("input_indices", R, E.indicesGet("output_indices", L))};`
                    ),
                    L++);
              return `
  ...
  `)
            ...
            getRunData: () => ({
              outputs: [{ dims: c, dataType: s }],
              dispatchGroup: { x: Math.ceil(w / 64) },
              programUniforms: [{ type: 12, data: w }, ...X(m, c)]
            })
          };
        }),
        (ro = (e, t) => {
          ...
          return (
            e[1].dims[0] > 0 &&
              e[1].getBigInt64Array().forEach((n) => r.push(Number(n))),
            we({
              axes: r,
              keepDims: t.keepDims,
        ...
        (Mt = (e, t, r, n) => {
          let i = e.inputs,
            s = i.length === 1 ? r : ro(i, r);
          e.compute(
            Kn(
              t,
              { hint: s.cacheKey, inputDependencies: ["rank"] },
              [i[0]],
              s.noopWithEmptyAxes && s.axes.length === 0 ? Hc : n,
              s.axes,
              i[0].dataType,
              s.keepDims,
              s.noopWithEmptyAxes
        ...
        (jc = (e, t) => {
          Dt(e.inputs),
            Mt(e, "ReduceMax", t, (n, i, s) => {
              let a = [];
              for (let d = 0; d < n.rank; d++)
                (s.indexOf(d) >= 0 || s.length === 0) &&
                  a.push(n.indicesSet("input_indices", d, 0));
              return [
                `${a.join(`
  `)}`,
          ...
          Dt(e.inputs),
            Mt(e, "ReduceMean", t, (n, i, s) => {
              ...
              return [
                ...
                `let value = ${i.type.value}(sum / ${a});`
              ];
            });
        }),
        (Yc = (e, t) => {
          Dt(e.inputs),
            Mt(e, "ReduceMin", t, (n, i, s) => {
              let a = [];
              for (let d = 0; d < n.rank; d++)
                (s.indexOf(d) >= 0 || s.length === 0) &&
                  a.push(`input_indices[${d}] = 0;`);
              return [
                `${a.join(`
  `)}`,
                `var value = ${n.getByIndices("input_indices")};`,
        ...
        (Ut = (e, t, r) => {
          ...
          for (let s = 0; s < t.length; s++)
            t.indexOf(s) === -1 ? (n *= e[s]) : (i *= e[s]);
          return i < 32 && n > 1024;
        }),
        (xs = (e, t) => {
          Ut(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes)
            ? Kc(e, t)
            : ps(e, t);
        }),
        (Ss = (e, t) => {
      ...
      return ${e}u;
        ...
        (tp = (e, t) => {
          let r = e.length,
            n = [];
          for (let i = 0; i < r; ++i) {
            let s = t.setByOffset("global_idx", e[i].getByIndices("indices"));
            r === 1
              ? n.push(s)
              : i === 0
                ? n.push(`if (inputIndex == ${i}u) { ${s} }`)
                : i === r - 1
                  ? n.push(`else { ${s} }`)
                  : n.push(`else if (inputIndex == ${i}) { ${s} }`);
          }
          return n.join(`
  `);
        }),
        (Yn = (e, t, r, n) => {
          ...
          for (let x = 0; x < e.length; ++x)
            (d += e[x].dims[t]),
              (s[x] = d),
              m.push(e[x].dims.length),
              (a[x] = U(`input${x}`, n, m[x])),
              c.push("rank"),
              u.push({ type: 12, data: s[x] });
          for (let x = 0; x < e.length; ++x) u.push(...X(e[x].dims));
          u.push(...X(r));
          let g = K("output", n, r.length),
            b = g.indicesGet("indices", t),
            $ = Array.from(Array(s.length).keys())
              .map((x) => `uniforms.sizeInConcatAxis${x}`)
              .join(","),
            w = (x) => `

    ${(() => {
      x.registerUniform("outputSize", "u32");
      for (let C = 0; C < e.length; C++)
        x.registerUniform(`sizeInConcatAxis${C}`, "u32");
      return x.declareVariables(...a, g);
    })()}
    ...
    ${x.mainStart()}
      ...
      ${tp(a, g)}
          ...
          return {
            name: "Concat",
            shaderCache: { hint: `${t}`, inputDependencies: c },
            getRunData: () => ({
              outputs: [{ dims: r, dataType: n }],
        ...
        (Ms = (e, t) => {
          let r = e.inputs,
            n = r[0].dims,
            i = M.normalizeAxis(t.axis, n.length);
          Jc(r, i);
          let s = n.slice();
          s[i] = r.reduce((d, c) => d + (c.dims.length > i ? c.dims[i] : 0), 0);
          let a = r.filter((d) => M.size(d.dims) > 0);
          e.compute(Yn(a, i, s, r[0].dataType), { inputs: a });
        }),
        (Us = (e) => we({ axis: e.axis }));
    });
  var rp,
    ...
    oo = j(() => {
      ...
      (rp = (e, t) => {
        ...
        if (a && d)
          throw new Error(
            "Attention cannot have both past and relative_position_bias"
          );
        if (r.dims.length !== 3)
        ...
        if (t.qkvHiddenSizes.length > 0) {
          ...
          for (let E of t.qkvHiddenSizes)
            if (E % t.numHeads !== 0)
              throw new Error(
                "qkv_hidden_sizes should be divisible by num_heads"
              );
          (g = t.qkvHiddenSizes[0]),
            (b = t.qkvHiddenSizes[1]),
            ($ = t.qkvHiddenSizes[2]);
        }
        let w = m;
        if (g !== b)
        ...
        if (a) {
          ...
          if (a.dims[2] !== t.numHeads)
            throw new Error('Input "past" third dimension must be num_heads');
          if (a.dims[4] !== b / t.numHeads)
            throw new Error(
              'Input "past" fifth dimension must be k_hidden_size / num_heads'
            );
          t.pastPresentShareBuffer || (x = a.dims[3]);
        }
        let C = w + x,
          T = -1,
          S = 0;
        if (s) throw new Error("Mask not supported");
        ...
        return {
          ...
          hiddenSize: g,
          vHiddenSize: $,
          headSize: Math.floor(g / t.numHeads),
          vHeadSize: Math.floor($ / t.numHeads),
          numHeads: t.numHeads,
          isUnidirectional: !1,
        ...
        (np = (e, t, r, n) => {
          let i = Ue(n),
            s = 64,
            a = n / i;
          a < s ? (s = 1) : a / 8 < 64 && (s = Math.ceil(a / 8));
          let d = Math.ceil(n / i / s),
            c = [
              { type: t.dataType, data: 1 / n },
              { type: 12, data: a },
              { type: 12, data: d }
            ],
            m = De(t.dataType, i),
            u = rt(1, i),
            g = (b) => {
              let $ = K("x", t.dataType, t.dims, i),
                x = [
                  { name: "d_inv", type: rt(t.dataType) },
    ...
    ${b.mainStart([s, 1, 1])}
      ...
      thread_max[local_idx] = ${(() => {
        switch (i) {
          ...
          default:
            throw new Error(`Unsupported components: ${i}`);
        }
      })()};
      workgroupBarrier();
      ...
      if (sum == 0) {
        ...
        (ip = (e, t, r, n, i, s, a) => {
          let d = a + i.kvSequenceLength,
            c = [i.batchSize, i.numHeads, i.sequenceLength, d],
            m = s.scale === 0 ? 1 / Math.sqrt(i.headSize) : s.scale,
            u = Ue(i.headSize),
            g = i.headSize / u,
            b = 12,
            $ = {
            ...
            x = n ? ["type", "type", "type"] : ["type", "type"],
            C = (T) => {
              let S = U("q", t.dataType, t.dims, u),
                E = U("key", r.dataType, r.dims, u),
                k = [S, E];
              n && k.push(U("relative_position_bias", n.dataType, n.dims));
              let P = K("output", t.dataType, c),
                R = rt(1, u),
                L = [
                  { name: "M", type: "u32" },
                  { name: "K", type: "u32" },
    ...
    ${T.mainStart([b, b, 1])}
      ...
      if (global_id.y < uniforms.M && global_id.x < uniforms.N) {
        ...
        var sum: f32 = ${(() => {
          ...
          return {
            name: "AttentionProbs",
            shaderCache: { hint: `${u}`, inputDependencies: x },
            getRunData: () => ({
        ...
        (op = (e, t, r, n, i) => {
          let s = i + n.kvSequenceLength,
            a = [n.batchSize, n.sequenceLength, n.vHiddenSize],
            d = 12,
            c = {
              x: Math.ceil(n.vHeadSize / d),
              y: Math.ceil(n.sequenceLength / d),
              z: n.batchSize * n.numHeads
            },
            m = [
              { type: 12, data: n.sequenceLength },
              { type: 12, data: s },
              { type: 12, data: n.vHeadSize },
              { type: 12, data: n.numHeads },
              { type: 12, data: n.vHiddenSize }
            ];
          return {
            name: "AttentionScore",
            ...
            getShaderSource: (b) => {
              let $ = U("probs", t.dataType, t.dims),
                w = U("v", r.dataType, r.dims),
                x = K("output", t.dataType, a),
                C = [
                  { name: "M", type: "u32" },
                  { name: "K", type: "u32" },
                  { name: "N", type: "u32" },
    ...
    ${b.mainStart([d, d, 1])}
     ...
     if (m < uniforms.M && n < uniforms.N) {
       ...
       output[outputIdx] = value;
        ...
        (Xn = (e, t, r, n, i, s, a, d, c, m, u) => {
          let g = e.outputCount > 1,
            b = e.outputCount > 2,
            $ = g && b ? m.pastSequenceLength : 0,
            w = $ + m.kvSequenceLength,
            x = [m.batchSize, m.numHeads, w, m.headSize],
            C = a ? [a, r] : [r],
            T = g
              ? e.compute(Yn(C, 2, x, r.dataType), {
                  inputs: C,
                  outputs: [1]
                })[0]
              : r,
            S = [m.batchSize, m.numHeads, w, m.headSize],
            E = d ? [d, n] : [n],
            k = b
              ? e.compute(Yn(E, 2, S, n.dataType), {
                  inputs: E,
                  outputs: [2]
                })[0]
              : n,
            P = [t, T];
          c && P.push(c);
          let R = e.compute(ip(e, t, T, c, m, u, $), {
            inputs: P,
            outputs: [-1]
          })[0];
          e.compute(np(e, R, m.batchSize * m.numHeads * m.sequenceLength, w), {
            inputs: [R],
            outputs: []
          });
          let L = [R, k];
          e.compute(op(e, R, k, m, $), { inputs: L, outputs: [0] });
        }),
        (ap = (e, t) => {
          let r = [t.batchSize, t.numHeads, t.sequenceLength, t.headSize],
            ...
            c = [e.inputs[0], e.inputs[1], e.inputs[2]],
            m = [
              { type: 12, data: n },
              { type: 12, data: i },
              { type: 12, data: s },
            ...
            u = (g) => {
              let b = K("output_q", c[0].dataType, r),
                $ = K("output_k", c[0].dataType, r),
                w = K("output_v", c[0].dataType, r),
                x = U("input", c[0].dataType, c[0].dims),
                C = U("weight", c[1].dataType, c[1].dims),
                T = U("bias", c[2].dataType, c[2].dims),
                S = x.type.storage,
                E = [
                  { name: "M", type: "u32" },
                  { name: "K", type: "u32" },
  ...
  var sp,
    ...
    Vs = j(() => {
      ...
      (sp = (e, t) => {
        ...
        let r = (n, i, s) => {
          let a = i.length;
          if (a !== n.length) throw new Error(`${s}: num dimensions != ${a}`);
          i.forEach((d, c) => {
            if (d !== n[c]) throw new Error(`${s}: dim[${c}] do not match`);
          });
        };
        if (e[0].dims.length > 1) {
          ...
          r(e[1].dims, n, "Invalid input scale"),
            r(e[2].dims, n, "Invalid input B"),
            r(e[3].dims, n, "Invalid input mean"),
            r(e[4].dims, n, "Invalid input var");
        } else
        ...
        (up = (e, t) => {
          let { epsilon: r, spatial: n, format: i } = t,
            s = e[0].dims,
            a = n ? Ue(s[s.length - 1]) : 1,
            d = i === "NHWC" && s.length > 1 ? a : 1,
            c = M.size(s) / a,
            m = n,
            u = m ? s.length : s,
            g = U("x", e[0].dataType, e[0].dims, a),
            b = U("scale", e[1].dataType, e[1].dims, d),
            $ = U("bias", e[2].dataType, e[2].dims, d),
            w = U("inputMean", e[3].dataType, e[3].dims, d),
            x = U("inputVar", e[4].dataType, e[4].dims, d),
            C = K("y", e[0].dataType, u, a),
            T = () => {
              let E = "";
              if (n)
                E = `let cOffset = ${s.length === 1 ? "0u" : i === "NHWC" ? `outputIndices[${s.length - 1}] / ${a}` : "outputIndices[1]"};`;
              else if (i === "NCHW")
                E = `
              ${C.indicesSet("outputIndices", "0", "0")}
              let cOffset = ${C.indicesToOffset("outputIndices")};`;
              else {
                E = `var cIndices = ${b.type.indices}(0);
                         cIndices[0] = outputIndices[${s.length - 1}];`;
                for (let k = 1; k < b.rank; k++)
                  E += `cIndices[${k}] = outputIndices[${k}];`;
                E += `let cOffset = ${b.indicesToOffset("cIndices")};`;
              }
              return E;
            },
            S = (E) => `
    ...
    ${E.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
      ...
      ${C.setByOffset("global_idx", "value")}
        ...
        (lp = (e) => we(e)),
        (Ns = (e, t) => {
          let { inputs: r, outputCount: n } = e,
            i = lp({ ...t, outputCount: n });
          if ((ke.webgpu.validateInputContent && sp(r, i), t.trainingMode))
            throw new Error(
  ...
  var dp,
    ...
    ${u.mainStart()}
      ...
      ${c.setByOffset("global_idx", "value")}
        ...
        (Hs = (e) => {
          dp(e.inputs), e.compute(cp(e.inputs));
        });
    });
  var pp,
    Pe,
    ...
    Jn = j(() => {
      ...
      (pp = (e, t, r, n, i, s) => {
        let a = Math.ceil(t / 4),
          d = "";
        typeof i == "string" ? (d = `${i}(a)`) : (d = i("a"));
        let c = U("inputData", r, [a], 4),
          m = K("outputData", n, [a], 4);
        return `
    ...
    ${e.mainStart()}
      ...
      ${m.setByOffset("global_idx", d)}
        ...
        (Pe = (e, t, r, n, i, s = e.dataType) => ({
          name: t,
          shaderCache: { hint: i, inputDependencies: ["type"] },
          getShaderSource: (a) => pp(a, M.size(e.dims), e.dataType, s, r, n),
          getRunData: (a) => ({
            outputs: [{ dims: e.dims, dataType: s }],
            dispatchGroup: { x: Math.ceil(M.size(a[0].dims) / 64 / 4) },
            programUniforms: [{ type: 12, data: Math.ceil(M.size(e.dims) / 4) }]
          })
        })),
        (Ls = (e) => {
          e.compute(Pe(e.inputs[0], "Abs", "abs"));
        }),
        (Fs = (e) => {
          e.compute(Pe(e.inputs[0], "Acos", "acos"));
        }),
        (qs = (e) => {
          e.compute(Pe(e.inputs[0], "Acosh", "acosh"));
        }),
        (js = (e) => {
          e.compute(Pe(e.inputs[0], "Asin", "asin"));
        }),
        (Ks = (e) => {
          e.compute(Pe(e.inputs[0], "Asinh", "asinh"));
        }),
        (Ys = (e) => {
          e.compute(Pe(e.inputs[0], "Atan", "atan"));
        }),
        (Xs = (e) => {
          e.compute(Pe(e.inputs[0], "Atanh", "atanh"));
        }),
        (Zs = (e) => we(e)),
        (Qs = (e, t) => {
          let r;
          ...
          e.compute(Pe(e.inputs[0], "Cast", r, void 0, t.cacheKey, t.to));
        }),
        (mp = (e) => {
          let t =
              e.length >= 2 && e[1].data !== 0 ? e[1].getFloat32Array()[0] : Ln,
            r =
              e.length >= 3 && e[2].data !== 0 ? e[2].getFloat32Array()[0] : Fn;
          return we({ min: t, max: r });
        }),
        (Js = (e, t) => {
          let r = e.inputs.length === 1 ? t : mp(e.inputs),
            n = rt(e.inputs[0].dataType);
          e.compute(
            Pe(
              e.inputs[0],
              "Clip",
              (i) => `clamp(${i}, clip_min_, clip_max_)`,
              `
  ...
  `,
        ...
        (eu = (e) => {
          e.compute(Pe(e.inputs[0], "Ceil", "ceil"));
        }),
        (tu = (e) => {
          e.compute(Pe(e.inputs[0], "Cos", "cos"));
        }),
        (ru = (e) => {
          e.compute(Pe(e.inputs[0], "Cosh", "cosh"));
        }),
        (Zn = (e) => we(e)),
        (nu = (e, t) => {
          let r = rt(e.inputs[0].dataType);
          e.compute(
            Pe(
              e.inputs[0],
              "Elu",
  ...
  fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
    ...
    return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
        ...
        (iu = (e) => {
          let t = rt(e.inputs[0].dataType);
          e.compute(Pe(e.inputs[0], "Erf", (r) => `erf_vf32(${r})`, Qn(t)));
        }),
        (ou = (e) => {
          e.compute(Pe(e.inputs[0], "Exp", "exp"));
        }),
        (au = (e) => {
          e.compute(Pe(e.inputs[0], "Floor", "floor"));
        }),
        (su = (e) => {
          let t = rt(e.inputs[0].dataType);
          e.compute(
        ...
        (uu = (e, t) => {
          ...
          e.compute(
            Pe(
              ...
              "LeakyRelu",
              (n) =>
                `select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,
        ...
        (lu = (e) => {
          e.compute(Pe(e.inputs[0], "Not", (t) => `!${t}`));
        }),
        (du = (e) => {
          e.compute(Pe(e.inputs[0], "Neg", (t) => `-${t}`));
        }),
        (cu = (e) => {
          e.compute(Pe(e.inputs[0], "Reciprocal", (t) => `1.0/${t}`));
        }),
        (pu = (e) => {
          let t = rt(e.inputs[0].dataType);
          e.compute(
        ...
        (mu = (e) => {
          e.compute(
            Pe(e.inputs[0], "Sigmoid", (t) => `(1.0 / (1.0 + exp(-${t})))`)
          );
        }),
        (fu = (e) => we(e)),
        (hu = (e, t) => {
          ...
          e.compute(
            Pe(
              ...
              "HardSigmoid",
              (n) =>
                `max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,
              void 0,
              t.cacheKey
            )
          );
        ...
        (gu = (e) => {
          e.compute(Pe(e.inputs[0], "Sin", "sin"));
        }),
        (yu = (e) => {
          e.compute(Pe(e.inputs[0], "Sinh", "sinh"));
        }),
        (bu = (e) => {
          e.compute(Pe(e.inputs[0], "Sqrt", "sqrt"));
        }),
        (vu = (e) => {
          e.compute(Pe(e.inputs[0], "Tan", "tan"));
        }),
        (wu = (e) =>
          `sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`),
        ($u = (e) => {
          e.compute(Pe(e.inputs[0], "Tanh", wu));
        }),
        (ao = (e = "f32") => `
  ...
  `),
        ...
        (_u = (e) => {
          let t = rt(e.inputs[0].dataType);
          e.compute(
            Pe(e.inputs[0], "FastGelu", so, ao(t), void 0, e.inputs[0].dataType)
          );
        }),
        (xu = (e, t) => {
          let r = rt(e.inputs[0].dataType);
          return (
            e.compute(
              Pe(
                ...
                "ThresholdedRelu",
                (n) =>
                  `select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,
        ...
        (Su = (e) => {
          e.compute(Pe(e.inputs[0], "Log", "log"));
        });
    });
  var fp,
    hp,
    ...
    Tu = j(() => {
      ...
      (fp = (e) => {
        ...
        (hp = (e) => {
          ...
          t[2] = t[2] / 2;
          let r = U("input", e[0].dataType, e[0].dims, 4),
            n = U("bias", e[0].dataType, [e[0].dims[2]], 4),
            i = K("output", e[0].dataType, t, 4),
            s = M.size(t) / 4,
            a = De(e[0].dataType);
          return {
            name: "BiasSplitGelu",
    ...
    ${c.mainStart()}
      ...
      ${i.setByOffset("global_idx", "valueLeft * geluRight")}
        ...
        (Iu = (e) => {
          fp(e.inputs), e.compute(hp(e.inputs));
        });
    });
  var gp,
    yp,
      ...
      (gp = (e, t, r, n, i, s, a, d, c, m, u, g) => {
        ...
        typeof d == "string"
          ...
          : typeof d == "function"
            ? (b = $ = d)
            : ((b = d.scalar), ($ = d.vector));
        let w = K("outputData", u, n.length, 4),
          x = U("aData", c, t.length, 4),
          C = U("bData", m, r.length, 4),
          T;
        if (i)
          if (s) {
            let S = M.size(t) === 1,
              E = M.size(r) === 1,
              k = t.length > 0 && t[t.length - 1] % 4 === 0,
              P = r.length > 0 && r[r.length - 1] % 4 === 0;
            S || E
              ? (T = w.setByOffset(
                  "global_idx",
                  $(
                    S
                      ? `${x.type.value}(${x.getByOffset("0")}.x)`
                      : x.getByOffset("global_idx"),
                    E
                      ? `${C.type.value}(${C.getByOffset("0")}.x)`
            ...
            T = w.setByOffset(
              "global_idx",
              $(x.getByOffset("global_idx"), C.getByOffset("global_idx"))
            );
        else {
          if (!s)
            throw new Error(
          ...
          let S = (E, k, P = "") => {
            let R = `aData[indexA${k}][componentA${k}]`,
              L = `bData[indexB${k}][componentB${k}]`;
            return `
        ...
        (yp = (e, t, r, n, i, s, a = r.dataType) => {
          let d = !M.areEqual(r.dims, n.dims),
            c = r.dims,
            m = M.size(r.dims),
            u = !1,
            g = !1,
            b = [d];
          if (d) {
            let $ = zt.calcShape(r.dims, n.dims, !1);
            if (!$)
              throw new Error("Can't perform binary op on the given tensors");
            (c = $), (m = M.size(c));
            let w = M.size(r.dims) === 1,
              x = M.size(n.dims) === 1,
              C = r.dims.length > 0 && r.dims[r.dims.length - 1] % 4 === 0,
              T = n.dims.length > 0 && n.dims[n.dims.length - 1] % 4 === 0;
            b.push(w), b.push(x), b.push(C), b.push(T);
            let S = 1;
            for (let E = 1; E < c.length; E++) {
              let k = r.dims[r.dims.length - E] ?? 1,
                P = n.dims[n.dims.length - E] ?? 1;
              if (k === P) S *= k;
              else break;
            }
            S % 4 === 0 ? ((g = !0), (u = !0)) : (w || x || C || T) && (u = !0);
          } else u = !0;
          return (
            b.push(u),
            {
              ...
              getRunData: () => ({
                outputs: [{ dims: c, dataType: a }],
                dispatchGroup: { x: Math.ceil(m / 64 / 4) },
                programUniforms: [
                  { type: 12, data: Math.ceil(M.size(c) / 4) },
                  ...X(r.dims, n.dims, c)
                ]
              })
            }
        ...
        (Wt = (e, t, r, n, i, s) => {
          e.compute(yp(t, i ?? "", e.inputs[0], e.inputs[1], r, n, s));
        }),
        (Au = (e) => {
          Wt(e, "Add", (t, r) => `${t}+${r}`);
        }),
        ...
        (Pu = (e) => {
          let t = U("input", e.inputs[0].dataType, e.inputs[0].dims).type.value;
          Wt(
            e,
            "Pow",
            {
              scalar: (n, i) => `pow_custom(${n},${i})`,
              vector: (n, i) => `pow_vector_custom(${n},${i})`
            },
            `
      ...
      (kt = (e, t, r = "f32") => {
        ...
        (ei = (e) => {
          ...
          if (t === "HardSigmoid") {
            ...
            let [r, n] = e?.activation_params || [Ln, Fn];
  ...
  var vp,
    ...
    an = j(() => {
      ...
      (vp = (e, t) =>
        ...
        (nn = (e, t, r = "f32", n, i = !1, s = 32, a = !1, d = 32) => {
          let c = t[1] * e[1],
            m = t[0] * e[0],
            u = i ? c : s,
            g = i ? s : c,
          ...
          if (
            !(
              ((i && b === 4 && e[1] === 4) || (!i && (b === 3 || b === 4))) &&
              u % t[0] === 0 &&
              s % t[1] === 0 &&
              e[0] === 4
            )
          )
            throw new Error(`If transposeA ${i} is true, innerElementSize ${b} and workPerThread[1] ${e[1]} must be 4.
  ...
  fn main(@builtin(local_invocation_id) localId : vec3<u32>,
    ...
    for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
        ...
        (on = (e, t, r = "f32", n, i = !1, s = 32, a = !1, d = 32, c = !1) => {
          let m = e[1] * t[1],
            u = e[0] * t[0],
            g = i ? m : s,
            b = i ? s : m;
          if (!(b % t[1] === 0 && g % t[0] === 0 && s % t[1] === 0))
            throw new Error(
              `tileAHight ${b} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${g} must be divisible by workgroupSize[0]${t[0]}, tileInner ${s} must be divisible by workgroupSize[1]${t[1]}`
            );
          let $ = b / t[1],
            w = g / t[0],
            x = s / t[1],
  ...
  `;
        ...
        (_p = (e, t, r, n, i, s = !1) => {
          let [a, d, c] = i,
            ...
            $ = Pr(a, c),
            w = Pr(d, c),
            x = De(n[0].type.tensor),
            C = () => {
              let E = u.rank,
                k = m.rank,
                P = `var aIndices: ${u.type.indices};`;
              for (let R = E - 2 - 1, L = k - 1; R >= 0; R--, L--)
                P += `
  aIndices[${R}] = ${k > 1 ? `batchIndices[${L}]` : "batchIndices"};`;
              return (
                $.forEach((R) => {
                  P += `
  aIndices[${R}] = 0;`;
  ...
  aIndices[${E - 2}] = u32(row);
            ...
            T = () => {
              let E = g.rank,
                k = m.rank,
                P = `var bIndices: ${g.type.indices};`;
              for (let R = E - 2 - 1, L = k - 1; R >= 0; R--, L--)
                P += `
  bIndices[${R}] = ${k > 1 ? `batchIndices[${L}]` : "batchIndices"};`;
              return (
                w.forEach((R) => {
                  P += `
  bIndices[${R}] = 0;`;
  ...
  bIndices[${E - 2}] = u32(row);
      ...
      `;
        ...
        (ii = (e, t, r, n, i = !1) => {
          ...
          Ot(t, V), V.push(...X(m, E, P));
          let Y = ["rank", "rank"],
            Q = e.length > 2;
          Q && (V.push(...X(e[2].dims)), Y.push("rank")), V.push(...X(L));
          let he = (N) => {
            let se = m.length,
              Ce = qn("batchDims", e[0].dataType, se, 1),
              Ve = De(e[0].dataType),
              ee = U("a", e[0].dataType, k, S),
              ae = U("b", e[1].dataType, R, S),
              Ie = K("result", e[0].dataType, L.length, S),
              me = [ee, ae];
            if (Q) {
              let H = i ? S : 1;
              me.push(U("bias", e[2].dataType, e[2].dims.length, H));
            }
            let oe = [
            ...
            Pt(t, oe);
            let ue = De(Ie.type.tensor),
              de = kt(t, Ie.type.value, ue),
              je = _p(S, Q, de, [Ce, ee, ae, Ie], [d, c, m], i);
            return `
    ${N.registerUniforms(oe)
      .registerInternalVariables(Ce)
      .declareVariables(...me, Ie)}
    ${je}
    ${w ? nn(x, C, Ve, Ce) : on(x, C, Ve, Ce)}
                     `;
          };
          return {
            name: "MatMul",
            shaderCache: {
              hint: `${x};${t.activation};${w};${i}`,
              inputDependencies: Y
            },
            getRunData: () => ({
  ...
  var xp,
    ...
    Vu = j(() => {
      ...
      uo();
      an();
      (xp = (e, t, r, n, i = !1, s, a = 4, d = 4, c = 4, m = "f32") => {
        let u = (Q) => {
            switch (Q) {
              case 1:
                return "resData = x[xIndex];";
              case 3:
                return `resData = vec3<${m}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;
              case 4:
                return "resData = x[xIndex / 4];";
              default:
                throw new Error(`innerElementSize ${Q} is not supported.`);
            }
          },
          g = (Q) => {
            switch (Q) {
      ...
      let coords = vec4<i32>(
        ...
        col % outWidth);
      `,
          w = e ? "i32(uniforms.x_shape[1])" : "i32(uniforms.x_shape[2])",
          x = e ? "i32(uniforms.x_shape[2])" : "i32(uniforms.x_shape[3])",
          C = e ? "row" : "col",
          T = e ? "col" : "row",
          S = `
      ...
      fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${P}) {
        ...
        (Nu = (e, t, r, n, i, s, a, d) => {
          ...
          Ne("verbose", () => `[conv2d_mm_webgpu] dispatch = ${E}`);
          let k = w ? (c && m % 4 !== 0 ? 3 : 4) : 1,
            P = T[1] * S[1],
            R = T[0] * S[0],
            L = Math.max(T[0] * k, T[1]),
            V = n % P === 0,
            Y = i % R === 0,
            Q = s % L === 0,
            he = w ? [k, 4, 4] : [1, 1, 1],
          ...
          Ot(t, N), N.push(...X(e[0].dims, e[1].dims));
          let se = ["rank", "rank"];
          a && (N.push(...X(e[2].dims)), se.push("rank")), N.push(...X(r));
          let Ce = (Ve) => {
            let ee = [
              { name: "dim_a_outer", type: "i32" },
              { name: "dim_b_outer", type: "i32" },
        ...
        fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w ? `vec4<${Ie}>` : Ie}) {
          ...
          setOutputAtIndex(flatIndex ${w ? "/ 4" : ""}, value);
              ...
              oe = U("x", e[0].dataType, e[0].dims.length, k === 3 ? 1 : k),
              ue = U("w", e[1].dataType, e[1].dims.length, ae),
              de = [oe, ue],
              je = K("result", e[0].dataType, r.length, ae);
            if (a) {
              let H = U("bias", e[2].dataType, e[2].dims.length, ae);
              de.push(H),
                (me += `
          ...
          ${w ? nn(S, T, Ie, void 0, !c, L) : on(S, T, Ie, void 0, !c, L, !1, void 0, d)}`;
          };
          return {
            name: "Conv2DMatMul",
            shaderCache: {
              hint: `${t.cacheKey};${k};${w};${V};${Y};${Q};${P};${R};${L}`,
  ...
  var lo,
    ...
    Gu = j(() => {
      ...
      (lo = (e, t, r) => {
        let n = e.length > 2,
          i = n ? "value += b[output_channel];" : "",
          s = e[0].dims,
          a = e[1].dims,
          d = a[0] / t.group,
          c = t.format === "NHWC",
          m = oi(s, a, t.dilations, t.pads, t.strides, c),
          u = M.size(m),
          g = [
            { type: 12, data: u },
        ...
        Ot(t, g), g.push(...X(s, a));
        let b = ["rank", "rank"];
        n && (g.push(...X(e[2].dims)), b.push("rank")), g.push(...X(m));
        let $ = (w) => {
          let x = K("output", e[0].dataType, m.length),
            C = De(x.type.tensor),
            T = kt(t, x.type.value, C),
            S = U("x", e[0].dataType, s.length),
            E = U("w", e[1].dataType, a.length),
            k = [S, E];
          n && k.push(U("b", e[2].dataType, e[2].dims.length));
          let P = [
    ...
    ${w.mainStart()}
      ...
      ${x.setByOffset("global_idx", "value")}
        ...
        return {
          name: "GroupedConv",
          shaderCache: { hint: t.cacheKey, inputDependencies: b },
          getRunData: () => ({
            outputs: [{ dims: r ? r(m) : m, dataType: e[0].dataType }],
            dispatchGroup: { x: Math.ceil(u / 64) },
            programUniforms: g
          }),
          getShaderSource: $
        ...
        (Hu = (e, t, r) => {
          let n = e.length > 2,
            ...
            s = Ue(r[2]),
            a = M.size(r) / i / s,
            d = [e[0].dims[0], e[0].dims[1], e[0].dims[2], e[0].dims[3] / i],
            c = [e[1].dims[0], e[1].dims[1], e[1].dims[2], e[1].dims[3] / i],
            m = [r[0], r[1], r[2], r[3] / i],
            u = [
              { type: 12, data: a },
          ...
          Ot(t, u), u.push(...X(d, c, m));
          let g = (s - 1) * t.strides[1] + c[1],
            b = ($) => {
              let w = K("output", e[0].dataType, m.length, i),
                x = De(w.type.tensor),
                C = kt(t, w.type.value, x),
                T = U("x", e[0].dataType, d.length, i),
                S = U("w", e[1].dataType, c.length, i),
                E = [T, S];
              n && E.push(U("b", e[2].dataType, e[2].dims, i));
              let k = n ? "value += b[output_channel];" : "",
                P = [
                  { name: "output_size", type: "u32" },
      ...
      for (var i = 0u; i < ${s}u; i++) {
        ...
        ${w.set("batch", "row", "col + i", "output_channel", "value")};
          ...
          return {
            ...
            shaderCache: {
              hint: `${t.cacheKey};${i};${s};${g};${c[0]};${c[1]}`,
              inputDependencies: n ? ["rank", "rank", "type"] : ["rank", "rank"]
            },
            getRunData: () => ({
              outputs: [{ dims: r, dataType: e[0].dataType }],
    ...
    mo = j(() => {
      ...
      (po = (e, t, r, n, i = !1) => {
        ...
        Ot(t, S),
          ...
          S.push(...X(T));
        let E = (k) => {
          let P = qn("batch_dims", e[0].dataType, x.length),
            R = U("a", e[0].dataType, s.length, g),
            L = U("b", e[1].dataType, a.length, u),
            V = K("output", e[0].dataType, T.length, u),
            Y = De(V.type.tensor),
            Q = kt(t, V.type.value, Y),
            he = [R, L],
            N = "";
          if (w) {
            let oe = i ? u : 1;
            he.push(U("bias", e[2].dataType, e[2].dims.length, oe)),
              (N = `${i ? `value += bias[col / ${oe}];` : `value += ${V.type.value}(bias[row + i]);`}`);
          }
          let se = s.slice(0, -2),
            Ce = a.slice(0, -2),
            Ve = Pr(se, x),
          ...
          let Ie = (oe, ue) => {
              let de = oe.rank,
                je = oe.name;
              if (de === 2)
                return `var ${je}_indices = ${oe.type.indices}(0u, 0u);`;
              let H = P.rank,
                ne = `var ${je}_indices: ${oe.type.indices};`;
              for (let Se = de - 2 - 1, Ye = H - 1; Se >= 0; Se--, Ye--)
                ne += `
  ${je}_indices[${Se}] = ${H > 1 ? `batch_indices[${Ye}]` : "batch_indices"};`;
              return (
                ue.forEach((Se) => {
                  ne += `
  ${je}_indices[${Se}] = 0;`;
                }),
                (ne += `${je}_indices[${de - 2}] = 0u;
                       ${je}_indices[${de - 1}] = 0u;`),
                ne
              );
            },
            me = () => {
              let oe = `var a_data: ${R.type.value};`;
              for (let ue = 0; ue < g; ue++)
                oe += `
                let b_data${ue} = b[(b_offset + (k + ${ue}) * uniforms.N + col) / ${u}];`;
              for (let ue = 0; ue < b; ue++) {
                oe += `a_data = a[(a_offset + (row + ${ue}) * uniforms.K + k) / ${g}];`;
  ...
  `;
    ...
    ${k
      .registerUniforms(ae)
      .registerInternalVariables(P)
      .declareVariables(...he, V)}
    ${k.mainStart()}
    ...
    `;
        ...
        return {
          name: "MatMulNaive",
          shaderCache: {
            hint: `${t.activation};${u};${g};${b};${i}`,
            inputDependencies: w ? ["rank", "rank", "rank"] : ["rank", "rank"]
          },
          getRunData: () => ({
            outputs: [{ dims: r, dataType: e[0].dataType }],
        ...
        (Sp = (e) => {
          ...
          if (
            e[0].dims[e[0].dims.length - 1] !== e[1].dims[e[1].dims.length - 2]
          )
            throw new Error("shared dimension does not match.");
        }),
        (Lu = (e) => {
          Sp(e.inputs);
          let t = zt.calcShape(e.inputs[0].dims, e.inputs[1].dims, !0);
          if (!t) throw new Error("Can't use matmul on the given tensors");
          let r = t[t.length - 1],
            n = e.inputs[0].dims[e.inputs[0].dims.length - 1];
          r < 8 && n < 8
            ? e.compute(po(e.inputs, { activation: "" }, t))
            : e.compute(ii(e.inputs, { activation: "" }, t));
        });
    });
  var oi,
    fo,
    ...
    co = j(() => {
      ...
      (oi = (e, t, r, n, i, s) => {
        let a = e[0],
          d = e.slice(s ? 1 : 2, s ? 3 : 4),
          c = d.length,
          m = t[0],
          g = t.slice(2).map((w, x) => w + (w - 1) * (r[x] - 1)),
          $ = d
            .map((w, x) => w + n[x] + n[x + c])
            .map((w, x) => Math.floor((w - g[x] + i[x]) / i[x]));
        return $.splice(0, 0, a), $.splice(s ? 3 : 1, 0, m), $;
      }),
        (fo = [2, 3, 1, 0]),
        (Cp = (e, t) => {
        ...
        (Fu = (e, t) => {
          ...
          for (let s = 2; s < t[1].dims.length; ++s)
            r[s - 2] === 0 && (r[s - 2] = t[1].dims[s]);
          let n = e.pads.slice();
          mr.adjustPadsBasedOnAutoPad(
            t[0].dims,
            e.strides,
            e.dilations,
            r,
        ...
        (ho = (e) => {
          let t = ei(e),
            r = e.format,
            n = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad],
            i = e.dilations,
            s = e.group,
            a = e.kernel_shape,
            d = e.pads,
        ...
        (Ip = (e, t, r) => {
          ...
          if (r.group !== 1) {
            if (
              ...
              r.wIsConst &&
                !e.kernelCustomData.wT &&
                (e.kernelCustomData.wT = V);
              let Y = [t[0], V];
              t.length === 3 && Y.push(t[2]),
                e.compute(Hu(Y, n, L), { inputs: Y });
          ...
          let s = t.length === 3,
            ...
            m = t[1].dims[2],
            u = t[1].dims[3],
            g = oi(t[0].dims, t[1].dims, r.dilations, n.pads, r.strides, i),
            b = g[i ? 1 : 2],
            $ = g[i ? 2 : 3],
            w = g[i ? 3 : 1],
            x = i && m === a && u === d && r.pads[0] === 0 && r.pads[1] === 0;
          if (
            x ||
            (m === 1 &&
              u === 1 &&
            ...
            if (i) {
              ...
              if (
                (r.wIsConst &&
                  !e.kernelCustomData.wT &&
                  (e.kernelCustomData.wT = se),
                x)
              ) {
                let Ce = a * d * c;
                (L = t[0].reshape([1, R, Ce])),
                  (V = se.reshape([1, Ce, w])),
                  (Y = [1, R, w]);
              } else
                (L = t[0].reshape([R, a * d, c])),
                  (V = se.reshape([1, c, w])),
                  (Y = [R, b * $, w]);
              Q.push(L), Q.push(V);
            } else
              (L = t[0].reshape([R, c, a * d])),
                (V = t[1].reshape([1, w, c])),
                (Y = [R, w, b * $]),
                Q.push(V),
                Q.push(L);
            s && Q.push(t[2]);
            let he = Y[2],
              N = Q[0].dims[Q[0].dims.length - 1];
            he < 8 && N < 8
              ? e.compute(po(Q, n, g, Y, i), { inputs: Q })
              : e.compute(ii(Q, n, g, Y, i), { inputs: Q });
            return;
          }
          let C = !0,
            T =
          ...
          r.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = T);
          let S = [t[0], T];
          s && S.push(t[2]);
          let E = i ? b * $ : w,
            k = i ? w : b * $,
            P = m * u * c;
          e.compute(Nu(S, n, g, E, k, P, s, C), { inputs: S });
        }),
        (Tp = (e, t) => {
          let r = t.format === "NHWC",
            n = [
          ...
          let i = [0, t.pads[0], 0, t.pads[1]],
            s = [1].concat(t.strides),
            a = [1].concat(t.dilations),
            d = [1].concat(t.kernelShape),
            c = Fu(
              { ...t, pads: i, strides: s, dilations: a, kernelShape: d },
              n
            );
          e.compute(lo(n, c, (m) => (r ? [m[0], m[2], m[3]] : [])));
        }),
        (go = (e, t) => {
          Cp(e.inputs, t),
            e.inputs[0].dims.length === 3 ? Tp(e, t) : Ip(e, e.inputs, t);
        });
    });
  var Ap,
    qu,
    ju = j(() => {
      ...
      let coords = vec4<i32>(
        ...
        col % outWidth);
      `,
          c = e ? "i32(uniforms.x_shape[1])" : "i32(uniforms.x_shape[2])",
        ...
        ${a}
        return x[getIndexFromCoords4D(coord, vec4<i32>(uniforms.x_shape))/${i}];`,
          $ = e
            ? `
        let col = colIn * ${i};
        if (row < uniforms.dim_a_outer && col < uniforms.dim_inner) {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
      ...
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        ...
        (qu = (e, t, r, n, i, s, a, d) => {
          ...
          Ne("verbose", () => `[conv_backprop_mm_webgpu] dispatch = ${E}`);
          let k = w ? 4 : 1,
            P = Math.max(T[0] * k, T[1]),
            R = w ? 4 : 1,
            L = [t.kernelShape[c ? 1 : 2], t.kernelShape[c ? 2 : 3]],
            V = [
              L[0] +
                (t.dilations[0] <= 1 ? 0 : (L[0] - 1) * (t.dilations[0] - 1)),
              L[1] +
                (t.dilations[1] <= 1 ? 0 : (L[1] - 1) * (t.dilations[1] - 1))
            ],
            Y = [
              V[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2),
              V[1] - 1 - Math.floor((t.pads[1] + t.pads[3]) / 2)
            ],
            Q = [
              { type: 6, data: n },
              { type: 6, data: i },
          ...
          Ot(t, Q), Q.push(...X(e[0].dims, e[1].dims));
          let he = ["rank", "rank"];
          a && (Q.push(...X(e[2].dims)), he.push("rank")), Q.push(...X(r));
          let N = (se) => {
            let Ce = U("x", e[0].dataType, e[0].dims.length, R),
              Ve = U("w", e[1].dataType, e[1].dims.length, 1),
              ee = K("result", e[0].dataType, r.length, R),
              ae = [Ce, Ve],
              Ie = "";
            if (a) {
              let ue = U("bias", e[2].dataType, e[2].dims.length, R);
              ae.push(ue),
                (Ie += `
            ...
            let me = [
              ...
              { name: "filter_dims", type: "i32", length: L.length },
              { name: "pads", type: "i32", length: Y.length }
            ];
            Pt(t, me);
            let oe = De(e[0].dataType, 1);
            if (oe !== "f16" && oe !== "f32")
              throw new Error(`elemType ${oe} is not supported.`);
            return `
          ${ni("uniforms.result_strides")}
          ${se.registerUniforms(me).declareVariables(...ae, ee)};
          ${Ie}
          ${Ap(c, a, t, Ce.type.value, k)}
          ${w ? nn(S, T, oe, void 0, !c, P) : on(S, T, oe, void 0, !c, P, !1, void 0, d)}`;
          };
          return {
            name: "Conv2DTransposeMatMul",
            shaderCache: {
              hint: `${t.cacheKey};${S};${T};${w}`,
              inputDependencies: he
            },
            getRunData: () => ({
              outputs: [{ dims: r, dataType: e[0].dataType }],
              dispatchGroup: { x: E[0], y: E[1], z: E[2] },
  ...
  var Ep,
    ...
    fn setOutputAtIndex(flatIndex : u32, value : ${s ? `vec4<${a}>` : a}) {
      ...
      fn getBiasByOutputCoords(coords : vec4<u32>) -> ${s ? `vec4<${a}>` : a} {
        ...
        let w = s ? 4 : 1,
          x = U("W", t[1].dataType, t[1].dims.length, w),
          C = U("Dy", t[0].dataType, t[0].dims.length, w),
          T = [C, x];
        n && T.push(U("bias", t[2].dataType, [r[g]].length, w));
        let S = K("result", t[0].dataType, r.length, w),
          E = `{
    ...
    ${s ? E : k}}`;
        ...
        (yo = (e, t, r) => {
          let n = e.length > 2,
            i = t.outputShape,
            s = M.size(i),
            a = [Math.ceil(s / 64), 1, 1];
          Ne("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${a}`);
          let d = t.format === "NHWC",
            c = ["rank", "rank"],
            m = [t.strides[0], t.strides[1]],
            u = [t.kernelShape[d ? 1 : 2], t.kernelShape[d ? 2 : 3]],
            g = [t.dilations[0], t.dilations[1]],
            b = [
              u[0] +
                (t.dilations[0] <= 1
                  ? 0
                  : (t.kernelShape[d ? 1 : 2] - 1) * (t.dilations[0] - 1)),
              u[1] +
                (t.dilations[1] <= 1
                  ? 0
                  : (t.kernelShape[d ? 2 : 3] - 1) * (t.dilations[1] - 1))
            ],
            $ = [
              b[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2),
              b[1] - 1 - Math.floor(t.pads[1] + t.pads[3]) / 2
            ],
            w = !1,
            x = t.group,
            C = e[1].dims,
          ...
          n && (E.push(...X(e[2].dims)), c.push("rank")), E.push(...X(i));
          let k = a[1] === 1 && a[2] === 1,
            P = (R) => {
              let L = [
                  { name: "output_size", type: "u32" },
                  { name: "strides", type: "u32", length: m.length },
                  { name: "filter_dims", type: "u32", length: u.length },
                  { name: "dilations", type: "u32", length: u.length },
                  {
                    name: "effective_filter_dims",
                    type: "u32",
                    length: b.length
                  },
                  { name: "pads", type: "i32", length: $.length },
                  { name: "input_channels_per_group", type: "u32" },
                  { name: "output_channels_per_group", type: "u32" }
                ],
                V = De(e[0].dataType);
              return `${Ep(R, e, i, n, k, w, V, L, d)}`;
            };
          return {
            name: "ConvTranspose2D",
            shaderCache: { hint: `${t.cacheKey};`, inputDependencies: c },
            getRunData: () => ({
              dispatchGroup: { x: a[0], y: a[1], z: a[2] },
  ...
  var kp,
    ...
    Qu = j(() => {
      ...
      Jt();
      Rr();
      (kp = (e, t, r, n, i, s) => (e - 1) * t + r + (n - 1) * i + 1 - s),
        (Op = (e, t, r, n, i) => {
          let s = Math.floor(e / 2);
          t === "SAME_UPPER"
            ? ((r[n] = s), (r[i] = e - s))
            : t === "SAME_LOWER" && ((r[n] = e - s), (r[i] = s));
        }),
        (Pp = (e, t, r, n, i, s, a, d, c, m) => {
          let u = e.length - 2,
            g = m.length === 0;
          if (c.length === 0) for (let w = 0; w < u; ++w) c.push(0);
          let b = e[0],
            $ = t[d ? 3 : 1] * i;
          for (let w = 0, x = e.length - u - (d ? 1 : 0); w < u; ++w, ++x) {
            let C = e[x],
              T = g ? C * a[w] : m[w],
              S = kp(C, a[w], s[w], t[x], r[w], T);
            Op(S, n, s, w, w + u),
              g &&
                m.push(
                  a[w] * (C - 1) +
          ...
          m.splice(0, 0, b), m.splice(d ? 3 : 1, 0, $);
        }),
        (Yu = (e, t) => {
          let r = e.kernelShape.slice();
          if (
            e.kernelShape.length === 0 ||
            e.kernelShape.reduce((g, b) => g * b, 1) === 0
          ) {
            r.length = 0;
            for (let g = 2; g < t[1].dims.length; ++g) r.push(t[1].dims[g]);
          }
          let n = e.format === "NHWC";
          r.splice(0, 0, t[1].dims[0]), r.splice(n ? 3 : 1, 0, t[1].dims[1]);
          let i = e.pads.slice(),
            s = e.outputShape.slice(),
            a = e.outputPadding.slice(),
            d = t[0].dims,
            c = e.dilations.slice();
          if (c.reduce((g, b) => g + b, 0) === 0) {
            let g = t[0].dims.length - 2;
            c = new Array(g).fill(1);
          }
          let m = e.strides.slice();
          if (m.reduce((g, b) => g + b, 0) === 0) {
            let g = t[0].dims.length - 2;
            m = new Array(g).fill(1);
          }
          Pp(d, r, c, e.autoPad, e.group, i, m, n, a, s);
        ...
        (Xu = (e) => {
          let t = ei(e),
            r = e.format,
            n = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][
        ...
        (Rp = (e, t) => {
          ...
          if (e.length === 3 && (e[2].dims.length !== 1 || e[2].dims[0] !== i))
            throw new Error("invalid bias");
          let s = e[0].dims.length - 2;
          if (
            t.dilations.reduce((u, g) => u + g, 0) > 0 &&
            t.dilations.length !== s
          )
            throw new Error(`dilations should be ${s}D`);
          if (
            t.strides.reduce((u, g) => u + g, 0) > 0 &&
            t.strides.length !== s
          )
            throw new Error(`strides should be ${s}D`);
          if (t.pads.reduce((u, g) => u + g, 0) > 0 && t.pads.length !== s * 2)
            throw new Error(`pads should be ${s * 2}D`);
          if (t.outputPadding.length !== s && t.outputPadding.length !== 0)
            throw new Error(`output_padding should be ${s}D`);
          if (
            t.kernelShape.reduce((u, g) => u + g, 0) > 0 &&
            t.kernelShape.length !== 0 &&
            t.kernelShape.length !== e[1].dims.length - 2
          )
            throw new Error("invalid kernel shape");
        ...
        (Bp = (e, t, r) => {
          ...
          r.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = C);
          let T = [t[0], C],
            S = t.length === 3;
          S &&
            (!i && t[2].dims.length === 1
              ? T.push(t[2].reshape([t[2].dims[0], 1, 1]))
              : T.push(t[2])),
            e.compute(qu(T, n, s, b, $, w, S, x), { inputs: T });
        }),
        (Dp = (e, t) => {
          let r = t.format === "NHWC",
            n = [
          ...
          d.length === 0 && (d = [0, 0]),
            ...
            (i = [1].concat(i));
          let c = Yu(
            { ...t, pads: d, strides: a, dilations: s, kernelShape: i },
            n
          );
          e.compute(
            yo(n, c, (m) => (r ? [m[0], m[2], m[3]] : [m[0], m[1], m[3]]))
          );
        }),
        (Zu = (e, t) => {
          Rp(e.inputs, t),
            e.inputs[0].dims.length === 3 ? Dp(e, t) : Bp(e, e.inputs, t);
        });
    });
  var Mp,
    Ju,
    ...
    tl = j(() => {
      ...
      (Mp = (e, t, r, n) => {
        let i = M.size(t),
          ...
          m = M.normalizeAxis(c, s),
          u = (g) => {
            let b = ` i32(${a.indicesGet("inputIndices", "uniforms.axis")}) `,
              $ = fe("uniforms.input_shape", "uniforms.axis", s),
              w = n.reverse ? b + (n.exclusive ? " + 1" : "") : "0",
              x = n.reverse ? $ : b + (n.exclusive ? "" : " + 1");
            return `
        ...
        return {
          name: "CumSum",
          shaderCache: { hint: n.cacheKey, inputDependencies: ["rank"] },
          getRunData: () => ({
        ...
        (Ju = (e, t) => {
          let r = e.inputs[0].dims,
            n = e.inputs[0].dataType,
            i = e.inputs[1];
          e.compute(Mp(n, r, i, t), { inputs: [0] });
        }),
        (el = (e) => {
          let t = e.exclusive === 1,
            r = e.reverse === 1;
          return we({ exclusive: t, reverse: r });
        });
    });
  var Up,
    Wp,
  ...
  `)
          ...
          c
            ? (([r, n, i, s] = e.dims),
              (a = u
                ? [r, n, i, m, m, s / m ** 2]
                : [r, n, i, s / m ** 2, m, m]),
              (d = u ? [0, 1, 3, 2, 4, 5] : [0, 1, 4, 2, 5, 3]))
            : (([r, n, i, s] = [e.dims[0], e.dims[2], e.dims[3], e.dims[1]]),
              (a = u
                ? [r, m, m, s / m ** 2, n, i]
                : [r, s / m ** 2, m, m, n, i]),
              (d = u ? [0, 3, 4, 1, 5, 2] : [0, 1, 4, 2, 5, 3]));
          let g = e.reshape(a),
            b = g.dims.length,
            $ = e.dataType,
            w = U("a", $, b),
    ...
    ${T.mainStart()}
      ...
      ${x.setByOffset("global_idx", w.getByIndices("aIndices"))}
          ...
          return {
            ...
            getRunData: (T) => {
              let S = c
                ...
                E = M.size(S),
                k = g.dims,
                P = M.sortBasedOnPerm(k, d);
              return {
                outputs: [{ dims: S, dataType: T[0].dataType }],
                dispatchGroup: { x: Math.ceil(E / 64) },
                programUniforms: [{ type: 12, data: E }, ...X(k, P)]
              };
            },
            getShaderSource: C
          };
        ...
        (rl = (e, t) => {
          Up(e.inputs), e.compute(Np(e.inputs[0], t));
        }),
        (nl = (e) =>
          we({ blocksize: e.blocksize, mode: e.mode, format: e.format }));
    });
  var bo,
    ai,
    ol,
      ...
      (bo = "[a-zA-Z]|\\.\\.\\."),
        ...
        (vo = class {
          ...
          addSymbol(t, r) {
            ...
            n === void 0 ? (n = [r]) : n.push(r),
              this.symbolToIndices.set(t, n);
          }
        }),
        (wo = class {
          constructor(t, r) {
            ...
            (this.hasEllipsis = !1),
              ...
              (this.lhs = new Array()),
              (this.outputDims = []);
            let [n, i] = r.includes("->") ? r.split("->", 2) : [r, ""];
            if (!n.match(RegExp(Hp))) throw new Error("Invalid LHS term");
            if (
              (n.split(",").forEach((d, c) => {
                let m = t[c].dims.slice();
                if (!d.match(RegExp(ol))) throw new Error("Invalid LHS term");
                let u = this.processTerm(d, !0, m, c);
                this.lhs.push(u);
              }),
              i === "")
            )
              i += [...this.symbolToInfo.entries()]
                .filter(([d, c]) => c.count === 1 || d === "...")
                .map(([d]) => d)
                .join("");
            else if (!i.match(RegExp(ai))) throw new Error("Invalid RHS");
            i.match(RegExp(bo, "g"))?.forEach((d) => {
              if (d === "...")
                this.outputDims = this.outputDims.concat(this.ellipsisDims);
              else {
                let c = this.symbolToInfo.get(d);
          ...
          addSymbol(t, r, n) {
            let i = this.symbolToInfo.get(t);
            if (i !== void 0) {
              if (i.dimValue !== r && i.count !== 1)
                throw new Error("Dimension mismatch");
              i.count++, i.inputIndices.push(n);
            } else i = { count: 1, dimValue: r, inputIndices: [n] };
            this.symbolToInfo.set(t, i);
          }
          processTerm(t, r, n, i = -1) {
            let s = n.length,
              a = !1,
              d = [],
              c = 0;
            if (!t.match(RegExp(ol)) && !r && t !== "")
              throw new Error("Invalid LHS term");
            let m = t.match(RegExp(bo, "g")),
              u = new vo(i);
            return (
              m?.forEach((g, b) => {
                if (g === "...") {
                  ...
                  a = !0;
                  let $ = s - m.length + 1;
                  if ($ < 0) throw new Error("Ellipsis out of bounds");
                  if (((d = n.slice(c, c + $)), this.hasEllipsis)) {
                    if (
                      this.ellipsisDims.length !== d.length ||
                      this.ellipsisDims.toString() !== d.toString()
                    )
                      throw new Error("Ellipsis dimensions mismatch");
                  } else if (r)
                    (this.hasEllipsis = !0), (this.ellipsisDims = d);
                  else throw new Error("Ellipsis must be specified in the LHS");
                  for (let w = 0; w < d.length; w++) {
                    let x = String.fromCharCode("0".charCodeAt(0) + w);
                    u.addSymbol(x, b + w), this.addSymbol(x, n[c++], i);
                  }
                } else
                  u.addSymbol(
                    g,
                    b + (this.hasEllipsis ? this.ellipsisDims.length - 1 : 0)
                  ),
                    this.addSymbol(g, n[c++], i);
              }),
              u
            );
          }
        ...
        (al = (e) => e + "_max"),
        (Gp = (e, t, r, n) => {
          let s = e.map((u) => u.length).map((u, g) => U(`input${g}`, t, u)),
            a = M.size(n),
            d = K("output", t, n.length),
            c = [...r.symbolToInfo.keys()].filter(
              (u) => !r.rhs.symbolToIndices.has(u)
            ),
            m = (u) => {
              let g = [],
                b = "var prod = 1.0;",
                ...
                T = [],
                S = [],
                E = r.symbolToInfo.size === r.rhs.symbolToIndices.size;
              r.symbolToInfo.forEach((P, R) => {
                if (r.rhs.symbolToIndices.has(R)) {
                  let L = r.rhs.symbolToIndices.get(R)?.[0];
                  L !== void 0 &&
                    r.lhs.forEach((V, Y) => {
                      if (P.inputIndices.includes(Y)) {
                        let Q = V.symbolToIndices.get(R);
                        if (Q === void 0)
                          throw new Error("Invalid symbol error");
                        Q.forEach((he) => {
                          g.push(
                            `${s[Y].indicesSet(`input${Y}Indices`, he, d.indicesGet("outputIndices", L))}`
                          );
                        });
                      }
                    });
                  ...
                  r.lhs.forEach((L, V) => {
                    if (P.inputIndices.includes(V)) {
                      let Y = L.symbolToIndices.get(R);
                      if (Y === void 0) throw new Error("Invalid symbol error");
                      Y.forEach((Q) => {
                        x.push(
                          `${s[V].indicesSet(`input${V}Indices`, Q, `${R}`)}`
                        );
                      }),
                        S.push(
                          `prod *= ${s[V].getByIndices(`input${V}Indices`)};`
                        );
                    }
                  }),
                    C.push(
                      `for(var ${R}: u32 = 0; ${R} < uniforms.${al(R)}; ${R}++) {`
                    ),
                    T.push("}");
              });
              let k = E
                ? [
                    ...g,
                    `let sum = ${s.map((P, R) => P.getByIndices(`input${R}Indices`)).join(" * ")};`
                  ]
                : [...g, $, ...C, ...x, b, ...S, w, ...T];
              return `
              ${u
                .registerUniforms(
                  c.map((P) => ({ name: `${al(P)}`, type: "u32" }))
                )
                .registerUniform("outputSize", "u32")
                .declareVariables(...s, d)}

              ${u.mainStart()}
              ${u.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
              var outputIndices = ${d.offsetToIndices("global_idx")};
              ${s.map((P, R) => `var input${R}Indices: ${s[R].type.indices};`)
                .join(`
  `)}
              ${k.join(`
  `)};
          ...
          return {
            ...
            getRunData: () => {
              let u = c
                .filter((b) => r.symbolToInfo.has(b))
                .map((b) => ({
                  type: 12,
                  data: r.symbolToInfo.get(b)?.dimValue || 0
                }));
              u.push({ type: 12, data: a });
              let g = e
                .map((b, $) => [...X(b)])
                .reduce((b, $) => b.concat($), u);
              return (
        ...
        (sl = (e, t) => {
          let r = new wo(e.inputs, t.equation),
            n = r.outputDims,
            i = e.inputs.map((s, a) => s.dims);
          e.compute(Gp(i, e.inputs[0].dataType, r, n));
        }),
        (ul = (e) => {
          let t = e.equation.replace(/\s+/g, "");
          return we({ equation: t });
        });
    });
  var Lp,
    dl,
    ...
    pl = j(() => {
      ...
      (Lp = (e) => {
        ...
        let t = e[0].dims,
          ...
          n = r.length < t.length ? 0 : r.length - t.length,
          i = t.length < r.length ? 0 : t.length - r.length;
        for (; n < r.length && i < t.length; ++n, ++i)
          if (r[n] !== t[i] && r[n] !== 1 && t[i] !== 1)
            throw new Error(
        ...
        (dl = (e, t) => {
          ...
          for (let i = 0; i < t.length; ++i)
            n.push(t[i] === 1 ? e[i + r] : t[i]);
          return n;
        }),
        (Fp = (e, t) => (e.length > t.length ? dl(e, t) : dl(t, e))),
        (qp = (e) => {
          let t = e[0].dims,
            r = Array.from(e[1].getBigInt64Array(), Number),
            n = Fp(t, r),
            i = e[0].dataType,
            s = i === 9 ? 4 : 1,
            a = Math.ceil(M.size(n) / s),
            d = (m) => {
              let u = U("input", i, t.length, s),
                g = K("output", i, n.length, s),
                b;
              if (i === 9) {
                let $ = (w, x, C = "") => `
      ...
      ${b}`;
            ...
            c = [{ type: 12, data: a }, ...X(t, n)];
          return {
            name: "Expand",
            shaderCache: { hint: `${n.length}`, inputDependencies: ["rank"] },
            getShaderSource: d,
            getRunData: () => ({
        ...
        (cl = (e) => {
          Lp(e.inputs), e.compute(qp(e.inputs), { inputs: [0] });
        });
    });
  var jp,
    ml,
    fl = j(() => {
      ...
      (jp = (e) => {
        ...
        let bias${$} = ${c.getByOffset(`bias${$}_offset / 4`)}[bias${$}_offset % 4];`,
              b = i
                ? `
        let bias = ${c.getByOffset("global_idx % (uniforms.bias_size / 4)")};`
                : `${g(0)}${g(1)}${g(2)}${g(3)}
        let bias = ${d.type.value}(bias0, bias1, bias2, bias3);`;
            return `${a.registerUniforms(u).declareVariables(d, c, m)}
      ...
      ${a.mainStart(fr)}
        ...
        return {
          ...
          getShaderSource: s,
          getRunData: (a) => ({
            outputs: [{ dims: a[0].dims, dataType: a[0].dataType }],
            programUniforms: [
              { type: 12, data: Math.ceil(r / 4) },
              { type: 12, data: n }
            ],
            dispatchGroup: { x: Math.ceil(r / fr / 4) }
          })
        };
      }),
        (ml = (e) => {
          e.inputs.length < 2 || M.size(e.inputs[1].dims) === 0
            ? _u(e)
            : e.compute(jp(e.inputs));
        });
    });
  var Kp,
    Yp,
      ...
      (Kp = (e) => {
        ...
        (Yp = (e, t) => {
          let r = e[0].dims,
            n = e[1].dims,
            i = r.length,
            s = M.normalizeAxis(t.axis, i),
            a = r.slice(0);
          a.splice(s, 1, ...n);
          let d = r[s],
            c = e[0].dataType === 9 ? 4 : 1,
            m = Math.ceil(M.size(a) / c),
            u = [
              { type: 12, data: m },
              { type: 6, data: d },
              { type: 12, data: s },
              ...X(e[0].dims, e[1].dims, a)
            ],
            g = (b) => {
              let $ = U("data", e[0].dataType, e[0].dims.length, c),
                w = U("inputIndices", e[1].dataType, e[1].dims.length),
                x = K("output", e[0].dataType, a.length, c),
                C = (S) => {
                  let E = n.length,
                    k = `var indicesIndices${S}  = ${w.type.indices}(0);`;
                  for (let P = 0; P < E; P++)
                    k += `${E > 1 ? `indicesIndices${S}[${P}]` : `indicesIndices${S}`} = ${a.length > 1 ? `outputIndices${S}[uniforms.axis + ${P}]` : `outputIndices${S}`};`;
                  k += `
          ...
          `;
                  for (let P = 0, R = 0; P < i; P++)
                    P === s
                      ? ((k += `${i > 1 ? `dataIndices${S}[${P}]` : `dataIndices${S}`} = u32(idx${S});`),
                        (R += E))
                      : ((k += `${i > 1 ? `dataIndices${S}[${P}]` : `dataIndices${S}`} = ${a.length > 1 ? `outputIndices${S}[${R}]` : `outputIndices${S}`};`),
                        R++);
                  return k;
                },
                T;
        ...
        ${b.mainStart()}
          ...
          return {
            ...
            getRunData: () => ({
              ...
              dispatchGroup: { x: Math.ceil(m / 64) },
              programUniforms: u
            }),
            getShaderSource: g
          };
      ...
      (Xp = (e) => {
        ...
        (Zp = (e, t) => {
          let r = e[0].dims,
            ...
            s = e[1].dims,
            a = e[1].dataType,
            d = M.normalizeAxis(t.axis, i),
            c = r[d],
            m = s.slice(0),
            u = M.size(m),
            g = U("input", n, i),
            b = U("indicesInput", a, s.length),
            $ = K("output", n, m.length),
            w = [
              { type: 12, data: u },
              { type: 6, data: c },
          ...
          return (
            w.push(...X(r, s, m)),
            {
              ...
              getRunData: () => ({
                outputs: [{ dims: m, dataType: e[0].dataType }],
                dispatchGroup: { x: Math.ceil(u / 64) },
                programUniforms: w
              }),
              getShaderSource: (T) => `
  ...
  var Qp,
      ...
      (Qp = (e) => {
        ...
        (Jp = (e, t) => {
          ...
          let c = M.size(d),
            ...
            u = ["type", "type"];
          e.length === 3 && (m.push(...X(e[2].dims)), u.push("rank")),
            m.push(...X(d));
          let g = (b) => {
            let $ = "";
            t.transA && t.transB
            ...
            let w = t.alpha === 1 ? "" : "value *= uniforms.alpha;",
              x = U("a", e[0].dataType, e[0].dims),
              C = U("b", e[1].dataType, e[1].dims),
              T = x.type.value,
              S = null,
              E = [x, C];
            e.length === 3 &&
              ((S = U("c", e[2].dataType, e[2].dims.length)), E.push(S));
            let k = K("output", e[0].dataType, d.length);
            E.push(k);
            let P = [
              { name: "output_size", type: "u32" },
              { name: "M", type: "u32" },
    ...
    ${b.mainStart()}
      ...
      output[global_idx] = value;
          ...
          return {
            name: "Gemm",
            shaderCache: { hint: `${t.cacheKey}`, inputDependencies: u },
            getRunData: () => ({
        ...
        (_l = (e, t) => {
          Qp(e.inputs), e.compute(Jp(e.inputs, t));
        });
    });
  var em,
    tm,
    ...
    Cl = j(() => {
      ...
      (em = (e, t) => {
        let r = e[0].dims,
          n = r,
          i = 2,
          s = M.sizeToDimension(r, i),
          a = M.sizeFromDimension(r, i),
          d = Ue(a),
          c = a / d,
          m = [r[0], r[1], c],
          u = ["rank", "type", "type"],
        ...
        g.push(...X(m, m));
        let b = ($) => {
          let w = U("x", e[0].dataType, m.length, d),
            x = U("scale", e[1].dataType, e[1].dims),
            C = U("bias", e[2].dataType, e[2].dims),
            T = K("output", e[0].dataType, m.length, d),
            S = [w, x, C, T],
            E = w.type.value,
            k = d === 1 ? "f32" : `vec${d}<f32>`,
            P = 64,
    ...
    ${$.mainStart(P)}
      ...
      for (var h = localIndex; h < uniforms.normPackedSize; h += workgroupSize) {
        ...
        return {
          ...
          shaderCache: { hint: `${t.epsilon};${d}`, inputDependencies: u },
          getRunData: () => ({
            outputs: [{ dims: n, dataType: e[0].dataType }],
            dispatchGroup: { x: s },
            programUniforms: g
        ...
        (tm = (e, t, r, n, i, s, a, d) => {
          let c = Ue(a),
            ...
            C = [
              { type: 12, data: w },
              { type: 12, data: s },
              { type: 12, data: Math.floor(a / c) },
              { type: 12, data: Math.floor((s * a) / c) }
            ],
            T = (R) => {
              let L = U("input", t.dataType, t.dims, c);
              return `
    ...
    ${R.mainStart(m)}
      ...
      output[global_idx] = ${b("sum", "squaredSum")};
            ...
            S = e.compute(
              {
                ...
                shaderCache: { hint: `${c}`, inputDependencies: x },
                getRunData: () => ({
                  outputs: [{ dims: [i, a, m, 2], dataType: 1 }],
                  dispatchGroup: { x: (i * a) / c },
                  programUniforms: C
                }),
                getShaderSource: T
              },
            ...
            E = [
              ...
              { type: 12, data: s },
              { type: 12, data: Math.floor(a / c) },
              { type: 12, data: Math.floor((m * a) / c) }
            ],
            k = ["type", "type", "type"],
            P = (R) => {
              let L = U("scale", r.dataType, r.dims, c),
                V = U("bias", n.dataType, n.dims, c);
              return `
          ...
          return e.compute(
            {
              ...
              shaderCache: { hint: `${c};${d}`, inputDependencies: k },
              getRunData: () => ({
                outputs: [{ dims: [i, a, 2], dataType: 1 }],
                dispatchGroup: { x: Math.ceil($ / 64) },
                programUniforms: E
              }),
              getShaderSource: P
            },
            { inputs: [S, r, n], outputs: [-1] }
          )[0];
        }),
        (rm = (e, t, r) => {
          let n = t[0].dims,
            ...
            g = ["type", "type"],
            b = tm(e, t[0], t[1], t[2], s, d, a, r.epsilon),
            $ = (w) => {
              let x = De(t[0].dataType),
                C = c === 1 ? "vec2f" : `mat2x${c}f`,
                T = c === 1 ? x : `vec${c}<${x}>`,
                S = U("input", t[0].dataType, t[0].dims, c),
                E = K("output", t[0].dataType, i, c);
              return `
    ...
    ${w.mainStart()}
      ...
      output[global_idx] = fma(input[global_idx], ${T}(scale[0]), ${T}(scale[1]));
          ...
          e.compute(
            {
              ...
              shaderCache: { hint: `${c}`, inputDependencies: g },
              getRunData: () => ({
        ...
        (Sl = (e, t) => {
          t.format === "NHWC" ? rm(e, e.inputs, t) : e.compute(em(e.inputs, t));
        });
    });
  var nm,
    im,
      ...
      (nm = (e) => {
        ...
        (im = (e, t, r) => {
          let n = t.simplified,
            ...
            a = !n && e[2],
            d = i,
            c = M.normalizeAxis(t.axis, i.length),
            m = M.sizeToDimension(i, c),
            u = M.sizeFromDimension(i, c),
            g = M.size(s.dims),
            b = a ? M.size(a.dims) : 0;
          if (g !== u || (a && b !== u))
            throw new Error(`Size of X.shape()[axis:] == ${u}.
         Size of scale and bias (if provided) must match this.
         Got scale size of ${g} and bias size of ${b}`);
          let $ = [];
          for (let P = 0; P < i.length; ++P) P < c ? $.push(i[P]) : $.push(1);
          let w = Ue(u),
            x = ["type", "type"],
            C = [
              { type: 12, data: m },
              { type: 1, data: u },
              { type: 12, data: Math.floor(u / w) },
          ...
          let T = r > 1,
            S = r > 2,
            E = (P) => {
              let R = De(e[0].dataType),
                L = [
                  U("x", e[0].dataType, e[0].dims, w),
                  U("scale", s.dataType, s.dims, w)
                ];
              a && L.push(U("bias", a.dataType, a.dims, w)),
                L.push(K("output", e[0].dataType, d, w)),
                T && L.push(K("mean_data_output", 1, $)),
                S && L.push(K("inv_std_output", 1, $));
              let V = [
    ...
    ${P.mainStart()}
      ...
      for (var j: u32 = 0; j < uniforms.norm_size_vectorized; j++) {
        let f32input = ${hr(R, w, "x[j + offset]")};
        let f32scale = ${hr(R, w, "scale[j]")};
      ...
      ${S ? "inv_std_output[global_idx] = inv_std_dev" : ""};
            ...
            k = [{ dims: d, dataType: e[0].dataType }];
          return (
            T && k.push({ dims: $, dataType: 1 }),
            S && k.push({ dims: $, dataType: 1 }),
            {
              name: "LayerNormalization",
              shaderCache: { hint: `${w};${r};${n}`, inputDependencies: x },
              getRunData: () => ({
                outputs: k,
                dispatchGroup: { x: Math.ceil(m / 64) },
                programUniforms: C
        ...
        (Il = (e, t) => {
          nm(e.inputs), e.compute(im(e.inputs, t, e.outputCount));
        });
    });
  var om,
    am,
    ...
    kl = j(() => {
      ...
      (om = (e, t) => {
        ...
        let i = Math.floor((t.k + t.blockSize - 1) / t.blockSize),
          s = (t.blockSize / 8) * t.bits,
          a = e[1];
        if (!M.areEqual(a.dims, [t.n, i, s]))
          throw new Error(
            "The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize"
          );
        let c = e[2].dims;
        if (M.size(c) !== t.n * i) throw new Error("scales input size error.");
        if (e.length === 4) {
          let u = e[3].dims,
            g = t.bits > 4 ? t.n * i : t.n * Math.floor((i + 1) / 2);
          if (M.size(u) !== g) throw new Error("zeroPoints input size error.");
        }
      }),
        (am = (e, t, r, n) => {
          let i = e[0].dims,
            s = i.length,
            a = Math.floor((t.k + t.blockSize - 1) / t.blockSize),
            d = i[s - 2],
            c = t.k,
            m = t.n,
            u = i.slice(0, s - 2),
            g = M.size(u),
            $ = ((t.blockSize / 8) * t.bits) / 4,
            w = e[0].dataType,
            x = Ue(d),
            C = Ue(t.k),
            T = Ue($),
            ...
            Q = [g, d, c / C],
            he = M.convertShape(e[1].dims).slice();
          he.splice(-1, 1, $ / T),
            Y.push(...X(Q)),
            Y.push(...X(he)),
            Y.push(...X(e[2].dims)),
            e.length === 4 && Y.push(...X(M.convertShape(e[3].dims)));
          let N = [g, d, m / R];
          Y.push(...X(N));
          let se = (Ce) => {
            let Ve = Q.length,
              ee = U("a", e[0].dataType, Ve, C),
              ae = U("b", 12, he.length, T),
              Ie = U("scales", e[2].dataType, e[2].dims.length),
              me = [ee, ae, Ie],
              oe =
                e.length === 4
                  ? U("zero_points", 12, e[3].dims.length)
                  : void 0;
            oe && me.push(oe);
            let ue = N.length,
              de = K("output", e[0].dataType, ue, R),
              je = [
                { name: "output_size", type: "u32" },
          ...
          return {
            name: P ? "BlockwiseMatMulNBits" : "MatMulNBits",
            shaderCache: {
              hint: `${t.cacheKey};${d};${w};${e.length}`,
              inputDependencies: Array(e.length).fill("rank")
            },
            getRunData: () => ({
              outputs: [{ dims: L, dataType: w }],
              name: P ? "BlockwiseMatMulNBits" : "MatMulNBits",
              dispatchGroup: P
                ? { x: 1, y: Math.ceil(m / R), z: g }
                : { x: Math.ceil(V / 64) },
              programUniforms: Y
            }),
            getShaderSource: se
        ...
        (Al = (e, t) => {
          om(e.inputs, t);
          let r = e.getMaxComputeWorkgroupSizes(),
            n = e.getMaxComputeWorkgroupStoragesize();
          e.compute(am(e.inputs, t, r, n));
        }),
        (El = (e) => we(e));
    });
  var dt,
    ...
    zl = j(() => {
      ...
      Rr();
      (dt = (e, t) =>
        e.length > t && e[t].dims.length > 0 && M.size(e[t].dims) > 0
          ? e[t]
          : void 0),
        (sm = (e, t) => {
          let r = e[0],
          ...
          if (n) {
            ...
            if (n.dims.length === 3) {
              ...
              if (n.dims[1] !== t.numHeads || n.dims[3] !== T)
                throw new Error(
          ...
          if (s) {
            ...
            if (i && r.dims.length === 5 && r.dims[3] === 2)
          ...
          if (d) {
            if (d.dims.length !== 4)
              throw new Error(
                'Input "relative_position_bias" is expected to have 4 dimensions'
              );
            if (
              (d.dims[0] !== g && d.dims[0] !== 1) ||
              d.dims[1] !== t.numHeads ||
              d.dims[2] !== b ||
              d.dims[3] !== R
            )
              throw new Error(
                'Input "relative_position_bias" shape (batch_size, 1, sequence_length, kv_sequence_length)'
              );
          }
          return {
            batchSize: g,
            ...
            pastSequenceLength: x,
            kvSequenceLength: w,
            totalSequenceLength: R,
            maxSequenceLength: C,
            inputHiddenSize: 0,
            hiddenSize: $,
            vHiddenSize: P,
            headSize: T,
            vHeadSize: Math.floor(P / t.numHeads),
            numHeads: t.numHeads,
            isUnidirectional: !1,
            pastPresentShareBuffer: !1,
            maskFilterValue: t.maskFilterValue,
        ...
        (um = (e, t, r, n, i, s, a) => {
          let d = [n, i, s],
            ...
            u = (g) => {
              let b = K("qkv_with_bias", t.dataType, d),
                $ = U("qkv", t.dataType, d),
                w = U("bias", r.dataType, d),
                x = [
                  { name: "output_size", type: "u32" },
      ...
      qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
          ...
          return e.compute(
            {
              ...
              shaderCache: { inputDependencies: ["type", "type"] },
              getRunData: () => ({
                outputs: [{ dims: d, dataType: t.dataType, gpuDataType: 0 }],
                dispatchGroup: { x: Math.ceil(c / 64) },
                programUniforms: m
              }),
              getShaderSource: u
        ...
        ($o = (e, t, r, n, i, s, a, d) => {
          ...
          if (a) {
            ...
            return (
              (c = um(e, s, a, t, n, r * i, d)),
              (c = c.reshape([t, n, r, i])),
              e.compute(xt(c, Ol.perm), { inputs: [c], outputs: [-1] })[0]
            );
          } else
            return (
              s.dims.length === 3 && (c = s.reshape([t, n, r, i])),
              e.compute(xt(c, Ol.perm), { inputs: [c], outputs: [-1] })[0]
            );
        }),
        (Rl = (e, t) => {
          ...
          let g = i && s && i.dims.length === 4 && s.dims.length === 4,
            b = $o(
              e,
              r.batchSize,
              r.numHeads,
          ...
          if (g) return Xn(e, b, i, s, d, void 0, m, u, c, r, t);
          if (!i || !s) throw new Error("key and value must be provided");
          let $ = $o(
              e,
              r.batchSize,
              r.numHeads,
    ...
    Dl = j(() => {
      ...
      (lm = (e) => {
        ...
        (fm = (e, t, r) => {
          switch (r.mode) {
            case 0:
              return dm(e, t, r.pads.length);
            case 1:
              return cm(e, t, r.pads.length);
            case 2:
              return pm(e, t, r.pads.length);
            case 3:
              return mm(e, t, r.pads.length);
            default:
              throw new Error("Invalid mode");
          }
        }),
        (hm = (e, t) => {
          let r = M.padShape(e[0].dims.slice(), t.pads),
            n = e[0].dims,
            i = M.size(r),
            s = [
              { type: 12, data: i },
          ...
          t.mode === 0 && s.push({ type: e[0].dataType, data: t.value }),
            s.push(...X(e[0].dims, r));
          let a = ["rank"],
            d = (c) => {
              let m = K("output", e[0].dataType, r.length),
                u = U("x", e[0].dataType, n.length),
                g = u.type.value,
                b = fm(m, n.length, t),
                $ = [
                  { name: "output_size", type: "u32" },
              ...
              return (
                t.mode === 0 && $.push({ name: "constant_value", type: g }),
                `
          ...
          return {
            name: "Pad",
            shaderCache: { hint: `${t.mode}`, inputDependencies: a },
            getRunData: () => ({
              outputs: [{ dims: r, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(M.size(r) / 64) },
              programUniforms: s
            }),
            getShaderSource: d
          };
        ...
        (gm = (e, t) => {
          if (e.length > 1) {
            let r = e[1].getBigInt64Array(),
              n = e.length >= 3 && e[2].data ? e[2].getFloat32Array()[0] : 0,
              i = e[0].dims.length,
              s = new Int32Array(2 * i).fill(0);
            if (e.length >= 4) {
              let d = e[3].getBigInt64Array();
              for (let c = 0; c < d.length; c++)
                (s[Number(d[c])] = Number(r[c])),
                  (s[Number(d[c]) + i] = Number(r[c + d.length]));
            } else r.forEach((d, c) => (s[Number(c)] = Number(d)));
            let a = [];
            return (
              s.forEach((d) => a.push(d)), { mode: t.mode, value: n, pads: a }
            );
          } else return t;
        }),
        (Bl = (e, t) => {
          lm(e.inputs);
          let r = gm(e.inputs, t);
          e.compute(hm(e.inputs, r), { inputs: [0] });
        });
    });
  var si,
    Ml,
    ...
    Jl = j(() => {
      ...
      _e();
      (si = (e) => {
        if (ke.webgpu.validateInputContent && (!e || e.length !== 1))
        ...
        (Ml = (e, t, r) => {
          ...
          let s = Object.hasOwnProperty.call(t, "dilations"),
            a = t.kernelShape.slice(),
            d = t.strides.slice(),
            c = s ? t.dilations.slice() : [],
            m = t.pads.slice();
          mr.adjustPoolAttributes(r, i, a, d, c, m);
          let u = mr.computePoolOutputShape(r, i, d, c, a, m, t.autoPad),
            g = Object.assign({}, t);
          s
            ? Object.assign(g, {
                kernelShape: a,
          ...
          let b = u.slice();
          return b.push(b.splice(1, 1)[0]), [g, n ? b : u];
        }),
        (Ul = (e, t) => {
          let r = t.format === "NHWC",
            n = M.size(e),
            i = M.size(t.kernelShape),
            s = [
              { type: 12, data: n },
              { type: 12, data: i }
            ],
          ...
          if (t.kernelShape.length <= 2) {
            let d = t.kernelShape[t.kernelShape.length - 1],
              c = t.strides[t.strides.length - 1],
              m = t.pads[t.pads.length / 2 - 1],
            ...
            let b = !1;
            if (t.kernelShape.length === 2) {
              let $ = t.kernelShape[t.kernelShape.length - 2],
                w = t.strides[t.strides.length - 2],
                x = t.pads[t.pads.length / 2 - 2],
                C = t.pads[t.pads.length - 2];
              (b = !!(x + C)),
                s.push(
                  { type: 12, data: $ },
                  { type: 12, data: w },
            ...
            let d = M.computeStrides(t.kernelShape);
            s.push(
              { type: 12, data: d },
              { type: 12, data: t.pads },
              ...
              a.push(
                { name: "kernelStrides", type: "u32", length: d.length },
                { name: "pads", type: "u32", length: t.pads.length },
                { name: "strides", type: "u32", length: t.strides.length }
              );
            let c = t.pads.reduce((m, u) => m + u);
            return [s, a, !!c, !1, !1];
          }
        }),
        (Wl = (e, t, r, n, i, s, a, d, c, m, u, g) => {
          let b = i.format === "NHWC",
            $ = t.type.value,
            w = K("output", t.type.tensor, n);
        ...
        (ym = (e) => `${Nl(e)};${e.countIncludePad}`),
        (bm = (e) => `${Nl(e)};${e.storageOrder};${e.dilations}`),
        (Vl = (e) => ({
          format: e.format,
        ...
        (Hl = (e, t, r, n) => {
          let [i, s] = Ml(t, n, r),
            a = U("x", t.dataType, t.dims.length),
            d = a.type.value,
            c = "value += x_val;",
            m = "";
          i.countIncludePad
            ? (m += `value /= ${d}(uniforms.kernelSize);`)
            : (m += `value /= ${d}(i32(uniforms.kernelSize) - pad);`);
          let [u, g, b, $, w] = Ul(s, i);
          u.push(...X(t.dims, s));
          let x = ["rank"];
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: s, dataType: t.dataType }],
              dispatchGroup: { x: Math.ceil(M.size(s) / 64) },
              programUniforms: u
            }),
            getShaderSource: (C) =>
              Wl(C, a, t.dims.length, s.length, i, c, m, 0, g, b, $, w)
          };
        }),
        (Gl = (e) => {
          ...
          return { ...n, cacheKey: ym(n) };
        }),
        (Ll = (e, t) => {
          si(e.inputs), e.compute(Hl("AveragePool", e.inputs[0], !1, t));
        }),
        (Fl = {
          autoPad: "",
          ceilMode: 0,
        ...
        (ql = (e) => {
          let t = e.format;
          return { format: t, ...Fl, cacheKey: t };
        }),
        (jl = (e, t) => {
          si(e.inputs), e.compute(Hl("GlobalAveragePool", e.inputs[0], !0, t));
        }),
        (Kl = (e, t, r, n) => {
          let [i, s] = Ml(t, n, r),
            a = `
      ...
      `,
            d = "",
            c = U("x", t.dataType, t.dims.length),
            m = ["rank"],
            [u, g, b, $, w] = Ul(s, i);
          return (
            u.push(...X(t.dims, s)),
        ...
        (Yl = (e, t) => {
          si(e.inputs), e.compute(Kl("MaxPool", e.inputs[0], !1, t));
        }),
        (Xl = (e) => {
        ...
        (Ql = (e, t) => {
          si(e.inputs), e.compute(Kl("GlobalMaxPool", e.inputs[0], !0, t));
        });
    });
  var wm,
    $m,
        ...
        (ed = (e) => {
          ...
          e.inputs[0].dataType === 6
            ? ((t = e.inputs[0].getInt32Array()[0]),
              ...
              (n = e.inputs[2].getInt32Array()[0]))
            : e.inputs[0].dataType === 1 &&
              ((t = e.inputs[0].getFloat32Array()[0]),
              (r = e.inputs[1].getFloat32Array()[0]),
              (n = e.inputs[2].getFloat32Array()[0])),
            ke.webgpu.validateInputContent && wm(t, r, n),
            e.compute($m(t, r, n, e.inputs[0].dataType), { inputs: [] });
        });
    });
  var _m,
    xm,
    ...
    od = j(() => {
      ...
      (_m = (e, t) => {
        ...
        (xm = (e, t, r) => {
          ...
          return t.forEach((i, s) => (n[i] = e[s])), n;
        }),
        (Sm = (e, t, r, n, i, s) => {
          let [a, d, c] = r > 10 ? [1, 2, 3] : [-1, e.length > 1 ? 1 : -1, -1],
            m = e[0].dims.length;
          if (a > 0 && e.length > a && e[a].dims.length > 0)
            e[a].getFloat32Array().forEach((u) => s.push(u));
          ...
          if (d > 0 && e.length > d && e[d].dims.length > 0) {
            if (
              (e[d].getFloat32Array().forEach((u) => n.push(u)),
              n.length !== 0 &&
                n.length !== m &&
                r >= 18 &&
                n.length !== t.axes.length)
            )
              throw new Error(
            ...
            _m(n, t),
              t.axes.length > 0 &&
                xm(n, t.axes, m).forEach((u, g) => (n[g] = u));
          }
          if (
            c > 0 &&
            e.length > c &&
            (e[c].getBigInt64Array().forEach((u) => i.push(Number(u))),
            i.length !== m || (r >= 18 && i.length === t.axes.length))
          )
            throw new Error(
       ...
       lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` +
        ...
        (Im = (e, t, r) =>
          ...
          "}"),
        (Tm = (e, t, r) => {
          let n = new Array(r).fill(0).concat(new Array(r).fill(1)),
            i = e.length === 0 ? n : e.slice();
          return t.length > 0
            ? (t.forEach((s, a) => {
                (n[s] = i[a]), (n[a + r] = i[t.length + a]);
              }),
              n)
            : i;
        }),
        (Am = (e, t, r, n) => {
          ...
          if (r.length > 0)
            if (n.length > 0) {
              if ((e.forEach((s) => i.push(s)), Math.max(...n) > e.length))
                throw new Error("axes is out of bound");
              n.forEach((s, a) => (i[s] = r[a]));
            } else r.forEach((s) => i.push(s));
          else {
            if (t.length === 0)
              throw new Error("Resize requires either scales or sizes.");
            i = e.map((s, a) => Math.round(s * t[a]));
          }
          return i;
        }),
        (Em = (e, t, r) => {
            ...
            switch (r.keepAspectRatioPolicy) {
              case "not_larger":
                return r.axes.length > 0
                  ? Math.min(...r.axes.map((s) => t[s]), Number.MAX_VALUE)
                  : Math.min(...t, Number.MAX_VALUE);
              case "not_smaller":
                return r.axes.length > 0
                  ? Math.max(...r.axes.map((s) => t[s]), Number.MIN_VALUE)
          ...
          return (
            r.axes.length > 0
              ? (r.axes.forEach((s) => (t[s] = n)),
                r.axes.forEach((s) => (i[s] = Math.round(e[s] * t[s]))))
              : (t.fill(n, 0, t.length),
                i.forEach((s, a) => (i[a] = Math.round(s * t[a])))),
            i
          );
        }),
        (km = (e, t, r, n, i) => `
  ...
  `
            : ""),
        (Rm = (e, t, r, n, i) => {
          let [a, d, c, m] = r.length === 2 ? [-1, 0, 1, -1] : [0, 2, 3, 1],
            u = e.type.value;
          return `
      ...
      fn bilinearInterpolation(output_indices: ${t.type.indices}) -> ${u} {
        ...
        ${
          n
            ? `if (row < 0 || row > (${r[d]} - 1) || col < 0 || col > (${r[c]} - 1)) {
          return ${i};
        }`
            : ""
        };
    ...
    fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${w} {
      ...
      fn trilinearInterpolation(output_indices: ${t.type.indices}) -> ${g} {
        ...
        ${
          n
            ? `if (depth < 0 || depth > (${r[d]} - 1) || height < 0 || height > (${r[c]} - 1) || width < 0 || (width > ${r[m]} - 1)) {
        return ${i};
          }`
            : ""
        };
      ...
      depth = max(0, min(depth, ${r[d]} - 1));
        ...
        (Dm = (e, t, r, n, i, s) => {
          let a = e.dims,
            d = Tm(s, t.axes, a.length),
            c = Am(a, n, i, t.axes),
            m = n.slice();
          n.length === 0 &&
            ((m = a.map((S, E) => (S === 0 ? 1 : c[E] / S))),
            t.keepAspectRatioPolicy !== "stretch" && (c = Em(a, m, t)));
          let u = K("output", e.dataType, c.length),
            g = U("input", e.dataType, a.length),
            b = M.size(c),
            $ = a.length === c.length && a.every((S, E) => S === c[E]),
            w = t.coordinateTransformMode === "tf_crop_and_resize",
            x = t.extrapolationValue,
            C = g.type.value,
            T = (S) => `
        ${
          $
        ...
        ${(() => {
          switch (t.mode) {
            ...
            case "cubic":
              ...
              ${(() => {
                if (a.length === 2 || a.length === 4)
                  return `${zm(g, u, a, c, m, d, t.cubicCoeffA, w, t.extrapolationValue, t.excludeOutside)}`;
                throw Error(
  ...
  `
          ...
          return {
            name: "Resize",
            shaderCache: {
              hint: `${t.cacheKey}|${r}|${m.length > 0 ? m : ""}|${i.length > 0 ? i : ""}|${d.length > 0 ? d : ""}|${$}|${a}`,
              inputDependencies: ["rank"]
            },
            getShaderSource: T,
            getRunData: () => ({
              outputs: [{ dims: c, dataType: e.dataType }],
        ...
        (nd = (e, t) => {
          ...
          Sm(e.inputs, t, s, r, n, i),
            e.compute(Dm(e.inputs[0], t, s, r, n, i), { inputs: [0] });
        }),
        (id = (e) => {
          let t = e.antialias,
            r = e.axes,
            n = e.coordinateTransformMode,
            i = e.cubicCoeffA,
            s = e.excludeOutside !== 0,
            a = e.extrapolationValue,
            d = e.keepAspectRatioPolicy,
            c = e.mode,
            m = e.nearestMode === "" ? "simple" : e.nearestMode;
          return we({
            antialias: t,
            axes: r,
  ...
  var Um,
    ...
    sd = j(() => {
      ...
      (Um = (e, t) => {
        let [r, n, i, s] = e,
          { numHeads: a, rotaryEmbeddingDim: d } = t;
        ...
        if (
          ...
          throw new Error(
            `Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${n.dims.length}`
          );
        if (i.dims.length !== 2)
          throw new Error(
        ...
        if (s.dims.length !== 2)
          throw new Error(
            `Input 'sin_cache' is expected to have 2 dimensions, got ${s.dims.length}`
          );
        if (!M.areEqual(i.dims, s.dims))
          throw new Error(
        ...
        let c = r.dims[0],
          m = r.dims[r.dims.length - 2],
          u = i.dims[0],
          g = M.sizeFromDimension(r.dims, 1) / m,
          b = d === 0 ? i.dims[1] * 2 : g / a;
        if (d > b)
          throw new Error(
        ...
        if (n.dims.length === 2) {
          if (c !== n.dims[0])
            throw new Error(
              `Input 'position_ids' dimension 0 should be of size batch_size, got ${n.dims[0]}`
            );
          if (m !== n.dims[1])
            throw new Error(
              `Input 'position_ids' dimension 1 should be of size sequence_length, got ${n.dims[1]}`
            );
        }
        if (b / 2 !== i.dims[1] && d / 2 !== i.dims[1])
          throw new Error(
        ...
        (Wm = (e, t) => {
          let {
            ...
            a = e[0].dims[0],
            d = M.sizeFromDimension(e[0].dims, 1),
            c = e[0].dims[e[0].dims.length - 2],
            m = d / c,
            u = e[2].dims[1],
            g = i === 0 ? u * 2 : m / n,
            b = new Array(a, c, m / g, g - u),
            $ = M.computeStrides(b),
            w = [
              { type: 1, data: s },
              { type: 12, data: b },
              { type: 12, data: $ },
              ...(e[0].dims.length === 3
                ? new Array({ type: 12, data: [d, m, g, 1] })
                : []),
              ...(e[0].dims.length === 4
                ? new Array({ type: 12, data: [d, g, c * g, 1] })
                : []),
              ...X(e[0].dims, e[1].dims, e[2].dims, e[3].dims, e[0].dims)
            ],
            x = (C) => {
              let T = U("input", e[0].dataType, e[0].dims.length),
                S = U("position_ids", e[1].dataType, e[1].dims.length),
                E = U("cos_cache", e[2].dataType, e[2].dims.length),
                k = U("sin_cache", e[3].dataType, e[3].dims.length),
                P = K("output", e[0].dataType, e[0].dims.length);
              return (
                C.registerUniforms([
                  { name: "scale", type: "f32" },
                  { name: "global_shape", type: "u32", length: b.length },
                  { name: "global_strides", type: "u32", length: $.length },
                  {
          ...
          return {
            ...
            shaderCache: {
              hint: we({ interleaved: r }).cacheKey,
              inputDependencies: ["rank", "rank", "rank", "rank"]
            },
            getShaderSource: x,
            getRunData: () => ({
              outputs: [{ dims: e[0].dims, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(M.size(b) / fr) },
              programUniforms: w
            })
          };
        }),
        (ad = (e, t) => {
          Um(e.inputs, t), e.compute(Wm(e.inputs, t));
        });
    });
  var Nm,
    Vm,
    ...
    ld = j(() => {
      ...
      (Nm = (e) => {
        ...
        let t = e[0],
          r = e[1],
          n = e[2];
        if (t.dataType !== r.dataType || t.dataType !== n.dataType)
          ...
          let i = t.simplified,
            ...
            S = (k) => {
              let P = [
                ...
                R = [
                  U("x", e[0].dataType, e[0].dims, C),
                  U("skip", e[1].dataType, e[1].dims, C),
                  U("gamma", e[2].dataType, e[2].dims, C)
                ];
              g && R.push(U("beta", e[3].dataType, e[3].dims, C)),
                b && R.push(U("bias", e[4].dataType, e[4].dims, C)),
                R.push(K("output", e[0].dataType, d, C)),
                $ && R.push(K("mean_output", 1, u)),
                w && R.push(K("inv_std_output", 1, u)),
                x && R.push(K("input_skip_bias_sum", e[0].dataType, d, C));
              let L = De(e[0].dataType);
              return `
        ...
        ${k.mainStart()}
          ...
          for (var i: u32 = 0; i < hidden_size_vectorized; i++) {
            ...
            E = [{ dims: d, dataType: e[0].dataType }];
          return (
            r > 1 && E.push({ dims: u, dataType: 1 }),
            r > 2 && E.push({ dims: u, dataType: 1 }),
            r > 3 && E.push({ dims: s, dataType: e[0].dataType }),
            {
              name: "SkipLayerNormalization",
              shaderCache: {
                hint: `${C};${$};${w};${x}`,
                inputDependencies: e.map((k, P) => "type")
              },
              getShaderSource: S,
              getRunData: () => ({
                outputs: E,
                dispatchGroup: { x: Math.ceil(c / m / 64) },
                programUniforms: T
              })
            }
          );
        ...
        (ud = (e, t) => {
          Nm(e.inputs);
          let n = [0];
          e.outputCount > 1 && n.push(-3),
            e.outputCount > 2 && n.push(-3),
            e.outputCount > 3 && n.push(3),
            e.compute(Vm(e.inputs, t, e.outputCount, !1), { outputs: n });
        });
    });
  var Hm,
    ui,
    ...
    md = j(() => {
      ...
      (Hm = (e, t) => {
        ...
        e.slice(1).forEach((r, n) => {
          if (e[n + 1].dataType !== 6 && e[n + 1].dataType !== 7)
        ...
        (ui = (e, t) => {
          ...
          if (e.length > t)
            if (e[t].dataType === 7)
              e[t].getBigInt64Array().forEach((n) => r.push(Number(n)));
            else if (e[t].dataType === 6)
              e[t].getInt32Array().forEach((n) => r.push(Number(n)));
            else
        ...
        (dd = (e, t, r, n, i) => {
          ...
          return (
            e < 0 && (s += r[n[t]]),
            i[t] < 0
              ? Math.max(0, Math.min(s, r[n[t]] - 1))
              : Math.max(0, Math.min(s, r[n[t]]))
          );
        }),
        (Lm = (
          e,
        ...
        (Fm = (e, t) => {
          let r = e[0].dims,
            ...
            i =
              t.axes.length > 0
                ? M.normalizeAxes(t.axes, r.length)
                : [...Array(r.length).keys()],
            s = ui(e, 4);
          s.forEach(
            (T) =>
            ...
            s.length === 0 && (s = Array(i.length).fill(1));
          let a = t.starts.map((T, S) => dd(T, S, r, i, s)),
            d = t.ends.map((T, S) => dd(T, S, r, i, s));
          if (i.length !== a.length || i.length !== d.length)
            throw new Error(
          ...
          if (i.length !== r.length)
            for (let T = 0; T < r.length; ++T)
              i.includes(T) ||
                (a.splice(T, 0, 0), d.splice(T, 0, r[T]), s.splice(T, 0, 1));
          let c = s.map((T) => Math.sign(T));
          s.forEach((T, S, E) => {
            if (T < 0) {
              let k = (d[S] - a[S]) / T,
                P = a[S],
          ...
          let m = r.slice(0);
          i.forEach((T, S) => {
            m[T] = Math.ceil((d[T] - a[T]) / s[T]);
          });
          let u = { dims: m, dataType: e[0].dataType },
            g = K("output", e[0].dataType, m.length),
            b = U("input", e[0].dataType, e[0].dims.length),
            $ = M.size(m),
            w = [
              { name: "outputSize", type: "u32" },
              { name: "starts", type: "u32", length: a.length },
              { name: "signs", type: "i32", length: c.length },
              { name: "steps", type: "u32", length: s.length }
            ],
            x = [
              { type: 12, data: $ },
              { type: 12, data: a },
        ...
        ${T.registerUniforms(w).declareVariables(b, g)}
          ...
          return {
            name: "Slice",
            shaderCache: {
              hint: `${c.length}_${a.length}_${s.length}`,
              inputDependencies: ["rank"]
            },
            getShaderSource: C,
            getRunData: () => ({
        ...
        (cd = (e, t) => {
          Hm(e.inputs, t);
          let r = Gm(e.inputs, t);
          e.compute(Fm(e.inputs, r), { inputs: [0] });
        }),
        (pd = (e) => {
          let t = e.starts,
            r = e.ends,
            n = e.axes;
          return we({ starts: t, ends: r, axes: n });
        });
    });
  var qm,
    jm,
      ...
      (qm = (e) => {
        ...
        (jm = (e, t) => {
          let r = e.dims,
            ...
            i = 64,
            s = t.axis;
          if ((s < 0 && (s = r.length + s), s < r.length - 1))
          ...
          let a = r[s],
            ...
            u = (C, T) =>
              T === 4
                ? `max(max(${C}.x, ${C}.y), max(${C}.z, ${C}.w))`
                : T === 2
                  ? `max(${C}.x, ${C}.y)`
                  : T === 3
                    ? `max(max(${C}.x, ${C}.y), ${C}.z)`
                    : C,
            g = U("x", e.dataType, e.dims, c),
            b = K("result", e.dataType, e.dims, c),
            $ = g.type.value,
            w =
              De(e.dataType) === "f32"
                ? `var threadMax = ${$}(-3.402823e+38f);`
                : `var threadMax = ${$}(-65504.0h);`,
            x = (C) => `
        ...
        ${C.mainStart()}
          ...
          return {
            name: "Softmax",
            shaderCache: { hint: `${c}`, inputDependencies: ["type"] },
            getRunData: () => ({
              outputs: [{ dims: r, dataType: e.dataType }],
              dispatchGroup: { x: d },
              programUniforms: [{ type: 6, data: m }]
            }),
            getShaderSource: x
          };
        }),
        (fd = (e, t) => {
          qm(e.inputs), e.compute(jm(e.inputs[0], t));
        }),
        (hd = (e) => we({ axis: e.axis }));
    });
  var Km,
        ...
        (Ym = (e, t) => {
          ...
          return (
            e[1].dims[0] > 0 &&
              ...
              (n = r.length)),
            we({ numOutputs: n, axis: t.axis, splitSizes: r })
          );
        }),
        (Xm = (e) => `
        ...
        (Zm = (e) => {
          ...
          for (let n = 0; n < t; ++n) {
            ...
            t === 1
              ? r.push(i)
              : n === 0
                ? r.push(`if (output_number == ${n}u) { ${i} }`)
                : n === t - 1
                  ? r.push(`else { ${i} }`)
                  : r.push(`else if (output_number == ${n}) { ${i} }`);
          }
          return `
  ...
  `)}
        ...
        (Qm = (e, t) => {
          let r = e[0].dims,
            n = M.size(r),
            i = e[0].dataType,
            s = M.normalizeAxis(t.axis, r.length),
            a = new Array(t.numOutputs),
            d = U("input", i, r.length),
            c = new Array(t.numOutputs),
            m = [],
            u = [],
            g = 0,
            b = [{ type: 12, data: n }];
          for (let w = 0; w < t.numOutputs; w++) {
            (g += t.splitSizes[w]), (c[w] = g);
            let x = r.slice();
            (x[t.axis] = t.splitSizes[w]),
              u.push(x),
              (a[w] = K(`output${w}`, i, x.length)),
              m.push({ dims: u[w], dataType: e[0].dataType });
          }
          b.push({ type: 12, data: c }, ...X(r, ...u));
          let $ = (w) => `
    ${w
      .registerUniform("input_size", "u32")
      .registerUniform("size_in_split_axis", "u32", c.length)
      .declareVariables(d, ...a)}
    ${Xm(c.length)}
    ${Zm(a)}
    ...
    ${w.mainStart()}
      ...
      writeBufferData(output_number, indices, global_idx);
        ...
        (yd = (e, t) => {
          Km(e.inputs);
          let r = e.inputs.length === 1 ? t : Ym(e.inputs, t);
          e.compute(Qm(e.inputs, r), { inputs: [0] });
        }),
        (bd = (e) => {
          let t = e.axis,
            r = e.splitSizes,
            n = e.numOutputs < 0 ? r.length : e.numOutputs;
          if (n !== r.length)
            throw new Error("numOutputs and splitSizes lengh must be equal");
          return we({ axis: t, numOutputs: n, splitSizes: r });
        });
    });
  var wd,
    Jm,
    ...
    _d = j(() => {
      ...
      xe();
      _e();
      (wd = (e) => Array.from(e.getBigInt64Array(), Number)),
        (Jm = (e) => {
          ...
          if (
            ...
            throw new Error(
              "Tile only support float, int32, and uint32 data types"
            );
          if (e[1].dataType !== 7)
            throw new Error(
          ...
          if (wd(e[1]).length !== e[0].dims.length)
            throw new Error(
        ...
        (tf = (e) => {
          let t = e[0].dims,
            ...
            i = M.size(n),
            s = e[0].dataType,
            a = U("input", s, t.length),
            d = K("output", s, n.length),
            c = (m) => `
        ...
        ${d.setByOffset("global_idx", a.getByIndices("input_indices"))}
          ...
          return {
            ...
            getRunData: () => ({
              outputs: [{ dims: n, dataType: e[0].dataType }],
              dispatchGroup: { x: Math.ceil(i / 64) },
              programUniforms: [{ type: 12, data: i }, ...X(e[0].dims, n)]
            }),
            getShaderSource: c
          };
        }),
        ($d = (e) => {
          Jm(e.inputs), e.compute(tf(e.inputs), { inputs: [0] });
        });
    });
  var rf,
    nf,
    ...
    Sd = j(() => {
      ...
      _e();
      (rf = (e, t, r, n, i) => {
        let s = K("output_data", i, r.length, 4),
          a = U("a_data", t[1].dataType, t[1].dims.length, 4),
          d = U("b_data", t[2].dataType, t[2].dims.length, 4),
          c = U("c_data", t[0].dataType, t[0].dims.length, 4),
          m,
          u = (g, b, $) => `select(${b}, ${g}, ${$})`;
        if (!n)
          m = s.setByOffset(
            ...
            u(
              ...
              d.getByOffset("global_idx"),
              c.getByOffset("global_idx")
            )
          );
        else {
          let g = (b, $, w = "") => {
            let x = `a_data[index_a${$}][component_a${$}]`,
              C = `b_data[index_b${$}][component_b${$}]`,
              T = `bool(c_data[index_c${$}] & (0xffu << (component_c${$} * 8)))`;
            return `
        ...
        (nf = (e) => {
          let t = e[1].dims,
            ...
            n = e[0].dims,
            i = e[1].dataType,
            s = !(M.areEqual(t, r) && M.areEqual(r, n)),
            a = t,
            d = M.size(t);
          if (s) {
            let m = zt.calcShape(zt.calcShape(t, r, !1), n, !1);
            if (!m)
          ...
          return {
            ...
            getShaderSource: (m) => rf(m, e, a, s, i),
            getRunData: () => ({
              outputs: [{ dims: a, dataType: i }],
              dispatchGroup: { x: Math.ceil(d / 64 / 4) },
              programUniforms: [{ type: 12, data: c }, ...X(n, t, r, a)]
            })
          };
        }),
        (xd = (e) => {
          e.compute(nf(e.inputs));
        });
    });
  var Cd,
    Id = j(() => {
      ...
      Cd = new Map([
        ...
        ["FusedConv", [go, ho]],
        ["Gather", [gl, hl]],
        ["GatherElements", [vl, bl]],
        ["Gelu", [su]],
        ["Gemm", [_l, $l]],
        ["GlobalAveragePool", [jl, ql]],
        ["GlobalMaxPool", [Ql, Zl]],
        ["Greater", [zu]],
        ["GreaterOrEqual", [Du]],
        ["HardSigmoid", [hu, fu]],
        ["InstanceNormalization", [Sl]],
        ["LayerNormalization", [Il]],
        ["LeakyRelu", [uu, Zn]],
        ["Less", [Bu]],
        ["LessOrEqual", [Mu]],
        ["Log", [Su]],
  ...
  var li,
    Td = j(() => {
      ...
      li = class {
        ...
        run(t, r, n, i, s) {
          lt(t.programInfo.name);
          let a = this.backend.device,
            d = this.backend.getComputePassEncoder();
          this.backend.writeTimestamp(this.backend.pendingDispatchNumber * 2);
          let c = [];
          for (let u of r)
            c.push({ binding: c.length, resource: { buffer: u.buffer } });
          for (let u of n)
            c.push({ binding: c.length, resource: { buffer: u.buffer } });
          s && c.push({ binding: c.length, resource: s });
          let m = a.createBindGroup({
          ...
          d.setPipeline(t.computePipeline),
            d.setBindGroup(0, m),
            d.dispatchWorkgroups(...i),
        ...
        build(t, r) {
          ...
          let n = this.backend.device,
            i = [];
          n.features.has("shader-f16") && i.push("enable f16;");
          let s = us(r, this.backend.device.limits),
            a = t.getShaderSource(s),
            d = `${i.join(`
  `)}
  ${s.additionalImplementations}
  ${a}`,
            c = n.createShaderModule({ code: d, label: t.name });
          Ne("verbose", () => `[WebGPU] ${t.name} shader code: ${d}`);
        ...
        normalizeDispatchGroupSize(t) {
          let r = typeof t == "number" ? t : t.x,
            n = typeof t == "number" ? 1 : t.y || 1,
            i = typeof t == "number" ? 1 : t.z || 1,
            s = this.backend.device.limits.maxComputeWorkgroupsPerDimension;
          if (r <= s && n <= s && i <= s) return [r, n, i];
          let a = r * n * i,
            d = Math.ceil(Math.sqrt(a));
          if (d > s) {
            if (((d = Math.ceil(Math.cbrt(a))), d > s))
    ...
    Ad = j(() => {
      ...
      (of = (e, t) => {
        ...
        (af = (e, t, r) => {
          let n = e.name;
          return (
            e.shaderCache?.hint && (n += "[" + e.shaderCache.hint + "]"),
            (n +=
              ":" +
              r +
              `:${of(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill("dims"))}`),
            n
          );
        }),
        (_o = class {
          constructor(t) {
            t &&
              ((this.architecture = t.architecture), (this.vendor = t.vendor));
          }
          isArchitecture(t) {
        ...
        (di = class {
          ...
          get currentKernelCustomData() {
            ...
            return (
              t ||
                ((t = {}), this.kernelCustomData.set(this.currentKernelId, t)),
              t
            );
          }
          async initialize(t, r) {
              ...
              i = {
                requiredLimits: {
                  ...
                  maxComputeWorkgroupsPerDimension:
                    r.limits.maxComputeWorkgroupsPerDimension,
                  maxStorageBufferBindingSize:
                    r.limits.maxStorageBufferBindingSize,
            ...
            r.features.has(
              ...
              ? n.push("chromium-experimental-timestamp-query-inside-passes")
              : r.features.has("timestamp-query") && n.push("timestamp-query"),
              r.features.has("shader-f16") && n.push("shader-f16"),
              (this.device = await r.requestDevice(i)),
              (this.adapterInfo = new _o(await r.requestAdapterInfo())),
              (this.gpuDataManager = as(this)),
              (this.programManager = new li(this)),
              (this.kernels = new Map()),
              (this.kernelPersistentData = new Map()),
              (this.kernelCustomData = new Map()),
              es(t.logLevel, !!t.debug),
              (this.device.onuncapturederror = (s) => {
                s.error instanceof GPUValidationError &&
                  console.error(
          ...
          flush() {
            ...
            this.queryType !== "none" &&
              ...
              (t = this.device.createBuffer({
                size: this.pendingDispatchNumber * 2 * 8,
                usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST
              })),
              this.pendingQueries.set(t, this.pendingKernels),
              (this.pendingKernels = []),
              ...
              this.queryType !== "none" &&
                t.mapAsync(GPUMapMode.READ).then(() => {
                  let r = new BigUint64Array(t.getMappedRange()),
                    n = this.pendingQueries.get(t);
                  for (let i = 0; i < r.length / 2; i++) {
                    let s = n[i],
                      a = s.kernelId,
                      d = this.kernels.get(a),
                      c = d.kernelType,
                      m = d.kernelName,
                      u = s.programName,
                      g = s.inputTensorViews,
                      b = s.outputTensorViews,
                      $ = r[i * 2],
                      w = r[i * 2 + 1];
                    typeof this.queryTimeBase > "u" && (this.queryTimeBase = $);
                    let x = Number($ - this.queryTimeBase),
                      C = Number(w - this.queryTimeBase);
                    if (!Number.isSafeInteger(x) || !Number.isSafeInteger(C))
                      throw new RangeError("incorrect timestamp range");
                    if (this.env.webgpu.profiling?.ondata)
                      this.env.webgpu.profiling.ondata({
                        version: 1,
                        inputsMetadata: g.map((T) => ({
                          dims: T.dims,
                          dataType: Zt(T.dataType)
                        })),
                        outputsMetadata: b.map((T) => ({
                          dims: T.dims,
                          dataType: Zt(T.dataType)
                        })),
                        kernelId: a,
                      ...
                      let T = "";
                      g.forEach((E, k) => {
                        T += `input[${k}]: [${E.dims}] | ${Zt(E.dataType)}, `;
                      });
                      let S = "";
                      b.forEach((E, k) => {
                        S += `output[${k}]: [${E.dims}] | ${Zt(E.dataType)}, `;
                      }),
                        console.log(
                          `[profiling] kernel "${a}|${c}|${m}|${u}" ${T}${S}execution time: ${C - x} ns`
                        );
                    }
                    Jr("GPU", `${u}::${$}::${w}`);
                  }
          ...
          run(t, r, n, i, s, a) {
            ...
            for (let E = 0; E < r.length; ++E) {
              let k = r[E].data;
              if (k === 0) continue;
              let P = this.gpuDataManager.get(k);
              if (!P) throw new Error(`no GPU data for input: ${k}`);
              d.push(P);
            }
            let {
                outputs: c,
              ...
              g = n.length === 0 ? c.map((E, k) => k) : n;
            if (g.length !== c.length)
              throw new Error(
                `Output size ${g.length} must be equal to ${c.length}.`
              );
            let b = [],
              $ = [];
            for (let E = 0; E < c.length; ++E) {
              if (!Number.isInteger(g[E]) || g[E] < -3 || g[E] >= a)
                throw new Error(`Invalid output index: ${g[E]}`);
              if (g[E] === -3) continue;
              let k = g[E] === -1,
                P = g[E] === -2,
                R =
                  k || P
                    ? s(c[E].dataType, c[E].dims)
                    : i(g[E], c[E].dataType, c[E].dims);
              if ((b.push(R), R.data === 0)) continue;
              let L = this.gpuDataManager.get(R.data);
              if (!L) throw new Error(`no GPU data for output: ${R.data}`);
              if ((k && this.temporaryData.push(L), P)) {
                let V = this.kernelPersistentData.get(this.currentKernelId);
                V ||
                  ((V = []),
                  this.kernelPersistentData.set(this.currentKernelId, V)),
                  V.push(L);
              }
              $.push(L);
            }
            if (d.length !== r.length || $.length !== b.length) {
              if ($.length === 0) return at(t.name), b;
              throw new Error(
                `Program ${t.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`
              );
            }
            let w;
            if (u) {
              let E = 0,
                k = [];
              u.forEach((V) => {
                let Y = typeof V.data == "number" ? [V.data] : V.data;
                if (Y.length === 0) return;
                let Q = V.type === 10 ? 2 : 4,
                  he,
                  N;
                V.type === 10
                  ? ((N = Y.length > 4 ? 16 : Y.length > 2 ? 8 : Y.length * Q),
                    (he = Y.length > 4 ? 16 : Q * Y.length))
                  : ((N = Y.length <= 2 ? Y.length * Q : 16), (he = 16)),
                  (E = Math.ceil(E / N) * N),
                  k.push(E);
                let se = V.type === 10 ? 8 : 4;
                E +=
                  Y.length > 4 ? Math.ceil(Y.length / se) * he : Y.length * Q;
              });
              let P = 16;
              E = Math.ceil(E / P) * P;
              let R = new ArrayBuffer(E);
              u.forEach((V, Y) => {
                let Q = k[Y],
                  he = typeof V.data == "number" ? [V.data] : V.data;
                if (V.type === 6) new Int32Array(R, Q, he.length).set(he);
                else if (V.type === 12)
                  new Uint32Array(R, Q, he.length).set(he);
                else if (V.type === 10)
                  new Uint16Array(R, Q, he.length).set(he);
                else if (V.type === 1)
                  new Float32Array(R, Q, he.length).set(he);
                else throw new Error(`Unsupported uniform type: ${Zt(V.type)}`);
              });
              let L = this.gpuDataManager.create(
                E,
                GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM
              );
              this.device.queue.writeBuffer(L.buffer, 0, R, 0, E),
                this.gpuDataManager.release(L.id),
                (w = { offset: 0, size: E, buffer: L.buffer });
            }
            let x = this.programManager.normalizeDispatchGroupSize(m),
              C = x[1] === 1 && x[2] === 1,
              T = af(t, r, C),
              S = this.programManager.getArtifact(T);
            if (
              (S ||
                ((S = this.programManager.build(t, x)),
                this.programManager.setArtifact(T, S),
                Ne(
                  "info",
                  () => `[artifact] key: ${T}, programName: ${t.name}`
                )),
              u && S.uniformVariablesInfo)
            ) {
              if (u.length !== S.uniformVariablesInfo.length)
                throw new Error(
                  `Uniform variables count mismatch: expect ${S.uniformVariablesInfo.length}, got ${u.length} in program "${S.programInfo.name}".`
                );
              for (let E = 0; E < u.length; E++) {
                let k = u[E],
                  P = k.type,
                  R = typeof k.data == "number" ? 1 : k.data.length,
                  [L, V] = S.uniformVariablesInfo[E];
                if (P !== L || R !== V)
                  throw new Error(
                    `Uniform variable ${E} mismatch: expect type ${L} with size ${V}, got type ${P} with size ${R} in program "${S.programInfo.name}".`
                  );
              }
            }
            if (
              (Ne(
                "info",
                () =>
                  `[ProgramManager] run "${t.name}" (key=${T}) with ${x[0]}x${x[1]}x${x[2]}`
              ),
              this.queryType !== "none" || this.sessionStatus === "capturing")
            ) {
              let E = {
                kernelId: this.currentKernelId,
                programName: S.programInfo.name,
                inputTensorViews: r,
                outputTensorViews: b
              };
            ...
            return this.programManager.run(S, d, $, x, w), at(t.name), b;
          }
          upload(t, r) {
          ...
          createKernel(t, r, n, i) {
            let s = Cd.get(t);
            if (!s) throw new Error(`kernel not implemented: ${t}`);
            let a = {
              kernelType: t,
              kernelName: i,
              kernelEntry: s[0],
          ...
          computeKernel(t, r, n) {
            let i = this.kernels.get(t);
            if (!i) throw new Error(`kernel not created: ${t}`);
            let s = i.kernelType,
              a = i.kernelName,
              d = i.kernelEntry,
              c = i.attributes;
            if (this.currentKernelId !== null)
              throw new Error(
                `kernel "[${s}] ${a}" is not allowed to be called recursively`
              );
            (this.currentKernelId = t),
              c[0] && ((c[1] = c[0](c[1])), (c[0] = void 0)),
              Ne("info", () => `[WebGPU] Start to run kernel "[${s}] ${a}"...`);
            let m = this.env.debug;
            this.temporaryData = [];
            try {
              return (
                m && this.device.pushErrorScope("validation"), d(r, c[1]), 0
              );
            } catch (u) {
              return (
                n.push(
                  Promise.resolve(`[WebGPU] Kernel "[${s}] ${a}" failed. ${u}`)
                ),
                1
              );
            } finally {
              m &&
                n.push(
                  this.device
                    ...
                    .then((u) =>
                      u
                        ? `GPU validation error for kernel "[${s}] ${a}": ${u.message}`
                        : null
                    )
                );
              for (let u of this.temporaryData)
                this.gpuDataManager.release(u.id);
              (this.temporaryData = []), (this.currentKernelId = null);
            }
          }
          registerBuffer(t, r, n, i) {
            let s = this.sessionExternalDataMapping.get(t);
            s || ((s = new Map()), this.sessionExternalDataMapping.set(t, s));
            let a = s.get(r),
              d = this.gpuDataManager.registerExternalBuffer(n, i, a?.[1]);
            return s.set(r, [d, n]), d;
          }
          unregisterBuffers(t) {
            let r = this.sessionExternalDataMapping.get(t);
            r &&
              (r.forEach((n) =>
                this.gpuDataManager.unregisterExternalBuffer(n[1])
              ),
              this.sessionExternalDataMapping.delete(t));
          }
          getBuffer(t) {
          ...
          createDownloader(t, r, n) {
            return async () => {
              let i = await Xi(this, t, r);
              return ts(i.buffer, n);
            };
          }
          writeTimestamp(t) {
          ...
          replay() {
            Ne("info", "replay"), (this.sessionStatus = "replaying");
            let t = this.capturedCommandList.get(this.currentSessionId),
              r = this.capturedPendingKernels.get(this.currentSessionId),
              n = t.length;
            this.pendingKernels = [];
            for (let i = 0; i < n; i++) {
              let s = this.getComputePassEncoder(),
                a = t[i];
              this.writeTimestamp(this.pendingDispatchNumber * 2),
                s.setPipeline(a.computePipeline),
                s.setBindGroup(0, a.bindGroup),
                s.dispatchWorkgroups(...a.dispatchGroup),
                this.writeTimestamp(this.pendingDispatchNumber * 2 + 1),
                this.pendingDispatchNumber++,
                this.queryType !== "none" && this.pendingKernels.push(r[i]),
          ...
          onReleaseSession(t) {
            this.unregisterBuffers(t),
              this.capturedCommandList.has(t) &&
                this.capturedCommandList.delete(t),
              this.capturedPendingKernels.has(t) &&
                this.capturedPendingKernels.delete(t),
              this.gpuDataManager.onReleaseSession(t);
          }
          onRunStart(t) {
      ...
      (sn = class e {
        ...
        (xo = class {
          constructor(t, r, n) {
            ...
            let i = t.HEAPU32,
              s = n >>> 2;
            this.opKernelContext = i[s++];
            let a = i[s++];
            (this.outputCount = i[s++]),
              (this.customDataOffset = i[s++]),
              (this.customDataSize = i[s++]);
            let d = [];
            for (let c = 0; c < a; c++) {
              let m = i[s++],
                u = i[s++],
                g = i[s++],
                b = [];
              for (let $ = 0; $ < g; $++) b.push(i[s++]);
              d.push(new sn(t, m, u, b));
            }
            this.inputs = d;
          }
          ...
          compute(t, r) {
            let n =
                r?.inputs?.map((d) =>
                  typeof d == "number" ? this.inputs[d] : d
                ) ?? this.inputs,
              i = r?.outputs ?? [],
              s = (d, c, m) => new sn(this.module, c, this.output(d, m), m),
              a = (d, c) => {
                let m = pr(d);
                if (!m) throw new Error(`Unsupported data type: ${d}`);
                let u = m * M.size(c),
                  g = u > 0 ? this.backend.gpuDataManager.create(u).id : 0;
                return new sn(this.module, d, g, c);
              };
            return this.backend.run(t, n, i, s, a, this.outputCount);
          }
          output(t, r) {
            let n = this.module.stackSave();
            try {
              let i = this.module.stackAlloc((1 + r.length) * 4),
                s = i >> 2;
              this.module.HEAPU32[s++] = r.length;
              for (let a = 0; a < r.length; a++)
                this.module.HEAPU32[s++] = r[a];
              return this.module._JsepOutput(this.opKernelContext, t, i);
            } catch (i) {
              throw new Error(
                `Failed to generate kernel's output[${t}] with dims [${r}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${i}`
              );
            } finally {
                ...
                (a, d, c, m = !1) => {
                  if (m)
                    Ne(
                      "verbose",
                      () =>
                        `[WebGPU] jsepCopyGpuToGpu: src=${a}, dst=${d}, size=${c}`
                    ),
                      s.memcpy(a, d);
                  else {
                    Ne(
                      "verbose",
                      () =>
                        `[WebGPU] jsepCopyCpuToGpu: dataOffset=${a}, gpuDataId=${d}, size=${c}`
                    );
                    let u = t.HEAPU8.subarray(a >>> 0, (a >>> 0) + c);
                    s.upload(d, u);
                  }
                },
                async (a, d, c) => {
                  Ne(
                    "verbose",
                    () =>
                      `[WebGPU] jsepCopyGpuToCpu: gpuDataId=${a}, dataOffset=${d}, size=${c}`
                  ),
                    await s.download(a, () =>
                      t.HEAPU8.subarray(d >>> 0, (d >>> 0) + c)
                    );
                },
                (a, d, c) =>
                  s.createKernel(
                    ...
                    d,
                    c,
                    t.UTF8ToString(t._JsepGetNodeName(d))
                  ),
                (a) => s.releaseKernel(a),
                (a, d, c, m) => {
                  Ne(
                    "verbose",
                    () =>
                      `[WebGPU] jsepRun: sessionHandle=${c}, kernel=${a}, contextDataOffset=${d}`
                  );
                  let u = new xo(t, s, d);
                  return s.computeKernel(a, u, m);
                },
                () => s.captureBegin(),
                () => s.captureEnd(),
                () => s.replay()
  ...
  var uf,
    ...
    Wd = j(() => {
      ...
      qi();
      (uf = (e, t) => {
        Fe()._OrtInit(e, t) !== 0 && We("Can't initialize onnxruntime.");
      }),
        (Pd = async (e) => {
          uf(e.wasm.numThreads, tn(e.logLevel));
        }),
        (Rd = async (e, t) => {
          {
            let r = (kd(), Yt(Ed)).init;
            if (t === "webgpu") {
              ...
              if (n) {
                ...
                if (
                  ...
                  throw new Error(`Invalid powerPreference setting: "${i}"`);
                let s = e.webgpu.forceFallbackAdapter;
                if (s !== void 0 && typeof s != "boolean")
                  throw new Error(
                    `Invalid forceFallbackAdapter setting: "${s}"`
                  );
                if (
                  ((n = await navigator.gpu.requestAdapter({
                    powerPreference: i,
                    forceFallbackAdapter: s
                  })),
                  !n)
                )
                  throw new Error(
        ...
        (lf = (e) => {
          ...
          try {
            let n = t.stackAlloc(8);
            return (
              t._OrtGetInputOutputCount(e, n, n + 4) !== 0 &&
                We("Can't get session input/output count."),
              [t.HEAP32[n / 4], t.HEAP32[n / 4 + 1]]
            );
          } finally {
            t.stackRestore(r);
          }
        ...
        (zd = async (e, t) => {
          ...
          let s = 0,
            ...
            u = [];
          try {
            if ((([a, c] = Xa(t)), t?.externalData && i.mountExternalData)) {
              let S = [];
              for (let E of t.externalData) {
                let k = typeof E == "string" ? E : E.path;
                S.push(
                  rn(typeof E == "string" ? E : E.data).then((P) => {
                    i.mountExternalData(k, P);
                  })
                );
              }
              await Promise.all(S);
            }
            (s = await i._OrtCreateSession(r, n, a)),
              s === 0 && We("Can't create a session.");
            let [g, b] = lf(s),
              $ = !!t?.enableGraphCapture,
              w = [],
              x = [],
              C = [];
            for (let S = 0; S < g; S++) {
              let E = i._OrtGetInputName(s, S);
              E === 0 && We("Can't get an input name."),
                m.push(E),
                w.push(i.UTF8ToString(E));
            }
            for (let S = 0; S < b; S++) {
              let E = i._OrtGetOutputName(s, S);
              E === 0 && We("Can't get an output name."), u.push(E);
              let k = i.UTF8ToString(E);
              x.push(k);
              {
                if ($ && t?.preferredOutputLocation === void 0) {
                  C.push("gpu-buffer");
                  continue;
                }
                let P =
                  typeof t?.preferredOutputLocation == "string"
                    ...
                    : t?.preferredOutputLocation?.[k] ?? "cpu";
                if (P !== "cpu" && P !== "cpu-pinned" && P !== "gpu-buffer")
                  throw new Error(
                    `Not supported preferred output location: ${P}.`
                  );
                if ($ && P !== "gpu-buffer")
                  throw new Error(
                    `Not supported preferred output location: ${P}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`
                  );
                C.push(P);
              }
            }
            let T = null;
            return (
              C.some((S) => S === "gpu-buffer") &&
                ((d = i._OrtCreateBinding(s)),
                d === 0 && We("Can't create IO binding."),
                (T = {
                  handle: d,
                  outputPreferredLocations: C,
                  outputPreferredLocationsEncoded: C.map((S) => Fi(S))
                })),
              gr.set(s, [s, m, u, T, $, !1]),
              [s, w, x]
            );
            ...
            throw (
              (m.forEach((b) => i._OrtFree(b)),
              u.forEach((b) => i._OrtFree(b)),
              d !== 0 && i._OrtReleaseBinding(d),
              s !== 0 && i._OrtReleaseSession(s),
              g)
            );
          } finally {
            i._free(r),
              a !== 0 && i._OrtReleaseSessionOptions(a),
              c.forEach((g) => i._free(g)),
        ...
        (Bd = (e) => {
          ...
          let [n, i, s, a, d] = r;
          a &&
            (d && t._OrtClearBoundOutputs(a.handle),
            t._OrtReleaseBinding(a.handle)),
            t.jsepOnReleaseSession?.(e),
            i.forEach((c) => t._OrtFree(c)),
            s.forEach((c) => t._OrtFree(c)),
            t._OrtReleaseSession(n),
            gr.delete(e);
        }),
        (Od = (e, t, r, n, i, s = !1) => {
          if (!e) {
          ...
          if (m === "gpu-buffer") {
            let w = e[2].gpuBuffer,
              x = pr(Li(d));
            g = c.reduce((T, S) => T * S, 1) * x;
            let C = a.jsepRegisterBuffer;
            if (!C)
              throw new Error(
            ...
            let w = e[2];
            if (Array.isArray(w)) {
              (g = 4 * w.length), (u = a._malloc(g)), r.push(u);
              let x = u / 4;
              for (let C = 0; C < w.length; C++) {
                if (typeof w[C] != "string")
                  throw new TypeError(
                    `tensor data at index ${C} is not a string`
                  );
                a.HEAPU32[x++] = qe(w[C], r);
              }
            } else
              (g = w.byteLength),
                (u = a._malloc(g)),
                r.push(u),
                a.HEAPU8.set(new Uint8Array(w.buffer, w.byteOffset, g), u);
          }
          let b = a.stackSave(),
            $ = a.stackAlloc(4 * c.length);
          try {
            let w = $ / 4;
            c.forEach((C) => (a.HEAP32[w++] = C));
            let x = a._OrtCreateTensor(Li(d), u, g, $, c.length, Fi(m));
            x === 0 &&
              We(
        ...
        (Dd = async (e, t, r, n, i, s) => {
          ...
          try {
            [C, T] = Ka(s);
            for (let ee = 0; ee < w; ee++) Od(r[ee], S, k, e, t[ee], b);
            for (let ee = 0; ee < x; ee++) Od(i[ee], E, k, e, w + n[ee], b);
            let Q = R / 4,
              he = L / 4,
              N = V / 4,
              se = Y / 4;
            for (let ee = 0; ee < w; ee++)
              (a.HEAPU32[Q++] = S[ee]), (a.HEAPU32[he++] = m[t[ee]]);
            for (let ee = 0; ee < x; ee++)
              (a.HEAPU32[N++] = E[ee]), (a.HEAPU32[se++] = u[n[ee]]);
            if (g && !$) {
              let {
                handle: ee,
                outputPreferredLocations: ae,
                outputPreferredLocationsEncoded: Ie
              } = g;
              if (m.length !== w)
                throw new Error(
                  `input count from feeds (${w}) is expected to be always equal to model's input count (${m.length}).`
                );
              for (let me = 0; me < w; me++) {
                let oe = t[me];
                (await a._OrtBindInput(ee, m[oe], S[me])) !== 0 &&
                  We(`Can't bind input[${me}] for session=${e}.`);
              }
              for (let me = 0; me < x; me++) {
                let oe = n[me];
                i[me]?.[3]
                  ? a._OrtBindOutput(ee, u[oe], E[me], 0) !== 0 &&
                    We(
                      `Can't bind pre-allocated output[${me}] for session=${e}.`
                    )
                  : a._OrtBindOutput(ee, u[oe], 0, Ie[oe]) !== 0 &&
                    We(
                      `Can't bind output[${me}] to ${ae[me]} for session=${e}.`
                    );
              }
              gr.set(e, [c, m, u, g, b, !0]);
            }
            a.jsepOnRunStart?.(c);
            let Ce;
            g
              ? (Ce = await a._OrtRunWithBinding(c, g.handle, x, V, C))
              : (Ce = await a._OrtRun(c, L, R, w, Y, x, V, C)),
              Ce !== 0 && We("failed to call OrtRun().");
            let Ve = [];
            for (let ee = 0; ee < x; ee++) {
              let ae = a.HEAPU32[V / 4 + ee];
              if (ae === E[ee]) {
                Ve.push(i[ee]);
                continue;
              }
              let Ie = a.stackSave(),
                ...
                de = 0;
              try {
                a._OrtGetTensorData(ae, me, me + 4, me + 8, me + 12) !== 0 &&
                  We(`Can't access output tensor data on index ${ee}.`);
                let H = me / 4,
                  ne = a.HEAPU32[H++];
                de = a.HEAPU32[H++];
                let Se = a.HEAPU32[H++],
                  Ye = a.HEAPU32[H++],
                  Be = [];
                for (let He = 0; He < Ye; He++) Be.push(a.HEAPU32[Se / 4 + He]);
                a._OrtFree(Se);
                let Ge = Be.reduce((He, Xe) => He * Xe, 1);
                ue = Zt(ne);
                let Ft = g?.outputPreferredLocations[n[ee]];
                if (ue === "string") {
                  if (Ft === "gpu-buffer")
                    throw new Error("String tensor is not supported on GPU.");
                  let He = [],
                    Xe = de / 4;
                  for (let bt = 0; bt < Ge; bt++) {
                    let Nt = a.HEAPU32[Xe++],
                      er = bt === Ge - 1 ? void 0 : a.HEAPU32[Xe] - Nt;
                    He.push(a.UTF8ToString(Nt, er));
                  }
                  Ve.push([ue, Be, He, "cpu"]);
                } else if (Ft === "gpu-buffer" && Ge > 0) {
                  let He = a.jsepGetBuffer;
                  if (!He)
                    throw new Error(
                  ...
                  let Xe = He(de),
                    bt = pr(ne);
                  if (bt === void 0 || !Vn(ue))
                    throw new Error(`Unsupported data type: ${ue}`);
                  (oe = !0),
                    Ve.push([
                      ue,
                      Be,
                      {
                        gpuBuffer: Xe,
                        download: a.jsepCreateDownloader(Xe, Ge * bt, ue),
                        dispose: () => {
                          a._OrtReleaseTensor(ae);
                        }
                      },
                      "gpu-buffer"
                    ]);
                  ...
                  let He = Nn(ue),
                    Xe = new He(Ge);
                  new Uint8Array(Xe.buffer, Xe.byteOffset, Xe.byteLength).set(
                    a.HEAPU8.subarray(de, de + Xe.byteLength)
                  ),
                    Ve.push([ue, Be, Xe, "cpu"]);
                }
              } finally {
                a.stackRestore(Ie),
                  ue === "string" && de && a._free(de),
                  oe || a._OrtReleaseTensor(ae);
              }
            }
            return (
              g &&
                !b &&
                (a._OrtClearBoundOutputs(g.handle),
                gr.set(e, [c, m, u, g, b, !1])),
              Ve
            );
          } finally {
            a.stackRestore(P),
              S.forEach((Q) => a._OrtReleaseTensor(Q)),
              E.forEach((Q) => a._OrtReleaseTensor(Q)),
              k.forEach((Q) => a._free(Q)),
              C !== 0 && a._OrtReleaseRunOptions(C),
              T.forEach((Q) => a._free(Q));
          }
        }),
        (Md = (e) => {
          let t = Fe(),
          ...
          let n = r[0],
            i = t._OrtEndProfiling(n);
          i === 0 && We("Can't get an profile file name."), t._OrtFree(i);
        }),
        (Ud = (e) => {
          let t = [];
          for (let r of e) {
  ...
  var yr,
    ...
    To = j(() => {
      ...
      Wd();
      Or();
      (yr = () => !!ke.wasm.proxy && typeof document < "u"),
        (un = !1),
        (pi = !1),
        (mi = !1),
        (Io = new Map()),
        (zr = (e, t) => {
          let r = Io.get(e);
          r ? r.push(t) : Io.set(e, [t]);
        }),
        (Br = () => {
          if (un || !pi || mi || !St) throw new Error("worker not ready");
        }),
        (pf = (e) => {
          switch (e.data.type) {
            case "init-wasm":
        ...
        (ci = typeof document < "u" ? document?.currentScript?.src : void 0),
        (Vd = async () => {
          if (!pi) {
            if (un) throw new Error("multiple calls to 'initWasm()' detected.");
            if (mi) throw new Error("previous call to 'initWasm()' failed.");
            if (((un = !0), yr()))
              return (
                ke.wasm.wasmPaths === void 0 &&
                  ci &&
                  ci.indexOf("blob:") !== 0 &&
                  (ke.wasm.wasmPaths = ci.substr(0, +ci.lastIndexOf("/") + 1)),
                new Promise((e, t) => {
                  St?.terminate();
                  let r = URL.createObjectURL(
                    new Blob([Nd()], { type: "text/javascript" })
                  );
                  (St = new Worker(r, { name: "ort-wasm-proxy-worker" })),
                    (St.onerror = (i) => t(i)),
                    (St.onmessage = pf),
                    URL.revokeObjectURL(r),
                    (Co = [e, t]);
                  let n = { type: "init-wasm", in: ke };
                  St.postMessage(n);
                })
              );
            try {
              await ja(ke.wasm), await Pd(ke), (pi = !0);
            } catch (e) {
              throw ((mi = !0), e);
            } finally {
              un = !1;
        ...
        (Hd = async (e) => {
          if (yr())
            return (
              ...
              new Promise((t, r) => {
                zr("init-ep", [t, r]);
                let n = { type: "init-ep", in: { epName: e, env: ke } };
                St.postMessage(n);
              })
            );
          await Rd(ke, e);
            ...
            return (
              ...
              new Promise((r, n) => {
                ...
                let i = { type: "create", in: { model: e, options: { ...t } } },
                  s = [];
                e instanceof Uint8Array && s.push(e.buffer),
                  St.postMessage(i, s);
              })
            );
          } else return zd(e, t);
          ...
          if (yr()) {
            ...
            return (
              ...
              new Promise((a, d) => {
                ...
                St.postMessage(m, Ud(c));
              })
            );
          } else return Dd(e, t, r, n, i, s);
        }),
        (jd = async (e) => {
          if (yr())
            return (
        ...
        (fi = class {
          ...
          async loadModel(t, r) {
            ...
            typeof t == "string"
              ? typeof process < "u" &&
                ...
                process.versions.node
                ? (n = await rn(t))
                : (n = await this.fetchModelAndCopyToWasmMemory(t))
              : (n = t),
              ([this.sessionId, this.inputNames, this.outputNames] = await Ld(
                n,
                r
              )),
              at();
          ...
          async run(t, r, n) {
            ...
            Object.entries(t).forEach((b) => {
              let $ = b[0],
                w = b[1],
                x = this.inputNames.indexOf($);
              if (x === -1) throw new Error(`invalid input '${$}'`);
              i.push(w), s.push(x);
            });
            let a = [],
              d = [];
            Object.entries(r).forEach((b) => {
              let $ = b[0],
                w = b[1],
                x = this.outputNames.indexOf($);
              if (x === -1) throw new Error(`invalid output '${$}'`);
              a.push(w), d.push(x);
            });
            let c = i.map((b, $) =>
                Kd(b, () => `input "${this.inputNames[s[$]]}"`)
              ),
              m = a.map((b, $) =>
                b ? Kd(b, () => `output "${this.outputNames[d[$]]}"`) : null
              ),
              u = await qd(this.sessionId, s, c, d, m, n),
              g = {};
            for (let b = 0; b < u.length; b++)
              g[this.outputNames[d[b]]] = a[b] ?? mf(u[b]);
            return at(), g;
          }
          startProfiling() {}
          endProfiling() {
  ...
  var ff,
    ...
    Xd = j(() => {
      ...
      (ff = () => {
        if (
          ((typeof ke.wasm.initTimeout != "number" ||
            ke.wasm.initTimeout < 0) &&
            (ke.wasm.initTimeout = 0),
          typeof ke.wasm.simd != "boolean" && (ke.wasm.simd = !0),
          typeof ke.wasm.proxy != "boolean" && (ke.wasm.proxy = !1),
          typeof ke.wasm.trace != "boolean" && (ke.wasm.trace = !1),
          typeof ke.wasm.numThreads != "number" ||
            !Number.isInteger(ke.wasm.numThreads) ||
            ke.wasm.numThreads <= 0)
        ) {
          ((typeof self < "u" && !self.crossOriginIsolated) ||
            (typeof process < "u" &&
              process.versions &&
              process.versions.node)) &&
            (ke.wasm.numThreads = 1);
          let e =
            typeof navigator > "u"
              ? (void 0)().length
              : navigator.hardwareConcurrency;
          ke.wasm.numThreads = Math.min(4, Math.ceil((e || 1) / 2));
        }
      }),
        (hi = class {
          async init(t) {
            ff(), await Vd(), await Hd(t);
          }
  ...
  var gf = Bi;
  {
    let e = (Qd(), Yt(Zd)).wasmBackend;
    Xt("webgpu", e, 5), Xt("webnn", e, 5), Xt("cpu", e, 10), Xt("wasm", e, 10);
  }
  Object.defineProperty(ke.versions, "web", { value: Pa, enumerable: !0 });
  return Yt(yf);
})();
/**
 * @license
