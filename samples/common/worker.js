...
async function sequence_classification(data) {
  let pipeline = await SequenceClassificationPipelineFactory.getInstance(
    (data) => {
      self.postMessage({
        type: "download",
...
async function token_classification(data) {
  let pipeline = await TokenClassificationPipelineFactory.getInstance(
    (data) => {
      self.postMessage({
        type: "download",
  ...
  let postProcessedChunks = chunks.map((x) => ({
    type: x.type,
...
async function zero_shot_classification(data) {
  let pipeline = await ZeroShotClassificationPipelineFactory.getInstance(
    (data) => {
      self.postMessage({
        type: "download",
...
async function speech_to_text(data) {
  let pipeline = await AutomaticSpeechRecognitionPipelineFactory.getInstance(
    (data) => {
      self.postMessage({
        type: "download",
...
async function image_classification(data) {
  let pipeline = await ImageClassificationPipelineFactory.getInstance(
    (data) => {
      self.postMessage({
        type: "download",
...
async function zero_shot_image_classification(data) {
  let pipeline = await ZeroShotImageClassificationPipelineFactory.getInstance(
    (data) => {
      self.postMessage({
        type: "download",
        task: "image-classification",
