      ...
      {empty ? (
        ...
        messages.map((msg, i) => (
          <div key={`message-${i}`} className="flex items-start space-x-4">
            {msg.role === "assistant" ? (
              <>
                <BotIcon className="h-6 w-6 min-h-6 min-w-6 my-3 text-sky-200 dark:text-gray-300" />
              ...
              <>
                <UserIcon className="h-6 w-6 min-h-6 min-w-6 my-3 text-sky-500 dark:text-gray-300" />
