import{A as r}from"./config-C7GNoNA1.js";function f(t,s){const n="bg-neutral-400",i="bg-sky-500",a="bg-amber-500",e="bg-emerald-500";let c=[],o="";switch(t){case"unload":c=[i,a,e],o=n;break;case"cached":c=[n,a,e],o=i;break;case"loading":c=[n,i,e],o=a;break;case"loaded":c=[n,i,a],o=e;break}s&&(c.map(u=>{s.classList.contains(u)&&s.classList.remove(u)}),s.classList.add(o))}function L(t){let s={};for(const n of r[t].resources)s[n]={cached:!1,size:0};return s}function p(t){return r[t].linkPathPrefix}function d(t){return t.split(".")[0].indexOf("/")<0?t.split(".")[0]:t.split(".")[0].split("/")[1]}function b(t,s){const n=r[t].resources.map(a=>{const e=d(a),c=a.indexOf("/")>0?a.split("/")[1]:a;return`  <div
    ...
    >Required files</span
  >`;s.innerHTML=i+n}function g(t,s){const n=()=>{s.classList.contains("opacity-0")&&s.classList.contains("-z-50")&&!s.classList.contains("z-50")&&(s.classList.remove("opacity-0","-z-50"),s.classList.add("z-50"))},i=()=>{!s.classList.contains("opacity-0")&&!s.classList.contains("-z-50")&&s.classList.contains("z-50")&&(s.classList.remove("z-50"),s.classList.add("opacity-0","-z-50"))};t.addEventListener("mouseover",n),t.addEventListener("mouseout",a=>{s.contains(a.relatedTarget)||i()}),s.addEventListener("mouseover",n),s.addEventListener("mouseout",i)}function h(t,s=0){const n=["Bytes","KB","MB","GB","TB"];if(t===0)return"0 Bytes";const i=parseInt(Math.floor(Math.log(t)/Math.log(1e3)),10);return(t/Math.pow(1e3,i)).toFixed(s)+" "+n[i]}function x(t){let s=document.createElement("template");return t=t.trim(),s.innerHTML=t,s.content.firstChild}function m(...t){t.forEach(s=>{s&&s instanceof HTMLElement&&s.classList.contains("hidden")&&s.classList.remove("hidden")})}export{b as a,d as b,f as c,L as d,h as f,p as g,x as h,g as i,m as r};
